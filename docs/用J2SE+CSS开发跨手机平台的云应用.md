...
2. 安装HomeCenter启动器，打开[http://homecenter.mobi/zh-cn/pc/downloads.htm](http://homecenter.mobi/zh-cn/pc/downloads.htm)（手机端也在此下载），下载相应操作系统压缩包，比如Windows系统，则是&quot;HC\_Server\_For\_Win.zip&quot;。
