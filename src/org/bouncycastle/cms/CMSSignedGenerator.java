...
public class CMSSignedGenerator {
	...
	/**
	 * Add a certificate to the certificate set to be included with the generated SignedData
	 * message.
	 *
	 * @param certificate
	 *            the certificate to be included.
	 * @throws CMSException
	 ...
	 *
	 * @param crlStore
	 *            the store containing the CRLs to be included.
	 * @throws CMSException
	 ...
	 * @param otherRevocationInfo
	 *            the otherRevocationInfo ASN.1 structure.
	 */
	 ...
	 *
	 * @param infoGen
	 *            the generator representing the particular signer.
	 */
	...
	/**
	 * Return a map of oids and byte arrays representing the digests calculated on the content
	 * during the last generate.
	 *
