...
public abstract class JceKeyTransRecipient implements KeyTransRecipient {
	 ...
	 * providers the standard lookup table won't work. Use this method to establish a specific
	 * mapping from an algorithm identifier to a specific algorithm.
	 * <p>
	 * For example:
	 * 
	 * <pre>
	 ...
	 * Key.getEncoded(). This is important if you are using a HSM for unwrapping and using a
	 * software based provider for decrypting the content. Default value: false.
	 *
	 * @param unwrappedKeyMustBeEncodable
	 *            true if getEncoded() should return key bytes, false if not necessary.
	 * @return this recipient.
	 */
	 ...
	 * 
	 * @param doValidate
	 *            true if unwrapped key's should be validated against the content encryption
	...
	protected Key extractSecretKey(AlgorithmIdentifier keyEncryptionAlgorithm, AlgorithmIdentifier encryptedKeyAlgorithm,
		...
		JceAsymmetricKeyUnwrapper unwrapper = helper.createAsymmetricUnwrapper(keyEncryptionAlgorithm, recipientKey)
				.setMustProduceEncodableUnwrappedKey(unwrappedKeyMustBeEncodable);
