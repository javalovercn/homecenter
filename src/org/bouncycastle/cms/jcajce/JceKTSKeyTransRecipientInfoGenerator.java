...
public class JceKTSKeyTransRecipientInfoGenerator extends KeyTransRecipientInfoGenerator {
	...
	private JceKTSKeyTransRecipientInfoGenerator(X509Certificate recipientCert, IssuerAndSerialNumber recipientID,
			String symmetricWrappingAlg, int keySizeInBits) throws CertificateEncodingException {
		super(recipientID,
				new JceKTSKeyWrapper(recipientCert, symmetricWrappingAlg, keySizeInBits, ANONYMOUS_SENDER, getEncodedRecipID(recipientID)));
	}
	...
	public JceKTSKeyTransRecipientInfoGenerator(X509Certificate recipientCert, String symmetricWrappingAlg, int keySizeInBits)
		...
		this(recipientCert, new IssuerAndSerialNumber(new JcaX509CertificateHolder(recipientCert).toASN1Structure()), symmetricWrappingAlg,
				keySizeInBits);
	}

	public JceKTSKeyTransRecipientInfoGenerator(byte[] subjectKeyIdentifier, PublicKey publicKey, String symmetricWrappingAlg,
			int keySizeInBits) {
		super(subjectKeyIdentifier, new JceKTSKeyWrapper(publicKey, symmetricWrappingAlg, keySizeInBits, ANONYMOUS_SENDER,
	 ...
	 *
	 * @param recipientCert
	 *            certificate carrying the public key.
	 * @param algorithmIdentifier
	 *            the identifier and parameters for the encryption algorithm to be used.
	 */
	 ...
	 *            the subject key identifier value to associate with the public key.
	 * @param algorithmIdentifier
	 *            the identifier and parameters for the encryption algorithm to be used.
	 * @param publicKey
