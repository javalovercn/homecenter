...
public class ZlibExpanderProvider implements InputExpanderProvider {
	...
	private static class LimitedInputStream extends FilterInputStream {
		...
		public int read(byte[] buf, int off, int len) throws IOException {
			...
			/*
			 * Limit the underlying request to 'remaining' bytes. This ensures the caller will see
			 * the full 'limit' bytes before getting an exception. Also, only one extra byte will
			 * ever be read.
			 */
