...
public class CMSSignedDataParser extends CMSContentInfoParser {
	 ...
	 *            for generating accumulating digests
	 * @param signedContent
	 ...
	 * 
	 * @param original
	 *            the signed data stream to be used as a base.
	 ...
	 *            the signed data stream to be used as a base.
	 * @param certs
	 *            new certificates to be used, if any.
	 * @param crls
	 *            new CRLs to be used, if any.
	 * @param attrCerts
	 *            new attribute certificates to be used, if any.
	 * @param out
	 *            the stream to write the new signed data object to.
	 * @return out.
	...
	private static void pipeEncapsulatedOctetString(ContentInfoParser encapContentInfo, OutputStream rawOutputStream) throws IOException {
		ASN1OctetStringParser octs = (ASN1OctetStringParser) encapContentInfo.getContent(BERTags.OCTET_STRING);
