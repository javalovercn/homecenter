...
public class SignerInfoGeneratorBuilder {
	 ...
	 *            a provider of digest calculators for the algorithms required in the signature and
	 ...
	 *
	 * @param signedGen
	 *            a generator of signed attributes.
	 * @return the builder object
	 */
	 ...
	 *
	 * @param unsignedGen
	 *            a generator for signed attributes.
	 * @return the builder object
	 */
	 ...
	 *
	 * @param contentSigner
	 *            operator for generating the final signature in the SignerInfo with.
	 * @param certHolder
	 *            carrier for the X.509 certificate related to the contentSigner.
	...
	/**
	 * Build a generator with the passed in subjectKeyIdentifier as the signerIdentifier. If used
	 * you should try to follow the calculation described in RFC 5280 section 4.2.1.2.
	 *
	 * @param contentSigner
	 *            operator for generating the final signature in the SignerInfo with.
