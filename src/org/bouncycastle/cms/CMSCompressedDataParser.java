...
public class CMSCompressedDataParser extends CMSContentInfoParser {
	...
	/**
	 * Return a typed stream which will allow the reading of the compressed content in expanded
	 * form.
	 *
	 * @param expanderProvider
	 *            a provider of expander algorithm implementations.
	 * @return a type stream which will yield the un-compressed content.
	 * @throws CMSException
	 *             if there is an exception parsing the CompressedData object.
	 */
