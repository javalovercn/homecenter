...
public class PasswordRecipientInformation extends RecipientInformation {
	...
	PasswordRecipientInformation(PasswordRecipientInfo info, AlgorithmIdentifier messageAlgorithm, CMSSecureReadable secureReadable,
	...
	protected RecipientOperator getRecipientOperator(Recipient recipient) throws CMSException, IOException {
		...
		byte[] derivedKey = pbeRecipient.calculateDerivedKey(pbeRecipient.getPasswordConversionScheme(), this.getKeyDerivationAlgorithm(),
				keySize);
