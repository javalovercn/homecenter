...
public class CMSAuthenticatedDataStreamGenerator extends CMSAuthenticatedGenerator {
	 ...
	 * encoding.
	 *
	 * @param useBerEncodingForRecipients
	 *            true if a BER set should be used, false if DER.
	 */
	 ...
	 *
	 * @param out
	 *            the stream to store the authenticated structure in.
	 * @param macCalculator
	...
	public OutputStream open(ASN1ObjectIdentifier dataType, OutputStream out, MacCalculator macCalculator,
			DigestCalculator digestCalculator) throws CMSException {
	...
	private class CmsAuthenticatedDataOutputStream extends OutputStream {
		...
		public CmsAuthenticatedDataOutputStream(MacCalculator macCalculator, DigestCalculator digestCalculator,
				ASN1ObjectIdentifier contentType, OutputStream dataStream, BERSequenceGenerator cGen, BERSequenceGenerator envGen,
		...
		public void close() throws IOException {
			...
			if (digestCalculator != null) {
				parameters = Collections.unmodifiableMap(getBaseParameters(contentType, digestCalculator.getAlgorithmIdentifier(),
