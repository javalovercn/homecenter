 ...
 * {@link McElieceKeyPairGenerator} or {@link McElieceKeyFactorySpi}.
 */
public class BCMcEliecePrivateKey implements CipherParameters, PrivateKey {
	 ...
	 * @param field
	 *            the field polynomial defining the finite field <tt>GF(2<sup>m</sup>)</tt>
	 * @param goppaPoly
	 *            the irreducible Goppa polynomial
	 * @param sInv
	...
	public BCMcEliecePrivateKey(McEliecePrivateKeySpec keySpec) {
		this(keySpec.getOIDString(), keySpec.getN(), keySpec.getK(), keySpec.getField(), keySpec.getGoppaPoly(), keySpec.getSInv(),
				keySpec.getP1(), keySpec.getP2(), keySpec.getH(), keySpec.getQInv());
	}

	public BCMcEliecePrivateKey(McEliecePrivateKeyParameters params) {
		this(params.getOIDString(), params.getN(), params.getK(), params.getField(), params.getGoppaPoly(), params.getSInv(),
				params.getP1(), params.getP2(), params.getH(), params.getQInv());
	...
	public boolean equals(Object other) {
		...
		return (n == otherKey.n) && (k == otherKey.k) && field.equals(otherKey.field) && goppaPoly.equals(otherKey.goppaPoly)
				&& sInv.equals(otherKey.sInv) && p1.equals(otherKey.p1) && p2.equals(otherKey.p2) && h.equals(otherKey.h);
	}
	...
	/**
	 * @return the algorithm parameters to encode in the SubjectPublicKeyInfo structure
	 */
	...
	public byte[] getEncoded() {
		McEliecePrivateKey privateKey = new McEliecePrivateKey(new ASN1ObjectIdentifier(oid), n, k, field, goppaPoly, sInv, p1, p2, h,
				qInv);
		PrivateKeyInfo pki;
		try {
