 ...
 * {@link McElieceCCA2KeyPairGenerator} or {@link McElieceCCA2KeyFactorySpi}.
 *
...
public class BCMcElieceCCA2PrivateKey implements CipherParameters, PrivateKey {
	...
	public BCMcElieceCCA2PrivateKey(McElieceCCA2PrivateKeySpec keySpec) {
		this(keySpec.getOIDString(), keySpec.getN(), keySpec.getK(), keySpec.getField(), keySpec.getGoppaPoly(), keySpec.getP(),
				keySpec.getH(), keySpec.getQInv());
	}

	public BCMcElieceCCA2PrivateKey(McElieceCCA2PrivateKeyParameters params) {
		this(params.getOIDString(), params.getN(), params.getK(), params.getField(), params.getGoppaPoly(), params.getP(), params.getH(),
				params.getQInv());
	...
	public boolean equals(Object other) {
		...
		return (n == otherKey.n) && (k == otherKey.k) && field.equals(otherKey.field) && goppaPoly.equals(otherKey.goppaPoly)
				&& p.equals(otherKey.p) && h.equals(otherKey.h);
	}
