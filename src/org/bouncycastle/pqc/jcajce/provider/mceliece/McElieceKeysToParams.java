...
/**
 * utility class for converting jce/jca McEliece objects objects into their org.bouncycastle.crypto
 * counterparts.
 */
public class McElieceKeysToParams {
	...
	static public AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey key) throws InvalidKeyException {
		if (key instanceof BCMcEliecePrivateKey) {
			...
			return new McEliecePrivateKeyParameters(k.getOIDString(), k.getN(), k.getK(), k.getField(), k.getGoppaPoly(), k.getSInv(),
					k.getP1(), k.getP2(), k.getH(), k.getQInv(), k.getMcElieceParameters());
		}
