...
public abstract class AsymmetricHybridCipher extends CipherSpiExt {
	 ...
	 * </p>
	 * 
	 * @return the parameters used with this cipher, or <tt>null</tt> if this cipher does not use
	 *         any parameters.
	 */
	 ...
	 * @return the length of the output of the next <tt>update()</tt> or <tt>doFinal()</tt> call
	 */
	 ...
	 *             if this cipher needs algorithm parameters for initialization and cannot generate
	 *             parameters itself.
	 */
	 ...
	 *             cipher is initialized with <tt>null</tt> parameters and cannot generate
	 *             parameters itself.
	 */
	...
	/**
	 * Compute the output size of an update() or doFinal() operation of a hybrid asymmetric cipher
	 * in encryption mode when given input of the specified length.
	 *
	 * @param inLen
	 *            the length of the input
	...
	/**
	 * Compute the output size of an update() or doFinal() operation of a hybrid asymmetric cipher
	 * in decryption mode when given input of the specified length.
	 *
	 * @param inLen
	 *            the length of the input
	 * @return the output size
