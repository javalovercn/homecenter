...
public class ArrayEncoder {
	 ...
	 * <code>1</code>, to a byte array. <code>coeffs[2*i]</code> and <code>coeffs[2*i+1]</code> must
	 * not both equal -1 for any integer <code>i</code>, so this method is only safe to use with
	 * arrays produced by {@link #decodeMod3Sves(byte[], int)}.<br>
