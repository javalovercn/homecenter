 ...
 * the polynomial, others (like <code>mult</code>) do not but return the result as a new polynomial.
 */
public class BigDecimalPolynomial {
	...
	/**
	 * Multiplies the polynomial by another. Does not change this polynomial but returns the result
	 * as a new polynomial.
	 *
	 * @param poly2
	...
	/**
	 * Multiplies the polynomial by another, taking the indices mod N. Does not change this
	 * polynomial but returns the result as a new polynomial.
	 *
	 * @param poly2
	 *            the polynomial to multiply by
	 * @return a new polynomial
