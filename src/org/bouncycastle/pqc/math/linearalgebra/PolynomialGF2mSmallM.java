...
public class PolynomialGF2mSmallM {
	...
	/**
	 * For the polynomial representation the map f: R->Z*, <tt>poly(X) -> [coef_0, coef_1, ...]</tt>
	 * is used, where <tt>coef_i</tt> is the <tt>i</tt>th coefficient of the polynomial represented
	 * as int (see {@link GF2mField}). The polynomials are stored as int arrays.
	 */
	...
	/**
	 * Create an irreducible polynomial with the given degree over the field <tt>GF(2^m)</tt>.
	 *
	 * @param deg
	 *            polynomial degree
	 * @param sr
	...
	/**
	 * Evaluate this polynomial <tt>p</tt> at a value <tt>e</tt> (in <tt>GF(2^m)</tt>) with the
	 * Horner scheme.
	 *
	 * @param e
	...
	/**
	 * Compute the sum of two polynomials a and b over the finite field <tt>GF(2^m)</tt>.
	 *
	 * @param a
	 ...
	 *             if <tt>element</tt> is not an element of the finite field this polynomial is
	 *             defined over.
	 */
	...
	/**
	 * Return the greatest common divisor of two polynomials over the field <tt>GF(2^m)</tt>.
	 *
	 * @param f
	 *            the first polynomial
	 * @param g
	 ...
	 * @param matrix
	 *            the squaring matrix
	 * @return <tt>this^2</tt> modulo the reduction polynomial implicitly given via the squaring
	 *         matrix
	 */
	 ...
	 *
	 * @param matrix
	 *            the matrix for computing square roots in <tt>(GF(2^m))^t</tt> the polynomial ring
	 *            defining the square root matrix
	 * @return <tt>this^(1/2)</tt> modulo the reduction polynomial implicitly given via the square
	 *         root matrix
	 */
	...
	/**
	 * Compute the result of the division of two polynomials modulo a third polynomial over the
	 * field <tt>GF(2^m)</tt>.
	 *
	 * @param a
	 *            the first polynomial
	 ...
	 * @param b
	 *            the second polynomial
	 * @return <tt>true</tt> if <tt>a</tt> and <tt>b</tt> represent the same polynomials,
