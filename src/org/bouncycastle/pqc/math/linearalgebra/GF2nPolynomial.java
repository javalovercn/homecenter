...
public class GF2nPolynomial {
	 ...
	 *             if <tt>this</tt> and <tt>b</tt> are not defined over the same field.
	 */
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt> and <tt>s</tt> are not defined over the same field.
	 */
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt>, <tt>b</tt> and <tt>g</tt> are not all defined over the same
	 *             field.
	 */
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt> and <tt>g</tt> are not defined over the same field.
	 */
	...
	/**
	 * Shifts left <i>this</i> by <i>amount</i> and stores the result in <i>this</i> PolynomialGF2n.
	 *
	 * @param amount
	 ...
	 * @throws DifferentFieldsException
	 *             if the coefficients of <i>this</i> and <i>g</i> use different fields
