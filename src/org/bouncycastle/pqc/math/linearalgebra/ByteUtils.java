...
public final class ByteUtils {
	 ...
	 * @param array
	 *            the array to clone
	 * @return the clone of the given array, or <tt>null</tt> if the array is <tt>null</tt>
	 */
	...
	/**
	 * Compute the bitwise XOR of two arrays of bytes. The arrays have to be of same length. No
	...
	/**
	 * Split a byte array <tt>input</tt> into two arrays at <tt>index</tt>, i.e. the first array
	 * will have the lower <tt>index</tt> bytes, the second one the higher
	 * <tt>input.length - index</tt> bytes.
	 *
	 * @param input
