...
/**
 * This class represents polynomial rings <tt>GF(2^m)[X]/p(X)</tt> for <tt>m&lt;32</tt>. If
 * <tt>p(X)</tt> is irreducible, the polynomial ring is in fact an extension field of
 * <tt>GF(2^m)</tt>.
 */
public class PolynomialRingGF2m {
	...
	/**
	 * Compute the matrix for computing square roots in this polynomial ring by inverting the
	 * squaring matrix.
	 */
