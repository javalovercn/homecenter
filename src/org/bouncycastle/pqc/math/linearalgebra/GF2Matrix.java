...
public class GF2Matrix extends Matrix {
	...
	/**
	 * For the matrix representation the array of type int[][] is used, thus one element of the
	 * array keeps 32 elements of the matrix (from one row and 32 columns)
	 */
	private int[][] matrix;
	...
	/**
	 * Get the quadratic submatrix of this matrix consisting of the leftmost <tt>numRows</tt>
	 * columns.
	 *
	...
	/**
	 * Compute the full form matrix <tt>(this | Id)</tt> from this matrix in left compact form,
	 * where <tt>Id</tt> is the <tt>k x k</tt> identity matrix and <tt>k</tt> is the number of rows
	 * of this matrix.
	 *
	...
	/**
	 * Get the submatrix of this matrix consisting of the rightmost <tt>numColumns-numRows</tt>
	 * columns.
	 *
	...
	/**
	 * Compute the full form matrix <tt>(Id | this)</tt> from this matrix in right compact form,
	 * where <tt>Id</tt> is the <tt>k x k</tt> identity matrix and <tt>k</tt> is the number of rows
	 * of this matrix.
	 *
	...
	/**
	 * Compute the product of a permutation matrix (which is generated from an n-permutation) and
	 * this matrix.
	 *
	 * @param p
	 *            the permutation
