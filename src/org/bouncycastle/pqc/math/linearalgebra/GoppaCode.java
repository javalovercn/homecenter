...
public final class GoppaCode {
	...
	/**
	 * This class is a container for two instances of {@link GF2Matrix} and one instance of
	 * {@link Permutation}. It is used to hold the systematic form <tt>S*H*P = (Id|M)</tt> of the
	 * check matrix <tt>H</tt> as returned by
	 ...
	 * hold a generator matrix and the set of indices such that the submatrix of the generator
	...
	public static class MatrixSet {
		 ...
		 * @param setJ
		 *            the set of indices such that the submatrix of the generator matrix consisting
		 *            of the specified columns is the identity
		 */
		...
		/**
		 * @return the set of indices such that the submatrix of the generator matrix consisting of
	 ...
	 * polynomial over the finite field <tt>GF(2<sup>m</sup>)</tt>.
	 *
	 * @param field
	 *            the finite field
	 * @param gp
	...
	/**
	 * Given a check matrix <tt>H</tt>, compute matrices <tt>S</tt>, <tt>M</tt>, and a random
	 * permutation <tt>P</tt> such that <tt>S*H*P = (Id|M)</tt>. Return <tt>S^-1</tt>, <tt>M</tt>,
	 * and <tt>P</tt> as {@link MaMaPe}. The matrix <tt>(Id | M)</tt> is called the systematic form
	 * of H.
	 *
	 * @param h
	 *            the check matrix
	 ...
	 *            the irreducible Goppa polynomial
	 * @param sqRootMatrix
	 *            the matrix for computing square roots in <tt>(GF(2<sup>m</sup>))<sup>t</sup></tt>
