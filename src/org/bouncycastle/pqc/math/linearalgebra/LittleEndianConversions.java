...
public final class LittleEndianConversions {
	 ...
	 * performed (i.e., if the integer cannot be encoded with <tt>length</tt> octets, it is
	 * truncated).
	 *
	 * @param value
	 *            the integer to convert
	 ...
	 * (i.e., if the last integer cannot be encoded with <tt>length % 4</tt> octets, it is
	 * truncated).
	 *
	 * @param input
	 *            the int array
