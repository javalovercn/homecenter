...
public final class BigIntUtils {
	 ...
	 * @param end
	 *            - the end index
	 * @return a subarray of <tt>input</tt>, ranging from <tt>start</tt> to <tt>end</tt>
	 */
	 ...
	 * numbers usually are positive. Thus, this helper method returns a byte array of minimal
