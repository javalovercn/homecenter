...
public final class BigEndianConversions {
	...
	/**
	 * Convert an integer to an octet string according to IEEE 1363, Section 5.5.3. Length checking
	 * is performed.
	 *
	 * @param x
	 *            the integer to convert
	 ...
	 *         <tt>null</tt> if the integer is negative
	 ...
	 * @return an integer representing the octet string <tt>input</tt>, or <tt>0</tt> if the
	 *         represented integer is negative or too large or the byte array is empty
	 * @throws ArithmeticException
	 ...
	 * @return an integer representing the octet string <tt>bytes</tt>, or <tt>0</tt> if the
	 *         represented integer is negative or too large or the byte array is empty
	 */
	...
	/**
	 * Convert an int array into a byte array of the specified length. No length checking is
	 * performed (i.e., if the last integer cannot be encoded into <tt>length % 4</tt> octets, it is
	 * truncated).
	 *
	 * @param input
	 *            the int array
