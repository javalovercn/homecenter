...
public class GF2nPolynomialField extends GF2nField {
	 ...
	 *            source of randomness for generating new polynomials.
	 * @param file
	 *            true if you want to read the field polynomial from the file false if you want to
	...
	/**
	 * Creates a new GF2nField of degree <i>i</i> and uses the given <i>polynomial</i> as field
	 * polynomial. The <i>polynomial</i> is checked whether it is irreducible. This can take some
	 * time if <i>i</i> is huge!
	 *
	 * @param deg
	...
	/**
	 * Returns true if the field polynomial is a pentanomial. The coefficients can be retrieved
	 * using getPc().
	 *
	 ...
	 * <i>field polynomial</i>. Returns false if no irreducible trinomial exists in GF(2^n). This
	...
	/**
	 * Tests random polynomials of degree (n+1) until an irreducible is found and stores the result
	 * in <i>field polynomial</i>. This can take very long for huge degrees.
	 *
	 * @return true
	 */
