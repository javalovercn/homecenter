 ...
 * field GF(2). <br>
 * For the vector representation the array of type int[] is used, thus one element of the array
 * holds 32 elements of the vector.
 *
 * @see Vector
 */
public class GF2Vector extends Vector {
	...
	/**
	 * Construct a GF2Vector of the given length and with elements from the given array. The array
	 * is copied and unused bits are masked out.
	 *
	 * @param length
	 *            the length of the vector
	 * @param v
	...
	/**
	 * Return a new vector consisting of the elements of this vector with the indices given by the
	 * set <tt>setJ</tt>.
	 *
	 * @param setJ
