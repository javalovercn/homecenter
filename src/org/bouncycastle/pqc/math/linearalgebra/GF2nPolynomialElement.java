...
public class GF2nPolynomialElement extends GF2nElement {
	...
	/**
	 * This method is used internally to map the square()-calls within GF2nPolynomialElement to one
	 * of the possible squaring methods.
	 *
	...
	/**
	 * Squares this GF2nPolynomialElement by using precalculated values and reducing. This is
	 * supposed to de fastest when using a trinomial or pentanomial as field polynomial. Use
	 * squareMatrix when using a ordinary polynomial as field polynomial.
	 *
	 * @return <tt>this<sup>2</sup></tt> (newly created)
	 * @see GF2nPolynomialElement#squareMatrix
	...
	/**
	 * Squares this GF2nPolynomialElement by using precalculated values and reducing. This is
	 * supposed to de fastest when using a tri- or pentanomial as fieldpolynomial. Use squareMatrix
	 * when using a ordinary polynomial as fieldpolynomial.
	 *
	 * @see GF2nPolynomialElement#squareMatrix
	 * @see GF2Polynomial#squareThisPreCalc
	 */
	...
	/**
	 * Solves the quadratic equation <tt>z<sup>2</sup> + z = this</tt> if such a solution exists.
	 * This method returns one of the two possible solutions. The other solution is <tt>z + 1</tt>.
	 * Use z.increase() to compute this solution.
	 *
