...
/**
 * This abstract class implements an element of the finite field <i>GF(2)<sup>n </sup></i> in either
 * <i>optimal normal basis</i> representation (<i>ONB</i>) or in <i>polynomial</i> representation.
 * It is extended by the classes <a href = GF2nONBElement.html><tt> GF2nONBElement</tt></a> and
...
public abstract class GF2nElement implements GFElement {
	...
	/**
	 * Performs a basis transformation of this element to the given GF2nField <tt>basis</tt>.
	 *
	 * @param basis
