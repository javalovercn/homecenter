...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
	...
	/**
	 * The standard constructor tries to generate the GMSS algorithm identifier with the
	 * corresponding OID.
	 *
	...
	/**
	 * Generates the GMSS key pair. The public key is an instance of JDKGMSSPublicKey, the private
	 * key is an instance of JDKGMSSPrivateKey.
	 *
	...
	private AsymmetricCipherKeyPair genKeyPair() {
		...
		GMSSPrivateKeyParameters privateKey = new GMSSPrivateKeyParameters(currentSeeds, nextNextSeeds, currentAuthPaths, nextAuthPaths,
				currentTreehash, nextTreehash, currentStack, nextStack, currentRetain, nextRetain, nextRoots, currentRootSigs, gmssPS,
				digestProvider);
	...
	/**
	 * calculates the authpath for tree in layer h which starts with seed[h] additionally computes
	 * the rootSignature of underlaying root
	 *
	 * @param currentStack
	...
	/**
	 * This method initializes the GMSS KeyPairGenerator using an integer value <code>keySize</code>
	 * as input. It provides a simple use of the GMSS for testing demands.
	 * <p>
	 ...
	 *
	 * @param keySize
	 *            Assigns the parameters used for the GMSS signatures. There are 3 choices:<br>
	 *            1. keysize &lt;= 10: creates 2^10 signatures using the parameterset<br>
	 *            P = (2, (5, 5), (3, 3), (3, 3))<br>
	 *            2. keysize &gt; 10 and &lt;= 20: creates 2^20 signatures using the
	 *            parameterset<br>
	 *            P = (2, (10, 10), (5, 4), (2, 2))<br>
	 *            3. keysize &gt; 20: creates 2^40 signatures using the parameterset<br>
	...
	/**
	 * This method is called by generateKeyPair() in case that no other initialization method has
