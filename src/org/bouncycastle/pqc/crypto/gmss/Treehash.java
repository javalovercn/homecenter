...
public class Treehash {
	...
	/**
	 * Calculates one update of the treehash instance, i.e. creates a new leaf and hashes if
	 * possible
	 *
	 * @param gmssRandom
	...
	/**
	 * Returns the height of the lowest node stored either in treehash or on the stack. It must not
	 * be set to infinity (as mentioned in the paper) because this cases are considered in the
