...
public class GMSSUtil {
	/**
	 * Converts a 32 bit integer into a byte array beginning at <code>offset</code> (little-endian
	 * representation)
	 *
	 * @param value
	 ...
	 * @param testValue
	 *            an integer
	 * @return <code>TRUE</code> if <code>testValue</code> is a power of 2, <code>FALSE</code>
	 *         otherwise
	 */
