...
public class WinternitzOTSignature {
	...
	/**
	 * An array of strings, containing the name of the used hash function, the name of the PRGN and
	 * the names of the corresponding providers
	 */
	 ...
	 * @param digest
	 *            an array of strings, containing the name of the used hash function, the name of
	...
	public WinternitzOTSignature(byte[] seed0, Digest digest, int w) {
		...
		/*
		 * mdsize = messDigestOTS.getDigestLength(); messagesize = ((mdsize<<3)+(w-1))/w;
		 *
		 * checksumsize = getlog((messagesize<<w)+1);
		 *
