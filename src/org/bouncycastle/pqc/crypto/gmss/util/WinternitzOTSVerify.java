...
public class WinternitzOTSVerify {
	 ...
	 *
	 * @param digest
	 *            the name of the hash function used by the OTS and the provider name of the hash
	 *            function
	 * @param w
	 *            the Winternitz parameter
	 */
	...
	/**
	 * This method computes the public OTS key from the one-time signature of a message. This is
	 * *NOT* a complete OTS signature verification, but it suffices for usage with CMSS.
	 *
	 * @param message
	 *            the message
	 * @param signature
