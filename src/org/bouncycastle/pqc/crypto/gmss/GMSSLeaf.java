 ...
 * signature scheme (OTSS). The class is used by the GMSS classes for calculation of upcoming leafs.
 */
public class GMSSLeaf {
	 ...
	 *
	 * @param digest
	 *            an array of strings, containing the name of the used hash function and PRNG and
	 ...
	 *
	 * @param digest
	 *            an array of strings, containing the digest of the used hash function and PRNG and
	 *            the digest of the corresponding provider
	 * @param w
	 *            the winterniz parameter of that tree the leaf is computed for
	 * @param numLeafs
	 *            the number of leafs of the tree from where the distributed computation is called
	 */
