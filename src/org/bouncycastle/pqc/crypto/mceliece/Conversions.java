...
final class Conversions {
	...
	/**
	 * Compute a message representative of a message given as a vector of length <tt>n</tt> bit and
	 * of hamming weight <tt>t</tt>. The result is a byte array of length <tt>(s+7)/8</tt>, where
