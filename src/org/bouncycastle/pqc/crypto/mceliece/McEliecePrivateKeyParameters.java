...
public class McEliecePrivateKeyParameters extends McElieceKeyParameters {
	 ...
	 *            McElieceParameters
	 */
	public McEliecePrivateKeyParameters(String oid, int n, int k, GF2mField field, PolynomialGF2mSmallM goppaPoly, GF2Matrix sInv,
			Permutation p1, Permutation p2, GF2Matrix h, PolynomialGF2mSmallM[] qInv, McElieceParameters params) {
		super(true, params);
		this.oid = oid;
		this.k = k;
		this.n = n;
	 ...
	 *            the dimension of the code
	 * @param encField
	 *            the encoded field polynomial defining the finite field <tt>GF(2<sup>m</sup>)</tt>
	 * @param encGoppaPoly
	 *            the encoded irreducible Goppa polynomial
	 * @param encSInv
	 *            the encoded matrix <tt>S<sup>-1</sup></tt>
	 * @param encP1
	 *            the encoded permutation used to generate the systematic check matrix
	 * @param encP2
	 *            the encoded permutation used to compute the public generator matrix
	 * @param encH
	 ...
	 *            McElieceParameters
	 */
	public McEliecePrivateKeyParameters(String oid, int n, int k, byte[] encField, byte[] encGoppaPoly, byte[] encSInv, byte[] encP1,
			byte[] encP2, byte[] encH, byte[][] encQInv, McElieceParameters params) {
		super(true, params);
		this.oid = oid;
		this.n = n;
		this.k = k;
