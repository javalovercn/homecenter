...
/**
 * A NtruSign private key comprises one or more {@link NTRUSigningPrivateKeyParameters.Basis} of
 * three polynomials each, except the zeroth basis for which <code>h</code> is undefined.
 */
public class NTRUSigningPrivateKeyParameters extends AsymmetricKeyParameter {
	...
	public static class Basis {
		 ...
		 *            NtruSign parameters
		 * @param include_h
		 *            whether to read the polynomial <code>h</code> (<code>true</code>) or only
		 ...
		 *            an output stream
		 * @param include_h
		 *            whether to write the polynomial <code>h</code> (<code>true</code>) or only
		 *            <code>f</code> and <code>f'</code> (<code>false</code>)
		 * @throws IOException
		 */
