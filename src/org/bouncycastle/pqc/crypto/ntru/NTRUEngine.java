...
public class NTRUEngine implements AsymmetricBlockCipher {
	...
	/**
	 * Generates an <code>int</code> array containing <code>dr</code> elements equal to
	 * <code>1</code> and <code>dr</code> elements equal to <code>-1</code> using an index
	 * generator.
	 *
	 * @param ig
	 *            an index generator
	 ...
	 *             if the encrypted data is invalid, or <code>maxLenBytes</code> is greater than 255
	 */
	 ...
	 * @param e
	 * @param priv_t
	 *            a polynomial such that if <code>fastFp=true</code>, <code>f=1+3*priv_t</code>;
