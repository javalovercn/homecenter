 ...
 * forms depending on whether product-form polynomials are used, and on <code>fastP</code><br>
...
public class NTRUEncryptionPrivateKeyParameters extends NTRUEncryptionKeyParameters {
	 ...
	 * @param t
	 *            the polynomial which determines the key: if <code>fastFp=true</code>,
