...
public class NTRUSigningKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
	...
	/*
	 * Implementation of the optional steps 20 through 26 in EESS1v2.pdf, section 3.5.1.1. This
	 * doesn't seem to have much of an effect and sometimes actually increases the norm of F, but on
	 * average it slightly reduces the norm.<br/> This method changes <code>F</code> and
	 * <code>g</code> but leaves <code>f</code> and <code>g</code> unchanged.
	 */
	 ...
	 * If <code>KeyGenAlg=FLOAT</code>, the basis may not be valid and this method must be rerun if
	 * that is the case.<br/>
	 *
	...
	public class FGBasis extends NTRUSigningPrivateKeyParameters.Basis {
		 ...
		 * <code>G</code> are within {@link NTRUSigningKeyGenerationParameters#keyNormBound}.
		 */
		boolean isNormOk() {
