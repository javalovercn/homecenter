...
public class ComputeInField {
	 ...
	 *
	 * @param B
	 *            this matrix is the left part of the equation (B in the equation above)
	 * @param b
	 ...
	 *            This parameter shows if the function is used by the solveEquation-function or by
	 *            the inverse-function and according to this creates matrices of different sizes.
	 * @throws RuntimeException
	...
	/**
	 * This function uses backward substitution to find x of the linear equation system (LES) B*x =
	 * b, where A a triangle-matrix is (contains only zeros under the diagonal) and b is a vector
	 * <p>
	...
	/**
	 * This function multiplies two given matrices. If the given matrices cannot be multiplied due
	 ...
	 * @throws RuntimeException
	 *             in case the addition is not possible because of different dimensions of the
	 *             matrices
	 */
