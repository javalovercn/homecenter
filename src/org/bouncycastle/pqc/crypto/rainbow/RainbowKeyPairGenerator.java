...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
	...
	/**
	 * This function generates the private map F, which consists of u-1 layers. Each layer consists
	 * of oi polynomials where oi = vi[i+1]-vi[i].
	 * <p>
	 ...
	 * <p>
	 * The composition of F with L2 is computed, followed by applying L1 to the composition's
	 * result. The singular and scalar values constitute to the public key as is, the quadratic
	 * terms are compacted in <tt>compactPublicKey()</tt>
	 * </p>
	 */
	 ...
	 *            3-dimensional array containing a n x n Matrix for each of the n - v1 polynomials
	 */
