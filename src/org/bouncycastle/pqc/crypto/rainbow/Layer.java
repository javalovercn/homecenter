...
public class Layer {
	 ...
	 * @param viNext
	 *            number of vinegar variables of next layer. It's the same as (num of oils) + (num
	 *            of vinegars) of this layer.
	 * @param coeffAlpha
	 ...
	 *
	 * @param x
	 *            vinegar variables of this layer that should be plugged into the polynomials.
	...
	public boolean equals(Object other) {
		...
		return vi == otherLayer.getVi() && viNext == otherLayer.getViNext() && oi == otherLayer.getOi()
				&& RainbowUtil.equals(coeff_alpha, otherLayer.getCoeffAlpha()) && RainbowUtil.equals(coeff_beta, otherLayer.getCoeffBeta())
				&& RainbowUtil.equals(coeff_gamma, otherLayer.getCoeffGamma()) && RainbowUtil.equals(coeff_eta, otherLayer.getCoeffEta());
	}
