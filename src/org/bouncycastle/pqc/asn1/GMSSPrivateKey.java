...
public class GMSSPrivateKey extends ASN1Object {
	...
	private GMSSPrivateKey(ASN1Sequence mtsPrivateKey) {
		 ...
		 * Treehash[seqOfcurTreehash1.size()]; for (int j = 0; j < curTreehash[i].length; j++) {
		 * seqOfcurTreehashStat = (ASN1Sequence)seqOfcurTreehash1.getObjectAt(j);
		 * seqOfcurTreehashString = (ASN1Sequence)seqOfcurTreehashStat .getObjectAt(0);
		 * seqOfcurTreehashBytes = (ASN1Sequence)seqOfcurTreehashStat .getObjectAt(1);
		 * seqOfcurTreehashInts = (ASN1Sequence)seqOfcurTreehashStat .getObjectAt(2);
		 * 
		 ...
		 * 
		 * int tailLength = checkBigIntegerInIntRange(seqOfcurTreehashInts.getObjectAt(1)); byte[][]
		 ...
		 * statByte[2] = ((DEROctetString)seqOfcurTreehashBytes.getObjectAt(2)).getOctets(); for
		 * (int k = 0; k < tailLength; k++) { statByte[3 + k] =
		 * ((DEROctetString)seqOfcurTreehashBytes .getObjectAt(3 + k)).getOctets(); } int[] statInt
		 * = new int[6 + tailLength]; statInt[0] =
		 * checkBigIntegerInIntRange(seqOfcurTreehashInts.getObjectAt(0)); statInt[1] = tailLength;
		 * statInt[2] = checkBigIntegerInIntRange(seqOfcurTreehashInts.getObjectAt(2)); statInt[3] =
		 ...
		 * checkBigIntegerInIntRange(seqOfcurTreehashInts.getObjectAt(5)); for (int k = 0; k <
		 * tailLength; k++) { statInt[6 + k] =
		 * checkBigIntegerInIntRange(seqOfcurTreehashInts.getObjectAt(6 + k)); }
		 * 
		 * // TODO: Check if we can do better than throwing away name[1] !!! curTreehash[i][j] = new
		 * Treehash(DigestFactory.getDigest(name[0]).getClass(), statByte, statInt); } }
		 * 
		 * 
		 * // --- Decode <nextTreehash>. ASN1Sequence seqOfNextTreehash0 =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(6); ASN1Sequence seqOfNextTreehash1; ASN1Sequence
		 * seqOfNextTreehashStat; ASN1Sequence seqOfNextTreehashBytes; ASN1Sequence
		 * seqOfNextTreehashInts; ASN1Sequence seqOfNextTreehashString;
		 * 
		 ...
		 * Treehash[seqOfNextTreehash1.size()]; for (int j = 0; j < nextTreehash[i].length; j++) {
		 * seqOfNextTreehashStat = (ASN1Sequence)seqOfNextTreehash1 .getObjectAt(j);
		 * seqOfNextTreehashString = (ASN1Sequence)seqOfNextTreehashStat .getObjectAt(0);
		 * seqOfNextTreehashBytes = (ASN1Sequence)seqOfNextTreehashStat .getObjectAt(1);
		 * seqOfNextTreehashInts = (ASN1Sequence)seqOfNextTreehashStat .getObjectAt(2);
		 * 
		 * String[] name = new String[2]; name[0] =
		 ...
		 * statByte[2] = ((DEROctetString)seqOfNextTreehashBytes.getObjectAt(2)).getOctets(); for
		 * (int k = 0; k < tailLength; k++) { statByte[3 + k] =
		 * ((DEROctetString)seqOfNextTreehashBytes .getObjectAt(3 + k)).getOctets(); } int[] statInt
		 * = new int[6 + tailLength]; statInt[0] =
		 ...
		 * 
		 * } nextTreehash[i][j] = new Treehash(DigestFactory.getDigest(name[0]).getClass(),
		 * statByte, statInt); } }
		 * 
		 * 
		 ...
		 * 
		 * byte[][][] keep = new byte[keepPart0.size()][][]; for (int i = 0; i < keep.length; i++) {
		 * keepPart1 = (ASN1Sequence)keepPart0.getObjectAt(i); keep[i] = new
		 * byte[keepPart1.size()][]; for (int j = 0; j < keep[i].length; j++) { keep[i][j] =
		 * ((DEROctetString)keepPart1.getObjectAt(j)).getOctets(); } }
		 * 
		 ...
		 * curStack.length; i++) { curStackPart1 = (ASN1Sequence)curStackPart0.getObjectAt(i);
		 * curStack[i] = new Vector(); for (int j = 0; j < curStackPart1.size(); j++) {
		 ...
		 * nextStack.length; i++) { nextStackPart1 = (ASN1Sequence)nextStackPart0.getObjectAt(i);
		 * nextStack[i] = new Vector(); for (int j = 0; j < nextStackPart1.size(); j++) {
		 * nextStack[i].addElement(((DEROctetString)nextStackPart1 .getObjectAt(j)).getOctets()); }
		 * }
		 * 
		 * // --- Decode <curRetain>. ASN1Sequence curRetainPart0 =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(10); ASN1Sequence curRetainPart1; ASN1Sequence
		 * curRetainPart2;
		 * 
		 * Vector[][] curRetain = new Vector[curRetainPart0.size()][]; for (int i = 0; i <
		 * curRetain.length; i++) { curRetainPart1 = (ASN1Sequence)curRetainPart0.getObjectAt(i);
		 * curRetain[i] = new Vector[curRetainPart1.size()]; for (int j = 0; j <
		 * curRetain[i].length; j++) { curRetainPart2 = (ASN1Sequence)curRetainPart1.getObjectAt(j);
		 * curRetain[i][j] = new Vector(); for (int k = 0; k < curRetainPart2.size(); k++) {
		 * curRetain[i][j] .addElement(((DEROctetString)curRetainPart2
		 * .getObjectAt(k)).getOctets()); } } }
		 * 
		 * // --- Decode <nextRetain>. ASN1Sequence nextRetainPart0 =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(11); ASN1Sequence nextRetainPart1; ASN1Sequence
		 * nextRetainPart2;
		 * 
		 * Vector[][] nextRetain = new Vector[nextRetainPart0.size()][]; for (int i = 0; i <
		 * nextRetain.length; i++) { nextRetainPart1 = (ASN1Sequence)nextRetainPart0.getObjectAt(i);
		 * nextRetain[i] = new Vector[nextRetainPart1.size()]; for (int j = 0; j <
		 * nextRetain[i].length; j++) { nextRetainPart2 =
		 * (ASN1Sequence)nextRetainPart1.getObjectAt(j); nextRetain[i][j] = new Vector(); for (int k
		 * = 0; k < nextRetainPart2.size(); k++) { nextRetain[i][j]
		 * .addElement(((DEROctetString)nextRetainPart2 .getObjectAt(k)).getOctets()); } } }
		 * 
		 * // --- Decode <nextNextLeaf>. ASN1Sequence seqOfLeafs =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(12); ASN1Sequence seqOfLeafStat; ASN1Sequence
		 * seqOfLeafBytes; ASN1Sequence seqOfLeafInts; ASN1Sequence seqOfLeafString;
		 * 
		 ...
		 * ((DERIA5String)seqOfLeafString.getObjectAt(1)).getString(); byte[][] statByte = new
		 * byte[4][]; statByte[0] = ((DEROctetString)seqOfLeafBytes.getObjectAt(0)) .getOctets();
		 * statByte[1] = ((DEROctetString)seqOfLeafBytes.getObjectAt(1)) .getOctets(); statByte[2] =
		 * ((DEROctetString)seqOfLeafBytes.getObjectAt(2)) .getOctets(); statByte[3] =
		 * ((DEROctetString)seqOfLeafBytes.getObjectAt(3)) .getOctets(); int[] statInt = new int[4];
		 * statInt[0] = checkBigIntegerInIntRange(seqOfLeafInts.getObjectAt(0)); statInt[1] =
		 ...
		 * checkBigIntegerInIntRange(seqOfLeafInts.getObjectAt(3)); nextNextLeaf[i] = new
		 * GMSSLeaf(DigestFactory.getDigest(name[0]).getClass(), statByte, statInt); }
		 * 
		 * // --- Decode <upperLeaf>. ASN1Sequence seqOfUpperLeafs =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(13); ASN1Sequence seqOfUpperLeafStat;
		 * ASN1Sequence seqOfUpperLeafBytes; ASN1Sequence seqOfUpperLeafInts; ASN1Sequence
		 * seqOfUpperLeafString;
		 * 
		 ...
		 * ((DERIA5String)seqOfUpperLeafString.getObjectAt(1)).getString(); byte[][] statByte = new
		 * byte[4][]; statByte[0] = ((DEROctetString)seqOfUpperLeafBytes.getObjectAt(0))
		 * .getOctets(); statByte[1] = ((DEROctetString)seqOfUpperLeafBytes.getObjectAt(1))
		 * .getOctets(); statByte[2] = ((DEROctetString)seqOfUpperLeafBytes.getObjectAt(2))
		 * .getOctets(); statByte[3] = ((DEROctetString)seqOfUpperLeafBytes.getObjectAt(3))
		 ...
		 * checkBigIntegerInIntRange(seqOfUpperLeafInts.getObjectAt(3)); upperLeaf[i] = new
		 * GMSSLeaf(DigestFactory.getDigest(name[0]).getClass(), statByte, statInt); }
		 * 
		 * // --- Decode <upperTreehashLeaf>. ASN1Sequence seqOfUpperTHLeafs =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(14); ASN1Sequence seqOfUpperTHLeafStat;
		 * ASN1Sequence seqOfUpperTHLeafBytes; ASN1Sequence seqOfUpperTHLeafInts; ASN1Sequence
		 * seqOfUpperTHLeafString;
		 * 
		 ...
		 * ((DERIA5String)seqOfUpperTHLeafString.getObjectAt(1)) .getString(); byte[][] statByte =
		 * new byte[4][]; statByte[0] = ((DEROctetString)seqOfUpperTHLeafBytes.getObjectAt(0))
		 * .getOctets(); statByte[1] = ((DEROctetString)seqOfUpperTHLeafBytes.getObjectAt(1))
		 * .getOctets(); statByte[2] = ((DEROctetString)seqOfUpperTHLeafBytes.getObjectAt(2))
		 * .getOctets(); statByte[3] = ((DEROctetString)seqOfUpperTHLeafBytes.getObjectAt(3))
		 * .getOctets(); int[] statInt = new int[4]; statInt[0] =
		 ...
		 * checkBigIntegerInIntRange(seqOfUpperTHLeafInts.getObjectAt(3)); upperTHLeaf[i] = new
		 * GMSSLeaf(DigestFactory.getDigest(name[0]).getClass(), statByte, statInt); }
		 * 
		 ...
		 * byte[seqOfnextRoots.size()][]; for (int i = 0; i < nextRoot.length; i++) { nextRoot[i] =
		 * ((DEROctetString)seqOfnextRoots.getObjectAt(i)) .getOctets(); }
		 * 
		 * // --- Decode <nextNextRoot>. ASN1Sequence seqOfnextNextRoot =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(17); ASN1Sequence seqOfnextNextRootStat;
		 * ASN1Sequence seqOfnextNextRootBytes; ASN1Sequence seqOfnextNextRootInts; ASN1Sequence
		 * seqOfnextNextRootString; ASN1Sequence seqOfnextNextRootTreeH; ASN1Sequence
		 * seqOfnextNextRootRetain;
		 * 
		 ...
		 * 
		 * // decode treehash of nextNextRoot // --------------------------------- ASN1Sequence
		 * seqOfnextNextRootTreeHStat; ASN1Sequence seqOfnextNextRootTreeHBytes; ASN1Sequence
		 * seqOfnextNextRootTreeHInts; ASN1Sequence seqOfnextNextRootTreeHString;
		 * 
		 ...
		 * (ASN1Sequence)seqOfnextNextRootTreeH .getObjectAt(k); seqOfnextNextRootTreeHString =
		 * (ASN1Sequence)seqOfnextNextRootTreeHStat .getObjectAt(0); seqOfnextNextRootTreeHBytes =
		 * (ASN1Sequence)seqOfnextNextRootTreeHStat .getObjectAt(1); seqOfnextNextRootTreeHInts =
		 * (ASN1Sequence)seqOfnextNextRootTreeHStat .getObjectAt(2);
		 * 
		 * String[] name = new String[2]; name[0] =
		 * ((DERIA5String)seqOfnextNextRootTreeHString.getObjectAt(0)) .getString(); name[1] =
		 * ((DERIA5String)seqOfnextNextRootTreeHString.getObjectAt(1)) .getString();
		 * 
		 ...
		 * (statByte[0].length == 0) { // if null was encoded statByte[0] = null; }
		 * 
		 * statByte[1] = ((DEROctetString)seqOfnextNextRootTreeHBytes .getObjectAt(1)).getOctets();
		 * statByte[2] = ((DEROctetString)seqOfnextNextRootTreeHBytes .getObjectAt(2)).getOctets();
		 * for (int j = 0; j < tailLength; j++) { statByte[3 + j] =
		 * ((DEROctetString)seqOfnextNextRootTreeHBytes .getObjectAt(3 + j)).getOctets(); } int[]
		 * statInt = new int[6 + tailLength]; statInt[0] =
		 ...
		 * nnRTreehash[k] = new Treehash(DigestFactory.getDigest(name[0]).getClass(), statByte,
		 * statInt); } // ---------------------------------
		 * 
		 * // decode retain of nextNextRoot // --------------------------------- // ASN1Sequence
		 * seqOfnextNextRootRetainPart0 = // (ASN1Sequence)seqOfnextNextRootRetain.get(0);
		 * ASN1Sequence seqOfnextNextRootRetainPart1;
		 * 
		 * Vector[] nnRRetain = new Vector[seqOfnextNextRootRetain.size()]; for (int j = 0; j <
		 * nnRRetain.length; j++) { seqOfnextNextRootRetainPart1 =
		 * (ASN1Sequence)seqOfnextNextRootRetain .getObjectAt(j); nnRRetain[j] = new Vector(); for
		 * (int k = 0; k < seqOfnextNextRootRetainPart1.size(); k++) { nnRRetain[j]
		 * .addElement(((DEROctetString)seqOfnextNextRootRetainPart1 .getObjectAt(k)).getOctets());
		 * } } // ---------------------------------
		 * 
		 * String[] name = new String[2]; name[0] =
		 ...
		 * 
		 * int heightOfTree = checkBigIntegerInIntRange(seqOfnextNextRootInts.getObjectAt(0)); int
		 * tailLength = checkBigIntegerInIntRange(seqOfnextNextRootInts.getObjectAt(7)); byte[][]
		 * statByte = new byte[1 + heightOfTree + tailLength][]; statByte[0] =
		 * ((DEROctetString)seqOfnextNextRootBytes.getObjectAt(0)) .getOctets(); for (int j = 0; j <
		 * heightOfTree; j++) { statByte[1 + j] = ((DEROctetString)seqOfnextNextRootBytes
		 * .getObjectAt(1 + j)).getOctets(); } for (int j = 0; j < tailLength; j++) { statByte[1 +
		 * heightOfTree + j] = ((DEROctetString)seqOfnextNextRootBytes .getObjectAt(1 + heightOfTree
		 * + j)).getOctets(); } int[] statInt = new int[8 + heightOfTree + tailLength]; statInt[0] =
		 * heightOfTree; statInt[1] =
		 ...
		 * checkBigIntegerInIntRange(seqOfnextNextRootInts.getObjectAt(6)); statInt[7] = tailLength;
		 * for (int j = 0; j < heightOfTree; j++) { statInt[8 + j] =
		 * checkBigIntegerInIntRange(seqOfnextNextRootInts.getObjectAt(8 + j)); } for (int j = 0; j
		 * < tailLength; j++) { statInt[8 + heightOfTree + j] =
		 * checkBigIntegerInIntRange(seqOfnextNextRootInts.getObjectAt(8 + heightOfTree + j)); }
		 * nextNextRoot[i] = new GMSSRootCalc(DigestFactory.getDigest(name[0]).getClass(), statByte,
		 * statInt, nnRTreehash, nnRRetain); }
		 * 
		 ...
		 * curRootSig[i] = ((DEROctetString)seqOfcurRootSig.getObjectAt(i)) .getOctets(); }
		 * 
		 * // --- Decode <nextRootSig>. ASN1Sequence seqOfnextRootSigs =
		 * (ASN1Sequence)mtsPrivateKey.getObjectAt(19); ASN1Sequence seqOfnRSStats; ASN1Sequence
		 * seqOfnRSStrings; ASN1Sequence seqOfnRSInts; ASN1Sequence seqOfnRSBytes;
		 * 
		 ...
		 * ((DERIA5String)seqOfnRSStrings.getObjectAt(1)).getString(); byte[][] statByte = new
		 * byte[5][]; statByte[0] = ((DEROctetString)seqOfnRSBytes.getObjectAt(0)) .getOctets();
		 * statByte[1] = ((DEROctetString)seqOfnRSBytes.getObjectAt(1)) .getOctets(); statByte[2] =
		 * ((DEROctetString)seqOfnRSBytes.getObjectAt(2)) .getOctets(); statByte[3] =
		 * ((DEROctetString)seqOfnRSBytes.getObjectAt(3)) .getOctets(); statByte[4] =
		 * ((DEROctetString)seqOfnRSBytes.getObjectAt(4)) .getOctets(); int[] statInt = new int[9];
		 * statInt[0] = checkBigIntegerInIntRange(seqOfnRSInts.getObjectAt(0)); statInt[1] =
		 ...
		 * // --- Decode <name>.
		 * 
		 * // TODO: Really check, why there are multiple algorithms, we only // use the first one!!!
		 * ASN1Sequence namePart = (ASN1Sequence)mtsPrivateKey.getObjectAt(20); String[] name = new
		 * String[namePart.size()]; for (int i = 0; i < name.length; i++) { name[i] =
		 * ((DERIA5String)namePart.getObjectAt(i)).getString(); }
		 */
	}

	public GMSSPrivateKey(int[] index, byte[][] currentSeed, byte[][] nextNextSeed, byte[][][] currentAuthPath, byte[][][] nextAuthPath,
			Treehash[][] currentTreehash, Treehash[][] nextTreehash, Vector[] currentStack, Vector[] nextStack, Vector[][] currentRetain,
			Vector[][] nextRetain, byte[][][] keep, GMSSLeaf[] nextNextLeaf, GMSSLeaf[] upperLeaf, GMSSLeaf[] upperTreehashLeaf,
			int[] minTreehash, byte[][] nextRoot, GMSSRootCalc[] nextNextRoot, byte[][] currentRootSig, GMSSRootSig[] nextRootSig,
			GMSSParameters gmssParameterset, AlgorithmIdentifier digestAlg) {
		AlgorithmIdentifier[] names = new AlgorithmIdentifier[] { digestAlg };
		this.primitive = encode(index, currentSeed, nextNextSeed, currentAuthPath, nextAuthPath, keep, currentTreehash, nextTreehash,
				currentStack, nextStack, currentRetain, nextRetain, nextNextLeaf, upperLeaf, upperTreehashLeaf, minTreehash, nextRoot,
				nextNextRoot, currentRootSig, nextRootSig, gmssParameterset, names);
	}
	 ...
	 *            tree indices
	 * @param currentSeeds
	 *            seed for the generation of private OTS keys for the current subtrees (TREE)
	 * @param nextNextSeeds
	 *            seed for the generation of private OTS keys for the subtrees after next (TREE++)
	 ...
	 * @param nextNextLeaf
	 *            array of upcoming leafs of the tree after next (LEAF++) of each layer
	 * @param upperLeaf
	 ...
	 * @param algorithms
	 *            An array of algorithm identifiers, containing the hash function details
	 */
	private ASN1Primitive encode(int[] index, byte[][] currentSeeds, byte[][] nextNextSeeds, byte[][][] currentAuthPaths,
			byte[][][] nextAuthPaths, byte[][][] keep, Treehash[][] currentTreehash, Treehash[][] nextTreehash, Vector[] currentStack,
			Vector[] nextStack, Vector[][] currentRetain, Vector[][] nextRetain, GMSSLeaf[] nextNextLeaf, GMSSLeaf[] upperLeaf,
			GMSSLeaf[] upperTreehashLeaf, int[] minTreehash, byte[][] nextRoot, GMSSRootCalc[] nextNextRoot, byte[][] currentRootSig,
