...
public class PKCS12PfxPdu {
	...
	public boolean isMacValid(PKCS12MacCalculatorBuilderProvider macCalcProviderBuilder, char[] password) throws PKCSException {
		if (hasMac()) {
			...
			MacDataGenerator mdGen = new MacDataGenerator(
					macCalcProviderBuilder.get(new AlgorithmIdentifier(pfxmData.getMac().getAlgorithmId().getAlgorithm(),
	 ...
	 * 
	 * @param encoding
	 *            encoding style (ASN1Encoding.DER, ASN1Encoding.DL, ASN1Encoding.BER)
