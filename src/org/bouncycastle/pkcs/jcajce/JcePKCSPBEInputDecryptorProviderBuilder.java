...
public class JcePKCSPBEInputDecryptorProviderBuilder {
	...
	/**
	 * Set the lookup provider of AlgorithmIdentifier returning key_size_in_bits used to handle
	 * PKCS5 decryption.
	 *
	 * @param keySizeProvider
			...
			public InputDecryptor get(final AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
				...
				try {
					if (algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
						...
						cipher.init(Cipher.DECRYPT_MODE, new PKCS12KeyWithParameters(password, wrongPKCS12Zero, pbeParams.getIV(),
