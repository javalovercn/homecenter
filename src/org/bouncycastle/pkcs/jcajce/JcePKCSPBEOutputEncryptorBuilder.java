...
public class JcePKCSPBEOutputEncryptorBuilder {
	...
	public OutputEncryptor build(final char[] password) throws OperatorCreationException {
		...
		try {
			if (algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
				...
				key = keyFact.generateSecret(new PBEKeySpec(password, salt, iterationCount,
	...
	private boolean isPKCS12(ASN1ObjectIdentifier algorithm) {
		return algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds) || algorithm.on(BCObjectIdentifiers.bc_pbe_sha1_pkcs12)
