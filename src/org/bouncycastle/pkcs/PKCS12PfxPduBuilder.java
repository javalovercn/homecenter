...
public class PKCS12PfxPduBuilder {
	...
	public PKCS12PfxPduBuilder addData(PKCS12SafeBag data) throws IOException {
		dataVector
				.add(new ContentInfo(PKCSObjectIdentifiers.data, new DEROctetString(new DLSequence(data.toASN1Structure()).getEncoded())));
	 ...
	 *
	 * @param macCalcBuilder
	 *            a builder for a PKCS12 mac calculator.
	 * @param password
	 *            the password to use.
	 * @return a Pfx object.
