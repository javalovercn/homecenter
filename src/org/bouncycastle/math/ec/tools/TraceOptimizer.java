...
public class TraceOptimizer {
	...
	public static void implPrintNonZeroTraceBits(X9ECParameters x9) {
		 ...
		 * 
		 * See section 3.6.2 of "Guide to Elliptic Curve Cryptography" (Hankerson, Menezes,
		 * Vanstone)
		 */
		{
			for (int i = 0; i < m; ++i) {
		...
		/*
		 * Check calculation based on the non-zero-trace bits against explicit calculation, for
