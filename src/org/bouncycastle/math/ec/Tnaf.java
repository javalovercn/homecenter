...
class Tnaf {
	...
	/**
	 * Computes the norm of an element <code>&lambda;</code> of <code><b>R</b>[&tau;]</code>, where
	 * <code>&lambda; = u + v&tau;</code> and <code>u</code> and <code>u</code> are real numbers
	 * (elements of <code><b>R</b></code>).
	 * 
	 * @param mu
	 *            The parameter <code>&mu;</code> of the elliptic curve.
	 * @param u
	 ...
	 *            <code><b>R</b>[&tau;]</code>.
	 * @param v
	 *            The <code>&tau;</code>-adic part of the element <code>&lambda;</code> of
	 *            <code><b>R</b>[&tau;]</code>.
	 * @return The norm of <code>&lambda;</code>.
	 */
	 ...
	 * 
	 * @param curve
	 *            The elliptic curve from which to obtain <code>&mu;</code>. The curve must be a
	 *            Koblitz curve, i.e. <code>a</code> equals <code>0</code> or <code>1</code> and
	 *            <code>b</code> equals <code>1</code>.
	...
	/**
	 * Computes the auxiliary values <code>s<sub>0</sub></code> and <code>s<sub>1</sub></code> used
	 * for partial modular reduction.
	 * 
	 * @param curve
	 *            The elliptic curve for which to compute <code>s<sub>0</sub></code> and
	...
	/**
	 * Multiplies a {@link org.bouncycastle.math.ec.ECPoint.AbstractF2m ECPoint.AbstractF2m} by a
	 * <code>BigInteger</code> using the reduced <code>&tau;</code>-adic NAF (RTNAF) method.
	 * 
	 * @param p
	...
	/**
	 * Multiplies a {@link org.bouncycastle.math.ec.ECPoint.AbstractF2m ECPoint.AbstractF2m} by an
	 * element <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> using the
	 ...
	 *            The parameter &mu; of the elliptic curve.
	 * @param lambda
	 *            The element <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> of which to
