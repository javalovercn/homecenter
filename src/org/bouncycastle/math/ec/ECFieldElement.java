...
public abstract class ECFieldElement implements ECConstants {
	...
	/**
	 * Class representing the Elements of the finite field <code>F<sub>2<sup>m</sup></sub></code> in
	 * polynomial basis (PB) representation. Both trinomial (TPB) and pentanomial (PPB) polynomial
	 * basis representations are supported. Gaussian normal basis (GNB) representation is not
	 * supported.
	 */
	public static class F2m extends ECFieldElement {
		/**
		 * Indicates gaussian normal basis representation (GNB). Number chosen according to X9.62.
		...
		/**
		 * Checks, if the ECFieldElements <code>a</code> and <code>b</code> are elements of the same
		 * field <code>F<sub>2<sup>m</sup></sub></code> (having the same representation).
		 * 
		 * @param a
		 *            field element.
		 * @param b
		 ...
		 *             if <code>a</code> and <code>b</code> are not elements of the same field
		 *             <code>F<sub>2<sup>m</sup></sub></code> (having the same representation).
		 */
		...
		/**
		 * @return the representation of the field <code>F<sub>2<sup>m</sup></sub></code>, either of
