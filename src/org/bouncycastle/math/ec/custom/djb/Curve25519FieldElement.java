...
public class Curve25519FieldElement extends ECFieldElement {
	...
	private static final int[] PRECOMP_POW2 = new int[] { 0x4a0ea0b0, 0xc4ee1b27, 0xad2fe478, 0x2f431806, 0x3dfbd7a7, 0x2b4d0099,
	...
	public ECFieldElement sqrt() {
		 ...
		 * 
		 * Breaking up the exponent's binary representation into "repunits", we get: { 251 1s } { 1
		 * 0s }
		 * 
		 * Therefore we need an addition chain containing 251 (the lengths of the repunits) We use:
		 * 1, 2, 3, 4, 7, 11, 15, 30, 60, 120, 131, [251]
		 */
