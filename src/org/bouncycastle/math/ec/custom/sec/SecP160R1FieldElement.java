...
public class SecP160R1FieldElement extends ECFieldElement {
	...
	public ECFieldElement sqrt() {
		 ...
		 *
		 * Breaking up the exponent's binary representation into "repunits", we get: { 129 1s } { 29
		 * 0s }
		 *
		 * Therefore we need an addition chain containing 129 (the length of the repunit) We use: 1,
