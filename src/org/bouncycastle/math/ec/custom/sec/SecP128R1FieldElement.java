...
public class SecP128R1FieldElement extends ECFieldElement {
	...
	public ECFieldElement sqrt() {
		 ...
		 *
		 * Breaking up the exponent's binary representation into "repunits", we get: { 31 1s } { 95
		 * 0s }
		 *
		 * Therefore we need an addition chain containing 31 (the length of the repunit) We use: 1,
		 * 2, 4, 8, 10, 20, 30, [31]
		 */
