...
public class SecT283Field {
	...
	private static final long[] ROOT_Z = new long[] { 0x0C30C30C30C30808L, 0x30C30C30C30C30C3L, 0x820820820820830CL, 0x0820820820820820L,
			0x2082082L };
	...
	protected static void implMultiply(long[] x, long[] y, long[] zz) {
		/*
		 * Formula (17) from "Some New Results on Binary Polynomial Multiplication", Murat Cenk and
		 * M. Anwar Hasan.
		 *
