...
public abstract class ECCurve {
	...
	public static int[] getAllCoordinateSystems() {
		return new int[] { COORD_AFFINE, COORD_HOMOGENEOUS, COORD_JACOBIAN, COORD_JACOBIAN_CHUDNOVSKY, COORD_JACOBIAN_MODIFIED,
	...
	public boolean equals(ECCurve other) {
		return this == other || (null != other && getField().equals(other.getField())
				&& getA().toBigInteger().equals(other.getA().toBigInteger()) && getB().toBigInteger().equals(other.getB().toBigInteger()));
	}
	...
	public static abstract class AbstractF2m extends ECCurve {
		...
		/**
		 * The auxiliary values <code>s<sub>0</sub></code> and <code>s<sub>1</sub></code> used for
