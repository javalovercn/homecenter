...
public class TimeStampResponse {
	 ...
	 * @throws IOException
	 *             if the byte array doesn't represent an ASN.1 encoding.
	 */
	 ...
	 *             if the response is malformed.
	 * @throws IOException
	 *             if the stream doesn't represent an ASN.1 encoding.
	 */
	...
	public void validate(TimeStampRequest request) throws TSPException {
		...
		if (tok != null) {
			...
			if (scV1 != null && scV2 != null) {
				/*
				 * RFC 5035 5.4. If both attributes exist in a single message, they are
