...
public class TimeStampResponseGenerator {
	 ...
	 * @param genTime
	 *            generation time for the response token.
	 ...
	 * <p>
	 * If genTime is null a timeNotAvailable or a validation exception occurs a
	 * TSPValidationException will be thrown. The parent TSPException will only occur on some sort
	 * of system failure.
	 * </p>
	 * 
	 * @param request
	...
	/**
	 * Return a granted response, if the passed in request passes validation with the passed in
	 * status string.
	 * <p>
	 * If genTime is null a timeNotAvailable or a validation exception occurs a
	 * TSPValidationException will be thrown. The parent TSPException will only occur on some sort
	 ...
	 * systemFailure. The return value of exception.getMessage() will be used as the status string
	 * for the response.
	 *
	 * @param exception
	 *            the exception thrown on validating the request.
	 * @return a TimeStampResponse.
	 * @throws TSPException
