...
public class CMSTimeStampedData {
	...
	public CMSTimeStampedData addTimeStamp(TimeStampToken token) throws CMSException {
		...
		return new CMSTimeStampedData(new ContentInfo(CMSObjectIdentifiers.timestampedData,
				new TimeStampedData(timeStampedData.getDataUri(), timeStampedData.getMetaData(), timeStampedData.getContent(),
	 ...
	 * @throws ImprintDigestInvalidException
	 *             if the token is not present in the message, or an imprint digest fails to
	 *             compare.
	 * @throws CMSException
	 *             if an exception occurs processing the message.
	 */
