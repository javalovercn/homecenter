...
class X509Util {
	...
	static byte[] calculateSignature(ASN1ObjectIdentifier sigOid, String sigName, String provider, PrivateKey key, SecureRandom random,
	...
	/**
	 * see if we can find an algorithm (or its alias and what it represents) in the property table
