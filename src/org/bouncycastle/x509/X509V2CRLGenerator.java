...
public class X509V2CRLGenerator {
	...
	/**
	 * generate an X509 CRL, based on the current issuer and subject, using the passed in provider
	 * for the signing.
	 * 
	 * @deprecated use generate()
	 */
	...
	/**
	 * generate an X509 CRL, based on the current issuer and subject using the default provider and
	 * an user defined SecureRandom object as source of randomness.
	 * <p>
	 * <b>Note:</b> this differs from the deprecated method in that the default provider is used -
	 * not "BC".
	 * </p>
	 ...
	 * provider for the signing.
	 */
	public X509CRL generate(PrivateKey key, String provider) throws CRLException, IllegalStateException, NoSuchProviderException,
	 ...
	 * for the signing.
	 */
	public X509CRL generate(PrivateKey key, String provider, SecureRandom random) throws CRLException, IllegalStateException,
