 ...
 * with the <code>algorithm</code> parameter to the <code>getInstance</code> methods.
 * <p>
 * Implementations must implement the {@link org.bouncycastle.x509.X509StreamParserSpi}.
 */
public class X509StreamParser implements StreamParser {
	 ...
	 *                if the requested type is not available in the default provider package or any
	 *                of the other provider packages that were searched.
	 */
