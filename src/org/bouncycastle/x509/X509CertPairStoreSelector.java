 ...
 * are e.g. used for cross certificates. The set of criteria is given from two
 * {@link org.bouncycastle.x509.X509CertStoreSelector}s which must be both matched.
 * 
...
public class X509CertPairStoreSelector implements Selector {
	...
	/**
	 * Decides if the given certificate pair should be selected. If <code>obj</code> is not a
	 * {@link X509CertificatePair} this method returns <code>false</code>.
	 * 
	 * @param obj
