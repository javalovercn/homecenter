...
public class X509V3CertificateGenerator {
	...
	/**
	 * Set the subject distinguished name. The subject describes the entity associated with the
	 * public key.
	 */
	...
	/**
	 * add a given extension field for the standard extensions tag (tag 3) The value parameter
	 * becomes the contents of the octet string associated with the extension.
	 */
	 ...
	 * provider.
	 * <p>
	 * <b>Note:</b> this differs from the deprecated method in that the default provider is used -
	 * not "BC".
	 * </p>
	 */
	 ...
	 * provider for the signing.
	 */
	public X509Certificate generate(PrivateKey key, String provider) throws CertificateEncodingException, IllegalStateException,
	 ...
	 * provider for the signing and the supplied source of randomness, if required.
	 */
	public X509Certificate generate(PrivateKey key, String provider, SecureRandom random) throws CertificateEncodingException,
			IllegalStateException, NoSuchProviderException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
		TBSCertificate tbsCert = generateTbsCert();
		byte[] signature;
