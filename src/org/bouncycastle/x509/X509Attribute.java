...
public class X509Attribute extends ASN1Object {
	...
	/**
	 * Create an X.509 Attribute with the type given by the passed in oid and the value represented
	 * by an ASN.1 Set containing value.
	 * 
	 * @param oid
	...
	/**
	 * Create an X.59 Attribute with the type given by the passed in oid and the value represented
	 * by an ASN.1 Set containing the objects in value.
	 * 
	 * @param oid
	 *            type of the attribute
	 * @param value
