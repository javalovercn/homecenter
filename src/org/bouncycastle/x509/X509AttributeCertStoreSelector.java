...
public class X509AttributeCertStoreSelector implements Selector {
			...
			if (targetInfoExt != null) {
				...
				try {
					targetinfo = TargetInformation.getInstance(
							new ASN1InputStream(((DEROctetString) DEROctetString.fromByteArray(targetInfoExt)).getOctets()).readObject());
				} catch (IOException e) {
					return false;
	 ...
	 * extension criteria. The <code>X509AttributeCertificate</code> must contain at least one of
	 * the specified target names.
	 * <p>
