...
public class ExtendedPKIXParameters extends PKIXParameters {
	...
	/**
	 * Creates an instance of <code>PKIXParameters</code> with the specified <code>Set</code> of
	 * most-trusted CAs. Each element of the set is a {@link TrustAnchor TrustAnchor}.
	 * <p>
	...
	/**
	 * Method to support <code>clone()</code> under J2ME. <code>super.clone()</code> does not exist
	 * and fields are not copied.
	 * 
	 * @param params
	 *            Parameters to set. If this are <code>ExtendedPKIXParameters</code> they are copied
	 *            to.
	 */
	 ...
	 * certificates were valid at the signing time. Both are indirectly choosen with the
	 * {@link PKIXParameters#setDate(java.util.Date)} method, so this methods sets the Date when
	 * <em>all</em> certificates must have been valid.
	 */
	 ...
	 * when the CA certificate was signed and so on. So the
	 * {@link PKIXParameters#setDate(java.util.Date)} method sets the time, when the <em>end
	 * certificate</em> must have been valid.
	 * <p>
	 ...
	 * 
	 * @throws ClassCastException
	 *             if an element of <code>stores</code> is not a <code>CertStore</code>.
	 */
	...
	/**
	 * Returns an immutable <code>List</code> of additional Bouncy Castle <code>Store</code>s used
	 * for finding CRLs, certificates, attribute certificates or cross certificates.
	 * 
	 * @return an immutable <code>List</code> of additional Bouncy Castle <code>Store</code>s. Never
	 *         <code>null</code>.
	 * 
	...
	/**
	 * Returns an immutable <code>List</code> of Bouncy Castle <code>Store</code>s used for finding
	 * CRLs, certificates, attribute certificates or cross certificates.
	 * 
	 * @return an immutable <code>List</code> of Bouncy Castle <code>Store</code>s. Never
	 *         <code>null</code>.
	 * 
	 * @see #setStores(List)
	 */
	 ...
	 * constraints are returned as an instance of <code>Selector</code>. If <code>null</code>, no
	 ...
	 * constraints are specified as an instance of <code>Selector</code>. If <code>null</code>, no
	 * constraints are defined.
	 * <p>
	 * The target certificate in a PKIX path may be a certificate or an attribute certificate.
	 * <p>
	 ...
	 * 
	 * @param selector
	 *            a <code>Selector</code> specifying the constraints on the target certificate or
	 *            attribute certificate (or <code>null</code>)
	 ...
	 * instance of <code>X509CertSelector</code>. If <code>null</code>, no constraints are defined.
	 * 
	 * <p>
	 ...
	 * 
	 * @param selector
	 *            a <code>X509CertSelector</code> specifying the constraints on the target
	 ...
	 * trusted AC issuers must be set.
	 * <p>
	 * The <code>trustedACIssuers</code> must be a <code>Set</code> of <code>TrustAnchor</code>
	 * <p>
	 ...
	 * @throws ClassCastException
	 *             if an element of <code>stores</code> is not a <code>TrustAnchor</code>.
	 */
	 ...
	 * <p>
	 * The returned <code>Set</code> is immutable and contains <code>String</code>s with the OIDs.
	 * 
	 ...
	 * @throws ClassCastException
	 *             if an element of <code>necessaryACAttributes</code> is not a <code>String</code>.
	 */
	 ...
	 * 
	 * @return Returns the attribute certificate checker. Is never <code>null</code>.
	 */
	 ...
	 *            The attribute certificate checkers to set. Is never <code>null</code>.
	 * @throws ClassCastException
