...
public class X509CRLStoreSelector extends X509CRLSelector implements Selector {
	 ...
	 * revocation for the specified attribute certificate. If <code>null</code> is specified, then
	 * no such optional information is provided.
	 * 
	 * @param attrCert
	 *            the <code>X509AttributeCertificate</code> being checked (or <code>null</code>)
