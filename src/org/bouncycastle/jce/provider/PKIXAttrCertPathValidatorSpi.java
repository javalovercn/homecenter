...
public class PKIXAttrCertPathValidatorSpi extends CertPathValidatorSpi {
	 ...
	 * 
	 * <p>
	 * <code>params</code> must be an instance of <code>ExtendedPKIXParameters</code>.
	 * <p>
	 * The target constraints in the <code>params</code> must be an
	 * <code>X509AttributeCertStoreSelector</code> with at least the attribute certificate criterion
	 * set. Obey that also target informations may be necessary to correctly validate this attribute
	 * certificate.
	 * <p>
	 * The attribute certificate issuer must be added to the trusted attribute issuers with
