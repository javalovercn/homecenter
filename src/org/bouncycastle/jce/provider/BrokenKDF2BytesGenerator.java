...
public class BrokenKDF2BytesGenerator implements DerivationFunction {
	...
	/**
	 * Construct a KDF2 Parameters generator. Generates key material according to IEEE P1363a - if
	 * you want orthodox results you should use a digest specified in the standard.
	 * <p>
	 * <b>Note:</b> IEEE P1363a standard is still a draft standard, if the standard changes this
	 * function, the output of this function will change as well. Don't use this routine for
	 * anything subject to long term storage.
	 *
	 * @param digest
