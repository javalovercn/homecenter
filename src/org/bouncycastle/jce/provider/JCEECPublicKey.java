		...
		if (algorithm.equals("ECGOST3410")) {
			if (gostParams != null) {
				...
				if (ecSpec instanceof ECNamedCurveSpec) {
					params = new GOST3410PublicKeyAlgParameters(ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec) ecSpec).getName()),
			...
			ASN1OctetString p = (ASN1OctetString) new X9ECPoint(curve.createPoint(this.getQ().getAffineXCoord().toBigInteger(),
