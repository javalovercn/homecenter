...
public class X509Principal extends X509Name implements Principal {
	...
	/**
	 * Takes an X509 dir name as a string of the format "C=AU,ST=Victoria", or some such, converting
	 * it into an ordered set of name attributes. If reverse is false the dir name will be encoded
	 * in the order of the (name, value) pairs presented, otherwise the encoding will start with the
	 ...
	 * that OID. and numeric oids will be processed automatically.
	 * <p>
