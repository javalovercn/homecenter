...
public class X509LDAPCertStoreParameters implements X509StoreParameters, CertStoreParameters {
	...
	public static class Builder {
		 ...
		 *            Attribute name(s) in the LDAP directory where end certificates are stored.
		 *            Separated by space. Defaults to "userCertificate" if <code>null</code>.
		 ...
		 *            Attribute name(s) in the LDAP directory where CA certificates are stored.
		 *            Separated by space. Defaults to "cACertificate" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s), where the cross certificates are stored. Separated by
		 *            space. Defaults to "crossCertificatePair" if <code>null</code>
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s) in the LDAP directory where CRLs are stored. Separated by
		 *            space. Defaults to "certificateRevocationList" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s) in the LDAP directory where delta RLs are stored. Separated
		 *            by space. Defaults to "deltaRevocationList" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s) in the LDAP directory where CRLs for authorities are stored.
		 *            Separated by space. Defaults to "authorityRevocationList" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute name(s) in the LDAP directory where end attribute certificates are
		 *            stored. Separated by space. Defaults to "attributeCertificateAttribute" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute name(s) in the LDAP directory where attribute certificates for
		 *            attribute authorities are stored. Separated by space. Defaults to
		 *            "aACertificate" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s) in the LDAP directory where self signed attribute
		 *            certificates for attribute authorities are stored. Separated by space.
		 *            Defaults to "attributeDescriptorCertificate" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s) in the LDAP directory where CRLs for attribute certificates
		 ...
		 *            Attribute name(s) in the LDAP directory where RLs for attribute authority
		 *            attribute certificates are stored. Separated by space. Defaults to
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified <code>userCertificateSubjectAttributeName</code>. E.g.
		 *            if "cn" is used to put information about the subject for end certificates,
		 *            then specify "cn".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified <code>cACertificateSubjectAttributeName</code>. E.g. if
		 *            "ou" is used to put information about the subject for CA certificates, then
		 *            specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified <code>crossCertificateSubjectAttributeName</code>. E.g.
		 *            if "o" is used to put information about the subject for cross certificates,
		 *            then specify "o".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            <code>certificateRevocationListIssuerAttributeName</code>. E.g. if "ou" is
		 *            used to put information about the issuer of CRLs, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified <code>deltaRevocationListIssuerAttributeName</code>.
		 *            E.g. if "ou" is used to put information about the issuer of CRLs, specify
		 *            "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified
		 *            <code>authorityRevocationListIssuerAttributeName</code>. E.g. if "ou" is used
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified
		 *            <code>attributeCertificateAttributeSubjectAttributeName</code>. E.g. if "cn"
		 *            is used to put information about the subject of end attribute certificates,
		 *            specify "cn".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified <code>aACertificateSubjectAttributeName</code>. E.g. if
		 *            "ou" is used to put information about the subject of attribute authority
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified
		 *            <code>attributeDescriptorCertificateSubjectAttributeName</code>. E.g. if "o"
		 *            is used to put information about the subject of self signed attribute
		 *            authority attribute certificates, specify "o".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified
		 *            <code>attributeCertificateRevocationListIssuerAttributeName</code>. E.g. if
		 *            "ou" is used to put information about the issuer of CRLs, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for the attribute
		 *            value of the specified
		 *            <code>attributeAuthorityRevocationListIssuerAttributeName</code>. E.g. if "ou"
		 ...
		 *            Attribute(s) in the subject of the certificate which is used to be searched in
		 *            the <code>ldapUserCertificateAttributeName</code>. E.g. the "cn" attribute of
		 *            the DN could be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute(s) in the subject of the certificate which is used to be searched in
		 *            the <code>ldapCACertificateAttributeName</code>. E.g. the "ou" attribute of
		 *            the DN could be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute(s) in the subject of the cross certificate which is used to be
		 *            searched in the <code>ldapCrossCertificateAttributeName</code>. E.g. the "o"
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched in the
		 *            <code>ldapCertificateRevocationListAttributeName</code>. E.g. the "o" or "ou"
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched in the
		 *            <code>ldapDeltaRevocationListAttributeName</code>. E.g. the "o" or "ou"
		 *            attribute may be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched in the
		 *            <code>ldapAuthorityRevocationListAttributeName</code>. E.g. the "o" or "ou"
		 *            attribute may be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute(s) in the subject of the attribute certificate which is used to be
		 *            searched in the <code>ldapAttributeCertificateAttributeAttributeName</code>.
		 ...
		 *            Attribute(s) in the subject of the attribute certificate which is used to be
		 *            searched in the <code>ldapAACertificateAttributeName</code>. E.g. the "ou"
		 ...
		 *            Attribute(s) in the subject of the attribute certificate which is used to be
		 *            searched in the <code>ldapAttributeDescriptorCertificateAttributeName</code>.
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched in the
		 *            <code>ldapAttributeCertificateRevocationListAttributeName</code>. E.g. the "o"
		 *            or "ou" attribute may be used certificate is searched in this LDAP attribute.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Anttribute(s) in the issuer of the CRL which is used to be searched in the
		 *            <code>ldapAttributeAuthorityRevocationListAttributeName</code>. E.g. the "o"
		 *            or "ou" attribute may be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            If not <code>null</code> the serial number of the certificate is searched in
		 *            this LDAP attribute.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		...
		public X509LDAPCertStoreParameters build() {
			if (ldapUserCertificateAttributeName == null // migrate to setters
					...
					|| ldapCertificateRevocationListAttributeName == null || ldapDeltaRevocationListAttributeName == null
					|| ldapAuthorityRevocationListAttributeName == null || ldapAttributeCertificateAttributeAttributeName == null
					|| ldapAACertificateAttributeName == null || ldapAttributeDescriptorCertificateAttributeName == null
					|| ldapAttributeCertificateRevocationListAttributeName == null
					|| ldapAttributeAuthorityRevocationListAttributeName == null || userCertificateSubjectAttributeName == null
					|| cACertificateSubjectAttributeName == null || crossCertificateSubjectAttributeName == null
					|| certificateRevocationListIssuerAttributeName == null || deltaRevocationListIssuerAttributeName == null
					|| authorityRevocationListIssuerAttributeName == null || attributeCertificateAttributeSubjectAttributeName == null
					|| aACertificateSubjectAttributeName == null || attributeDescriptorCertificateSubjectAttributeName == null
