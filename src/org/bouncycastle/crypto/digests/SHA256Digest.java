...
public class SHA256Digest extends GeneralDigest implements EncodableDigest {
	...
	public void reset() {
		...
		/*
		 * SHA-256 initial hash value The first 32 bits of the fractional parts of the square roots
	...
	/*
	 * SHA-256 Constants (represent the first 32 bits of the fractional parts of the cube roots of
