...
public class CustomNamedCurves {
	...
	static X9ECParametersHolder curve25519 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			 ...
			 * involves substitution of variables, so the base-point x coordinate is 9 + (486662 /
			 * 3).
			 * 
			 * The Curve25519 paper doesn't say which of the two possible y values the base point
			 * has. The choice here is guided by language in the Ed25519 paper.
			 * 
			 * (The other possible y value is
			 * 5F51E65E475F794B1FE122D388B72EB36DC2B28192839E4DD6163A5D81312C14)
			 */
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A"
	...
	static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			byte[] S = null;
			GLVTypeBParameters glv = new GLVTypeBParameters(new BigInteger("9ba48cba5ebcb9b6bd33b92830b2a2e0e192f10a", 16),
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "3B4C382CE37AA192A4019E763036F4F5DD4D7EBB" + "938CF935318FDCED6BC28286531733C3F03C4FEE"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder secp160r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "4A96B5688EF573284664698968C38BB913CBFC82" + "23A628553168947D59DCC912042351377AC5FB32"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder secp160r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "52DCB034293A117E1F4FF11B30F7199D3144CE6D" + "FEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			byte[] S = null;
			GLVTypeBParameters glv = new GLVTypeBParameters(new BigInteger("bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16),
	...
	static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			byte[] S = null;
			GLVTypeBParameters glv = new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16),
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C"
	...
	static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21"
	...
	static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			GLVTypeBParameters glv = new GLVTypeBParameters(
					...
					new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16),
					272);
	...
	static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "02FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE8" + "0289070FB05D38FF58321F2E800536D538CCDAA3D9"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "0369979697AB43897789566789567F787A7876A654" + "00435EDB42EFAFB2989D51FEFCE3C80988F41FF883"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "03F0EBA16286A2D57EA0991168D4994637E8343E36" + "00D51FBC6C71A0094FA2CDD545B11C5C0C797324F1"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode(
					"04" + "01F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E1" + "0025E399F2903712CCF3EA9E3A1AD17FB0B3201B6AF7CE1B05"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode(
					"04" + "00D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F" + "01CE94335607C304AC29E7DEFBD9CA01F596F927224CDECF6C"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect233r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "00FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B"
	...
	static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "29A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC"
	...
	static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "0503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC2458492836"
	...
	static X9ECParametersHolder sect283r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "05F939258DB7DD90E1934F8C70B0DFEC2EED25B8557EAC9C80E2E198F8CDBECD86B12053"
