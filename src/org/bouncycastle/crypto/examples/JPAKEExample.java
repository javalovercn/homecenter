...
public class JPAKEExample {
	...
	public static void main(String args[]) throws CryptoException {
		 ...
		 * Initialization
		 * 
		 * Pick an appropriate prime order group to use throughout the exchange. Note that both
		 * participants must use the same group.
		 */
		...
		System.out.println("KP{x1}={" + aliceRound1Payload.getKnowledgeProofForX1()[0].toString(16) + "};{"
				+ aliceRound1Payload.getKnowledgeProofForX1()[1].toString(16) + "}");
		System.out.println("KP{x2}={" + aliceRound1Payload.getKnowledgeProofForX2()[0].toString(16) + "};{"
		...
		System.out.println("KP{x3}={" + bobRound1Payload.getKnowledgeProofForX1()[0].toString(16) + "};{"
				+ bobRound1Payload.getKnowledgeProofForX1()[1].toString(16) + "}");
		System.out.println("KP{x4}={" + bobRound1Payload.getKnowledgeProofForX2()[0].toString(16) + "};{"
		...
		System.out.println("KP{x2*s}={" + aliceRound2Payload.getKnowledgeProofForX2s()[0].toString(16) + "},{"
				+ aliceRound2Payload.getKnowledgeProofForX2s()[1].toString(16) + "}");
		System.out.println("");

		System.out.println("Bob sends to Alice");
		System.out.println("B=" + bobRound2Payload.getA().toString(16));
		System.out.println("KP{x4*s}={" + bobRound2Payload.getKnowledgeProofForX2s()[0].toString(16) + "},{"
		...
		/*
		 * You must derive a session key from the keying material applicable to whatever encryption
		...
		/*
		 * At this point, you can stop and use the session keys if you want. This is implicit key
		 * confirmation.
		 * 
		 * If you want to explicitly confirm that the key material matches, you can continue on and
		 * perform round 3.
		 */
