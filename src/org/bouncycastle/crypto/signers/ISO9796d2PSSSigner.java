...
public class ISO9796d2PSSSigner implements SignerWithRecovery {
	 ...
	 * @param param
	 *            parameters for signature generation/verification. If the parameters are for
	 *            generation they should be a ParametersWithRandom, a ParametersWithSalt, or just an
	 *            RSAKeyParameters object. If RSAKeyParameters are passed in a SecureRandom will be
	 *            created.
	...
	/**
	 * Return a reference to the recoveredMessage message, either as it was added to a just
	 * generated signature, or extracted from a verified one.
	 *
