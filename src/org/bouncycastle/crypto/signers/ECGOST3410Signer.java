...
public class ECGOST3410Signer implements DSA {
	...
	/**
	 * return true if the value r and s represent a GOST3410 signature for the passed in message
	 * (for standard GOST3410 the message should be a GOST3411 hash of the real message to be
	 * verified).
	 */
