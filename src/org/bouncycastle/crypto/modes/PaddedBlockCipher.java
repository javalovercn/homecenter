...
public class PaddedBlockCipher extends BufferedBlockCipher {
	 ...
	 * @return the space required to accommodate a call to update and doFinal with len bytes of
	 *         input.
	 */
	 ...
	 * @exception DataLengthException
	 *                if there is insufficient space in out for the output or we are decrypting and
	 *                the input is not block size aligned.
	 * @exception IllegalStateException
