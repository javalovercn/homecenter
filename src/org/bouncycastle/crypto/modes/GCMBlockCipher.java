...
public class GCMBlockCipher implements AEADBlockCipher {
	...
	public int doFinal(byte[] out, int outOff) throws IllegalStateException, InvalidCipherTextException {
		...
		if (atLength > atLengthPre) {
			/*
			 * Some AAD was sent after the cipher started. We determine the difference b/w the hash
			 * value we actually used when the cipher started (S_atPre) and the final hash value
			 * calculated (S_at). Then we carry this difference forward by multiplying by H^c, where
			 * c is the number of (full or partial) cipher-text blocks produced, and adjust the
			 * current hash.
			 */
