 ...
 * <p>
 * NIST
 * <a href="http://csrc.nist.gov/groups/ST/toolkit/documents/Examples/DSA2_All.pdf">publishes</a>
...
public class JPAKEPrimeOrderGroup {
	 ...
	 * </ul>
	 * <p>
	 * The prime checks are performed using {@link BigInteger#isProbablePrime(int)}, and are
	 * therefore subject to the same probability guarantees.
	 * <p>
	 * These checks prevent trivial mistakes. However, due to the small uncertainties if p and q are
	 * not prime, advanced attacks are not prevented. Use it at your own risk.
	 *
	 ...
	 * {@link JPAKEPrimeOrderGroups}. These pre-approved groups can avoid the expensive checks.
	 */
