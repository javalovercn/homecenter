...
public class SRP6Util {
	...
	/**
	 * Computes the client evidence message (M1) according to the standard routine: M1 = H( A | B |
	 * S )
	 * 
	 * @param digest
	...
	/**
	 * Computes the server evidence message (M2) according to the standard routine: M2 = H( A | M1 |
	 * S )
	 * 
	 * @param digest
	 *            The Digest used as the hashing function H
