...
public class DESKeyGenerator extends CipherKeyGenerator {
	/**
	 * initialise the key generator - if strength is set to zero the key generated will be 64 bits
	 * in size, otherwise strength can be 64 or 56 bits (if you don't count the parity bits).
	 *
	 * @param param
