 ...
 * paper, the order of key setup and salt setup is reversed: state <- ExpandKey(state, 0, key) state
 * <- ExpandKey(state, 0, salt) This corresponds to the OpenBSD reference implementation of Bcrypt.
 * </p>
 * <p>
...
public final class BCrypt {
	...
	private static final int[] MAGIC_STRING = { 0x4F727068, 0x65616E42, 0x65686F6C, 0x64657253, 0x63727944, 0x6F756274 };
	final static int MAGIC_STRING_LENGTH = 6;

	private final static int[] KP = { 0x243F6A88, 0x85A308D3, 0x13198A2E, 0x03707344, 0xA4093822, 0x299F31D0, 0x082EFA98, 0xEC4E6C89,
			0x452821E6, 0x38D01377, 0xBE5466CF, 0x34E90C6C, 0xC0AC29B7, 0xC97C50DD, 0x3F84D5B5, 0xB5470917, 0x9216D5D9, 0x8979FB1B },

			KS0 = { 0xD1310BA6, 0x98DFB5AC, 0x2FFD72DB, 0xD01ADFB7, 0xB8E1AFED, 0x6A267E96, 0xBA7C9045, 0xF12C7F99, 0x24A19947, 0xB3916CF7,
			...
			KS1 = { 0x4B7A70E9, 0xB5B32944, 0xDB75092E, 0xC4192623, 0xAD6EA6B0, 0x49A7DF7D, 0x9CEE60B8, 0x8FEDB266, 0xECAA8C71, 0x699A17FF,
			...
			KS2 = { 0xE93D5A68, 0x948140F7, 0xF64C261C, 0x94692934, 0x411520F7, 0x7602D4F7, 0xBCF46B2E, 0xD4A20068, 0xD4082471, 0x3320F46A,
			...
			KS3 = { 0x3A39CE37, 0xD3FAF5CF, 0xABC27737, 0x5AC52D1B, 0x5CB0679E, 0x4FA33742, 0xD3822740, 0x99BC9BBE, 0xD5118E9D, 0xBF0F7315,
	...
	private int F(int x) {
		return (((S[(x >>> 24)] + S[SBOX_SK + ((x >>> 16) & 0xff)]) ^ S[SBOX_SK2 + ((x >>> 8) & 0xff)]) + S[SBOX_SK3 + (x & 0xff)]);
	}
	...
	private byte[] encryptMagicString() {
		int[] text = { MAGIC_STRING[0], MAGIC_STRING[1], MAGIC_STRING[2], MAGIC_STRING[3], MAGIC_STRING[4], MAGIC_STRING[5] };
		for (int i = 0; i < 64; i++) {
