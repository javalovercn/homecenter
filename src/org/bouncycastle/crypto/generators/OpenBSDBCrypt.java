...
public class OpenBSDBCrypt {
	private static final byte[] encodingTable = // the Bcrypts encoding table for OpenBSD
			{ (byte) '.', (byte) '/', (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H',
					...
					(byte) 'w', (byte) 'x', (byte) 'y', (byte) 'z', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4', (byte) '5',
	...
	/**
	 * Creates a 60 character Bcrypt String, including version, cost factor, salt and hash,
	 * separated by '$'
	 *
	 * @param cost
	 ...
	 *
	 * @param bcryptString
	 *            a 60 character Bcrypt String, including version, cost factor, salt and hash,
	 *            separated by '$'
	 * @param password
	 ...
	 * 
	 * @exception InvalidArgumentException if the parameter contains a value other than from Bcrypts
