...
public class RSAKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
	...
	public AsymmetricCipherKeyPair generateKeyPair() {
		...
		while (!done) {
			...
			for (;;) {
				...
				/*
				 * Require a minimum weight of the NAF representation, since low-weight composites
				 * may be weak against a version of the number-field-sieve for factoring.
				 *
	...
	private static int getNumberOfIterations(int bits, int certainty) {
		 ...
		 * certainty is higher than the FIPS 186-4 tables (C.2/C.3) cater to, extra iterations are
		 * added at the "worst case rate" for the excess.
		 */
		if (bits >= 1536) {
