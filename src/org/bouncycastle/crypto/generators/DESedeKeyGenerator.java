...
public class DESedeKeyGenerator extends DESKeyGenerator {
	...
	/**
	 * initialise the key generator - if strength is set to zero the key generated will be 192 bits
	 * in size, otherwise strength can be 128 or 192 (or 112 or 168 if you don't count parity bits),
