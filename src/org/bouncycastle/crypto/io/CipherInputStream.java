...
public class CipherInputStream extends FilterInputStream {
	 ...
	 *             if the data read from the stream was invalid ciphertext (e.g. the cipher is an
	 *             AEAD cipher and the ciphertext tag check fails).
	 */
	 ...
	 * supports marking, and the cipher passed in to this stream's constructor is a SkippingCipher
	 * (so capable of being reset to an arbitrary point easily).
	 * </p>
	 * 
	 * @param readlimit
