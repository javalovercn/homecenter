...
public class CipherOutputStream extends FilterOutputStream {
	 ...
	 * <p>
	 * The <code>write</code> method of <code>CipherOutputStream</code> calls the <code>write</code>
	 ...
	 *             if the data written to this stream was invalid ciphertext (e.g. the cipher is an
