...
public class HashCommitter implements Committer {
	...
	/**
	 * Base Constructor. The maximum message length that can be committed to is half the length of
	 * the internal block size for the digest (ExtendedDigest.getBlockLength()).
	 *
	 * @param digest
