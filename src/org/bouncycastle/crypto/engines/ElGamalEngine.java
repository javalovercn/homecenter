...
public class ElGamalEngine implements AsymmetricBlockCipher {
	...
	/**
	 * Return the maximum size for an input block to this engine. For ElGamal this is always one
	 * byte less than the size of P on encryption, and twice the length as the size of P on
	 * decryption.
	 *
	...
	/**
	 * Return the maximum size for an output block to this engine. For ElGamal this is always one
	 * byte less than the size of P on decryption, and twice the length as the size of P on
	 * encryption.
	 *
