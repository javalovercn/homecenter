...
class RSACoreEngine {
	...
	/**
	 * Return the maximum size for an input block to this engine. For RSA this is always one byte
	 * less than the key size on encryption, and the same length as the key size on decryption.
	 *
