...
/**
 * Wrap keys according to <A HREF="https://www.ietf.org/rfc/rfc3217.txt"> RFC 3217</A>.
 * <p>
 * Note:
 * <ul>
 * <li>if you are using this to wrap triple-des keys you need to set the parity bits on the key and,
 * if it's a two-key triple-des key, pad it yourself.
 * </ul>
 */
public class DESedeWrapEngine implements Wrapper {
	...
	/** Field IV2 */
	private static final byte[] IV2 = { (byte) 0x4a, (byte) 0xdd, (byte) 0xa2, (byte) 0x2c, (byte) 0x79, (byte) 0xe8, (byte) 0x21,
			(byte) 0x05 };
	 ...
	 * @param param
	 *            necessary parameters, may include KeyParameter, ParametersWithRandom, and
	 *            ParametersWithIV
	 */
	...
	public byte[] unwrap(byte[] in, int inOff, int inLen) throws InvalidCipherTextException {
		...
		/*
		 * // Check if the length of the cipher text is reasonable given the key // type. It must be
		 ...
		 * key is intended, // return error. // // we do not accept 168 bit keys. it has to be 192
		 * bit. int lengthA = (estimatedKeyLengthInBit / 8) + 16; int lengthB =
		 * estimatedKeyLengthInBit % 8;
		 * 
	...
	/**
	 * Some key wrap algorithms make use of the Key Checksum defined in CMS [CMS-Algorithms]. This
	 * is used to provide an integrity check value for the key being wrapped. The algorithm is
	 *
