...
public class CramerShoupCoreEngine {
	...
	/**
	 * Return the maximum size for an input block to this engine. For Cramer Shoup this is always
	 * one byte less than the key size on encryption, and the same length as the key size on
	 * decryption. TODO: correct?
	 * 
	...
	/**
	 * Return the maximum size for an output block to this engine. For Cramer Shoup this is always
	 * one byte less than the key size on decryption, and the same length as the key size on
	 * encryption. TODO: correct?
	 * 
