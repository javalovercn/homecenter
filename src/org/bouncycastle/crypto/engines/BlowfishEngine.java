...
public final class BlowfishEngine implements BlockCipher {
	...
	private void setKey(byte[] key) {
		/*
		 * - comments are from _Applied Crypto_, Schneier, p338 please be careful comparing the two,
		 * AC numbers the arrays from 1, the enclosed code from 0.
		 *
		 * (1) Initialise the S-boxes and the P-array, with a fixed string This string contains the
		...
		/*
		 * (2) Now, XOR P[0] with the first 32 bits of the key, XOR P[1] with the second 32-bits of
		 * the key, and so on for all bits of the key (up to P[17]). Repeatedly cycle through the
		 * key bits until the entire P-array has been XOR-ed with the key bits
		 */
