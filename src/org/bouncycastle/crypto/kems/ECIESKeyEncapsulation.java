...
public class ECIESKeyEncapsulation implements KeyEncapsulation {
	 ...
	 *            the random source for the session key.
	 * @param cofactorMode
	 *            true to use the new cofactor ECDH.
	 * @param oldCofactorMode
	 *            true to use the old cofactor ECDH.
	 * @param singleHashMode
	 *            true to use single hash mode.
	 */
	public ECIESKeyEncapsulation(DerivationFunction kdf, SecureRandom rnd, boolean cofactorMode, boolean oldCofactorMode,
	 ...
	 *
	 * @param key
	 *            the recipient's public (for encryption) or private (for decryption) key.
	 */
