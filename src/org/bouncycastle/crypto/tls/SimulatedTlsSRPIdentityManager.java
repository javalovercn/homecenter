...
/**
 * An implementation of {@link TlsSRPIdentityManager} that simulates the existence of "unknown"
...
public class SimulatedTlsSRPIdentityManager implements TlsSRPIdentityManager {
	 ...
	 *
	 * @param group
	 *            the {@link SRP6GroupParameters} defining the group that SRP is operating in
	 * @param seedKey
