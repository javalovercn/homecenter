...
public final class SessionParameters {
	public static final class Builder {
		...
		public SessionParameters build() {
			...
			return new SessionParameters(cipherSuite, compressionAlgorithm, masterSecret, peerCertificate, pskIdentity, srpIdentity,
	...
	private SessionParameters(int cipherSuite, short compressionAlgorithm, byte[] masterSecret, Certificate peerCertificate,
			byte[] pskIdentity, byte[] srpIdentity, byte[] encodedServerExtensions) {
		this.cipherSuite = cipherSuite;
		this.compressionAlgorithm = compressionAlgorithm;
