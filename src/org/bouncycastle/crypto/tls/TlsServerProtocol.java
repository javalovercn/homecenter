...
public class TlsServerProtocol extends TlsProtocol {
	...
	protected void receiveClientHelloMessage(ByteArrayInputStream buf) throws IOException {
		 ...
		 */
		{
			...
			if (renegExtData != null) {
				/*
				 * If the extension is present, set secure_renegotiation flag to TRUE. The server
				 * MUST then verify that the length of the "renegotiated_connection" field is zero,
	...
	protected void sendServerHelloMessage() throws IOException {
		...
		if (!Arrays.contains(offeredCipherSuites, selectedCipherSuite) || selectedCipherSuite == CipherSuite.TLS_NULL_WITH_NULL_NULL
		...
		if (this.serverExtensions != null) {
			...
			this.securityParameters.maxFragmentLength = processMaxFragmentLengthExtension(clientExtensions, serverExtensions,
