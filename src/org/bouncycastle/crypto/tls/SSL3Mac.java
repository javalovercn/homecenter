...
public class SSL3Mac implements Mac {
	...
	/**
	 * Base constructor for one of the standard digest algorithms that the byteLength of the
	 * algorithm is know for. Behaviour is undefined for digests other than MD5 or SHA1.
	 *
	 * @param digest
	 *            the digest.
	 */
