...
public class DTLSServerProtocol extends DTLSProtocol {
	...
	protected byte[] generateServerHello(ServerHandshakeState state) throws IOException {
		...
		if (state.serverExtensions != null) {
			...
			securityParameters.maxFragmentLength = evaluateMaxFragmentLengthExtension(state.resumedSession, state.clientExtensions,
					state.serverExtensions, AlertDescription.internal_error);
			 ...
			 */
			state.allowCertificateStatus = !state.resumedSession && TlsUtils.hasExpectedEmptyExtensionData(state.serverExtensions,
					TlsExtensionsUtils.EXT_status_request, AlertDescription.internal_error);

			state.expectSessionTicket = !state.resumedSession && TlsUtils.hasExpectedEmptyExtensionData(state.serverExtensions,
