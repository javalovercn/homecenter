 ...
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setKey(byte[]) key}.</li>
 * <li>Randomised hashing, by providing a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setNonce(byte[]) nonce}.</li>
 * <li>A hash function for digital signatures, associating a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setPublicKey(byte[]) public key}
 * with the message digest.</li>
 * <li>A key derivation function, by providing a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setKeyIdentifier(byte[]) key
 * identifier}.</li>
...
public class SkeinParameterSpec implements AlgorithmParameterSpec {
	...
	public static class Builder {
		 ...
		 * {@value org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} (reserved for
		 * message body).
		 * <p>
		 * Parameters with type <
		 * {@value org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} are processed
		 * before the message content, parameters with type >
		 * {@value org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} are processed
		...
		/**
		 * Sets the {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY}
		 * parameter.
		 */
		 ...
		 * doesn't use a Gregorian calender so that the GeneralizedTime produced is compatible
		 * implementations.
		 * <p/>
		 * The format is <code>YYYYMMDD email@address distinguisher</code>, encoded to a byte
		 * sequence using UTF-8 encoding.
		...
		/**
		 * Sets the {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_NONCE}
		 * parameter.
		 *
		 * @return the current builder instance.
		 */
		...
		/**
		 * Constructs a new {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec} instance with
		 * the parameters provided to this builder.
		 */
