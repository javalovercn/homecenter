...
public class PKIXExtendedBuilderParameters implements CertPathParameters {
	...
	public static class Builder {
		...
		/**
		 * Sets the maximum number of intermediate non-self-issued certificates in a certification
		 * path. The PKIX <code>CertPathBuilder</code> must not build paths longer then this length.
		 * <p>
		 * A value of 0 implies that the path can only contain a single certificate. A value of -1
		 * does not limit the length. The default length is 5.
		 *
		 * <p>
		 *
		 ...
		 *
		 * @param maxPathLength
		 *            the maximum number of non-self-issued intermediate certificates in the
		 *            certification path
