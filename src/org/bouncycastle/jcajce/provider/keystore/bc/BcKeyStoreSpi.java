...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
	 ...
	 * disk, so the password is mandatory, however if you hard drive is in a bad part of town and
	 * you absolutely, positively, don't want nobody peeking at your things, this is the one to use,
	 * no problem! After all in a Bouncy Castle nothing can touch you.
	 *
