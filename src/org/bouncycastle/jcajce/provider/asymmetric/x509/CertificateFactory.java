...
public class CertificateFactory extends CertificateFactorySpi {
	 ...
	 * inStream.
	 *
	 * The inStream may contain a sequence of DER-encoded CRLs, or a PKCS#7 CRL set. This is a
	 * PKCS#7 SignedData object, with the only signficant field being crls. In particular the
	 * signature and the contents are ignored.
	 */
