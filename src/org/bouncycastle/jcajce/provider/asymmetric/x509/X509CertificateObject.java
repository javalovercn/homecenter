...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
	...
	public X509CertificateObject(JcaJceHelper bcHelper, org.bouncycastle.asn1.x509.Certificate c) throws CertificateParsingException {
	...
	/**
	 * return a more "meaningful" representation for the signature algorithm used in the
	 * certificate.
	 */
		...
		if (this.getVersion() == 3) {
			...
			if (extensions != null) {
				...
				while (e.hasMoreElements()) {
					...
					if (oid.equals(Extension.keyUsage) || oid.equals(Extension.certificatePolicies) || oid.equals(Extension.policyMappings)
							|| oid.equals(Extension.inhibitAnyPolicy) || oid.equals(Extension.cRLDistributionPoints)
