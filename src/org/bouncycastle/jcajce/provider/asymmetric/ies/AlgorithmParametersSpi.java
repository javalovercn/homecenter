...
public class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
	...
	protected void engineInit(byte[] params) throws IOException {
		try {
			...
			this.currentSpec = new IESParameterSpec(((ASN1OctetString) s.getObjectAt(0)).getOctets(),
					((ASN1OctetString) s.getObjectAt(0)).getOctets(), ((ASN1Integer) s.getObjectAt(0)).getValue().intValue());
