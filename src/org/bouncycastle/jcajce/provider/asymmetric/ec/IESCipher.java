...
public class IESCipher extends CipherSpi {
	...
	static public class ECIESwithDESede extends ECIESwithCipher {
		public ECIESwithDESede() {
			super(new DESedeEngine());
		}
	}

	static public class ECIESwithAES extends ECIESwithCipher {
		public ECIESwithAES() {
			super(new AESEngine());
		}
	}
	...
	static public class OldECIESwithDESede extends OldECIESwithCipher {
		public OldECIESwithDESede() {
			super(new DESedeEngine());
		}
	}

	static public class OldECIESwithAES extends OldECIESwithCipher {
		public OldECIESwithAES() {
			super(new AESEngine());
		}
	}

	static public class OldECIESwithDESedeCBC extends OldECIESwithCipher {
		public OldECIESwithDESedeCBC() {
			super(new CBCBlockCipher(new DESedeEngine()), 8);
		}
	}

	static public class OldECIESwithAESCBC extends OldECIESwithCipher {
