...
public class PKIXExtendedParameters implements CertPathParameters {
	...
	public static class Builder {
		 ...
		 *
		 * @param trustAnchors
		 *            a set of trustAnchors, one of which a particular end-entity and it's
	...
	/**
	 * Returns the required constraints on the target certificate. The constraints are returned as
	 * an instance of <code>Selector</code>. If <code>null</code>, no constraints are defined.
	 *
