...
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
	...
	public static class Builder {
		 ...
		 *            <code>true</code> if the delta CRL indicator extension must be in the CRL.
		 */
		 ...
		 * <p>
		 * This is only meaningful for delta CRLs. Complete CRLs must have a CRL number which is
		 * greater or equal than the base number of the corresponding CRL.
		 *
		 ...
		 * <p>
		 * The issuing distribution point extension is a CRL extension which identifies the scope
		 * and the distribution point of a CRL. The scope contains among others information about
		 * revocation reasons contained in the CRL. Delta CRLs and complete CRLs must have matching
		 ...
		 *            The issuing distribution point to set. This is the DER encoded OCTET STRING
		 *            extension value.
	 ...
	 * <code>false</code>.
	 * <p>
	 * You may also set the issuing distribution point criteria if not a missing issuing
	 * distribution point should be assumed.
	 * 
	...
	public static Collection<? extends CRL> getCRLs(final PKIXCRLStoreSelector selector, CertStore certStore) throws CertStoreException {
