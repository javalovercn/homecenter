...
public class DVCSRequestInfo {
	 ...
	 *
	 * @param in
	 *            a byte array holding the encoding of a DVCSRequestInformation structure.
	 */
	 ...
	 *
	 * @param data
	 *            a DVCSRequestInformation to populate this object with.
	 */
	 ...
	 *             if a request time is present but cannot be extracted.
	 */
	...
	/**
	 * Get data locations, where the copy of request Data can be obtained. Note: the exact meaning
	 * of field is up to applications. Note: this field can be set by DVCS.
	 *
