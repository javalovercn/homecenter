...
public class TeleTrusTNamedCurves {
	...
	static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve curve = configureCurve(new ECCurve.Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), // q
	...
	static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve curve = configureCurve(new ECCurve.Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), // q
	...
	static X9ECParametersHolder brainpoolP224r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve curve = configureCurve(new ECCurve.Fp(new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF", 16), // q
	...
	static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve curve = configureCurve(
					new ECCurve.Fp(new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377", 16), // q
	...
	static X9ECParametersHolder brainpoolP320r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve curve = configureCurve(
					new ECCurve.Fp(new BigInteger("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27", 16), // q
