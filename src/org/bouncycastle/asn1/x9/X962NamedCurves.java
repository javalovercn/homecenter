...
public class X962NamedCurves {
	static X9ECParametersHolder prime192v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			return new X9ECParameters(cFp192v1, new X9ECPoint(cFp192v1, Hex.decode("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")),
					n, h, Hex.decode("3045AE6FC8422f64ED579528D38120EAE12196D5"));
		}
	};
	...
	static X9ECParametersHolder prime192v2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			return new X9ECParameters(cFp192v2, new X9ECPoint(cFp192v2, Hex.decode("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")),
	...
	static X9ECParametersHolder prime192v3 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			return new X9ECParameters(cFp192v3, new X9ECPoint(cFp192v3, Hex.decode("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")),
					n, h, Hex.decode("c469684435deb378c4b65ca9591e2a5763059a2e"));
		}
	};
	...
	static X9ECParametersHolder prime239v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve cFp239v1 = new ECCurve.Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"),
			...
			return new X9ECParameters(cFp239v1,
					new X9ECPoint(cFp239v1, Hex.decode("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")), n, h,
	...
	static X9ECParametersHolder prime239v2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve cFp239v2 = new ECCurve.Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"),
					new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16),
					new BigInteger("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c", 16), n, h);

			return new X9ECParameters(cFp239v2,
					new X9ECPoint(cFp239v2, Hex.decode("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")), n, h,
	...
	static X9ECParametersHolder prime239v3 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve cFp239v3 = new ECCurve.Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"),
					new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16),
					new BigInteger("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e", 16), n, h);

			return new X9ECParameters(cFp239v3,
					new X9ECPoint(cFp239v3, Hex.decode("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")), n, h,
	...
	static X9ECParametersHolder prime256v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			return new X9ECParameters(cFp256v1,
					new X9ECPoint(cFp256v1, Hex.decode("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")), n, h,
	...
	static X9ECParametersHolder c2pnb163v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m163v1 = new ECCurve.F2m(163, 1, 2, 8, new BigInteger("072546B5435234A422E0789675F432C89435DE5242", 16),
					new BigInteger("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9", 16), c2m163v1n, c2m163v1h);

			return new X9ECParameters(c2m163v1, new X9ECPoint(c2m163v1, Hex.decode("0307AF69989546103D79329FCC3D74880F33BBE803CB")),
					c2m163v1n, c2m163v1h, Hex.decode("D2C0FB15760860DEF1EEF4D696E6768756151754"));
		}
	};
	...
	static X9ECParametersHolder c2pnb163v2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m163v2 = new ECCurve.F2m(163, 1, 2, 8, new BigInteger("0108B39E77C4B108BED981ED0E890E117C511CF072", 16),
					new BigInteger("0667ACEB38AF4E488C407433FFAE4F1C811638DF20", 16), c2m163v2n, c2m163v2h);

			return new X9ECParameters(c2m163v2, new X9ECPoint(c2m163v2, Hex.decode("030024266E4EB5106D0A964D92C4860E2671DB9B6CC5")),
					c2m163v2n, c2m163v2h, null);
		}
	};
	...
	static X9ECParametersHolder c2pnb163v3 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m163v3 = new ECCurve.F2m(163, 1, 2, 8, new BigInteger("07A526C63D3E25A256A007699F5447E32AE456B50E", 16),
					new BigInteger("03F7061798EB99E238FD6F1BF95B48FEEB4854252B", 16), c2m163v3n, c2m163v3h);

			return new X9ECParameters(c2m163v3, new X9ECPoint(c2m163v3, Hex.decode("0202F9F87B7C574D0BDECF8A22E6524775F98CDEBDCB")),
					c2m163v3n, c2m163v3h, null);
		}
	};
	...
	static X9ECParametersHolder c2pnb176w1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m176w1 = new ECCurve.F2m(176, 1, 2, 43, new BigInteger("00E4E6DB2995065C407D9D39B8D0967B96704BA8E9C90B", 16),
					new BigInteger("005DDA470ABE6414DE8EC133AE28E9BBD7FCEC0AE0FFF2", 16), c2m176w1n, c2m176w1h);

			return new X9ECParameters(c2m176w1, new X9ECPoint(c2m176w1, Hex.decode("038D16C2866798B600F9F08BB4A8E860F3298CE04A5798")),
					c2m176w1n, c2m176w1h, null);
		}
	};
	...
	static X9ECParametersHolder c2tnb191v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m191v1 = new ECCurve.F2m(191, 9, new BigInteger("2866537B676752636A68F56554E12640276B649EF7526267", 16),
					new BigInteger("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC", 16), c2m191v1n, c2m191v1h);

			return new X9ECParameters(c2m191v1, new X9ECPoint(c2m191v1, Hex.decode("0236B3DAF8A23206F9C4F299D7B21A9C369137F2C84AE1AA0D")),
	...
	static X9ECParametersHolder c2tnb191v2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m191v2 = new ECCurve.F2m(191, 9, new BigInteger("401028774D7777C7B7666D1366EA432071274F89FF01E718", 16),
					new BigInteger("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01", 16), c2m191v2n, c2m191v2h);

			return new X9ECParameters(c2m191v2, new X9ECPoint(c2m191v2, Hex.decode("023809B2B7CC1B28CC5A87926AAD83FD28789E81E2C9E3BF10")),
	...
	static X9ECParametersHolder c2tnb191v3 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m191v3 = new ECCurve.F2m(191, 9, new BigInteger("6C01074756099122221056911C77D77E77A777E7E7E77FCB", 16),
					new BigInteger("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8", 16), c2m191v3n, c2m191v3h);

			return new X9ECParameters(c2m191v3, new X9ECPoint(c2m191v3, Hex.decode("03375D4CE24FDE434489DE8746E71786015009E66E38A926DD")),
	...
	static X9ECParametersHolder c2pnb208w1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			return new X9ECParameters(c2m208w1,
					new X9ECPoint(c2m208w1, Hex.decode("0289FDFBE4ABE193DF9559ECF07AC0CE78554E2784EB8C1ED1A57A")), c2m208w1n, c2m208w1h,
					null);
		}
	};
	...
	static X9ECParametersHolder c2tnb239v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m239v1 = new ECCurve.F2m(239, 36, new BigInteger("32010857077C5431123A46B808906756F543423E8D27877578125778AC76", 16),
					new BigInteger("790408F2EEDAF392B012EDEFB3392F30F4327C0CA3F31FC383C422AA8C16", 16), c2m239v1n, c2m239v1h);

			return new X9ECParameters(c2m239v1,
					new X9ECPoint(c2m239v1, Hex.decode("0257927098FA932E7C0A96D3FD5B706EF7E5F5C156E16B7E7C86038552E91D")), c2m239v1n,
					c2m239v1h, null);
		}
	};
	...
	static X9ECParametersHolder c2tnb239v2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m239v2 = new ECCurve.F2m(239, 36, new BigInteger("4230017757A767FAE42398569B746325D45313AF0766266479B75654E65F", 16),
					new BigInteger("5037EA654196CFF0CD82B2C14A2FCF2E3FF8775285B545722F03EACDB74B", 16), c2m239v2n, c2m239v2h);

			return new X9ECParameters(c2m239v2,
					new X9ECPoint(c2m239v2, Hex.decode("0228F9D04E900069C8DC47A08534FE76D2B900B7D7EF31F5709F200C4CA205")), c2m239v2n,
					c2m239v2h, null);
		}
	};
	...
	static X9ECParametersHolder c2tnb239v3 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m239v3 = new ECCurve.F2m(239, 36, new BigInteger("01238774666A67766D6676F778E676B66999176666E687666D8766C66A9F", 16),
					new BigInteger("6A941977BA9F6A435199ACFC51067ED587F519C5ECB541B8E44111DE1D40", 16), c2m239v3n, c2m239v3h);

			return new X9ECParameters(c2m239v3,
					new X9ECPoint(c2m239v3, Hex.decode("0370F6E9D04D289C4E89913CE3530BFDE903977D42B146D539BF1BDE4E9C92")), c2m239v3n,
					c2m239v3h, null);
		}
	};
	...
	static X9ECParametersHolder c2pnb272w1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m272w1 = new ECCurve.F2m(272, 1, 3, 56,
					...
					new BigInteger("7167EFC92BB2E3CE7C8AAAFF34E12A9C557003D7C73A6FAF003F99F6CC8482E540F7", 16), c2m272w1n, c2m272w1h);

			return new X9ECParameters(c2m272w1,
					new X9ECPoint(c2m272w1, Hex.decode("026108BABB2CEEBCF787058A056CBE0CFE622D7723A289E08A07AE13EF0D10D171DD8D")),
	...
	static X9ECParametersHolder c2pnb304w1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m304w1 = new ECCurve.F2m(304, 1, 2, 11,
					...
					new BigInteger("00BDDB97E555A50A908E43B01C798EA5DAA6788F1EA2794EFCF57166B8C14039601E55827340BE", 16), c2m304w1n,
					c2m304w1h);

			return new X9ECParameters(c2m304w1,
					new X9ECPoint(c2m304w1, Hex.decode("02197B07845E9BE2D96ADB0F5F3C7F2CFFBD7A3EB8B6FEC35C7FD67F26DDF6285A644F740A2614")),
	...
	static X9ECParametersHolder c2tnb359v1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m359v1 = new ECCurve.F2m(359, 68,
			...
			return new X9ECParameters(c2m359v1,
	...
	static X9ECParametersHolder c2pnb368w1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			ECCurve c2m368w1 = new ECCurve.F2m(368, 1, 2, 85,
			...
			return new X9ECParameters(c2m368w1,
	...
	static X9ECParametersHolder c2tnb431r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			BigInteger c2m431r1n = new BigInteger(
					"0340340340340340340340340340340340340340340340340340340323C313FAB50589703B5EC68D3587FEC60D161CC149C1AD4A91", 16);
			BigInteger c2m431r1h = BigInteger.valueOf(0x2760);

			ECCurve c2m431r1 = new ECCurve.F2m(431, 120, new BigInteger(
					"1A827EF00DD6FC0E234CAF046C6A5D8A85395B236CC4AD2CF32A0CADBDC9DDF620B0EB9906D0957F6C6FEACD615468DF104DE296CD8F", 16),
					new BigInteger(
