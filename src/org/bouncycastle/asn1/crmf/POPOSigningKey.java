...
public class POPOSigningKey extends ASN1Object {
	 ...
	 *
	 * @param poposkIn
	 *            the POPOSigningKeyInput structure, or null if the CertTemplate includes both
	 *            subject and publicKey values.
	 * @param aid
	 *            the AlgorithmIdentifier used to sign the proof of possession.
	 * @param signature
	 *            a signature over the DER-encoded value of poposkIn, or the DER-encoded value of
	 *            certReq if poposkIn is null.
	 */
