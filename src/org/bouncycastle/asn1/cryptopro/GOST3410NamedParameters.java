...
public class GOST3410NamedParameters {
	...
	static private GOST3410ParamSetParameters cryptoProA = new GOST3410ParamSetParameters(1024, new BigInteger(
			...
			new BigInteger("68363196144955700784444165611827252895102170888761442055095051287550314083023"), new BigInteger(
	...
	static private GOST3410ParamSetParameters cryptoProB = new GOST3410ParamSetParameters(1024, new BigInteger(
			...
			new BigInteger("79885141663410976897627118935756323747307951916507639758300472692338873533959"), new BigInteger(
	...
	static private GOST3410ParamSetParameters cryptoProXchA = new GOST3410ParamSetParameters(1024, new BigInteger(
			...
			new BigInteger("91771529896554605945588149018382750217296858393520724172743325725474374979801"), new BigInteger(
	...
	/**
	 * returns an enumeration containing the name strings for parameters contained in this
	 * structure.
	 */
