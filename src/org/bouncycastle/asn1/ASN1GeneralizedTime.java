...
public class ASN1GeneralizedTime extends ASN1Primitive {
	...
	/**
	 * The correct format for this is YYYYMMDDHHMMSS[.f]Z, or without the Z for local time, or
	 * Z+-HHMM on the end, for difference between local time and UTC time. The fractional second
	 * amount f must consist of at least one number with trailing zeroes removed.
	 *
	 * @param time
	 *            the time string.
	 * @throws IllegalArgumentException
