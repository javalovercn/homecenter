...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
	...
	public int hashCode() {
		return hashCollection(excludedSubtreesDN) + hashCollection(excludedSubtreesDNS) + hashCollection(excludedSubtreesEmail)
				+ hashCollection(excludedSubtreesIP) + hashCollection(excludedSubtreesURI) + hashCollection(permittedSubtreesDN)
				+ hashCollection(permittedSubtreesDNS) + hashCollection(permittedSubtreesEmail) + hashCollection(permittedSubtreesIP)
	 ...
	 *
	 * @param permitted
	 *            A <code>Set</code> of permitted IP addresses with their subnet mask as byte
	 *            arrays.
	 * @param ips
	 *            The IP address with its subnet mask.
	 * @return The <code>Set</code> of permitted IP ranges intersected with <code>ip</code>.
	 */
	 ...
	 *
	 * @param excluded
	 *            A <code>Set</code> of excluded IP addresses with their subnet mask as byte arrays.
	 * @param ip
	 *            The IP address with its subnet mask.
	 * @return The <code>Set</code> of excluded IP ranges unified with <code>ip</code> as byte
	 *         arrays.
	 */
	 ...
	 * @return An array with two elements. Each element contains the IP address and the subnet mask
	 *         in this order.
	 */
	 ...
	 * @return A array with two elements. The first/second element contains the min and max IP
	 *         address of the first/second IP address and its subnet mask.
	 */
	 ...
	 *            The IP address.
	 * @param constraint
	 *            The constraint. This is an IP address concatenated with its subnetmask.
	 ...
	 * <code>union</code>. If <code>email1</code> and <code>email2</code> have nothing in common
	 * they are added both.
	 *
	 * @param email1
	...
	/**
	 * The most restricting part from <code>email1</code> and <code>email2</code> is added to the
