...
/**
 * <code>UserNotice</code> class, used in <code>CertificatePolicies</code> X509 extensions (in
 * policy qualifiers).
 * 
 * <pre>
 * UserNotice ::= SEQUENCE {
...
public class UserNotice extends ASN1Object {
	 ...
	 * Creates a new <code>UserNotice</code> instance.
	 * <p>
	 * Useful from reconstructing a <code>UserNotice</code> instance from its encodable/encoded
	 * form.
	 *
	 * @param as
	 *            an <code>ASN1Sequence</code> value obtained from either calling @{link
	 *            toASN1Primitive()} for a <code>UserNotice</code> instance or from parsing it from
	 *            a DER-encoded stream.
	 */
