...
public class TargetInformation extends ASN1Object {
	...
	/**
	 * According to RFC 3281 only one targets element must be produced. If multiple targets are
	 * given they must be merged in into one targets element.
	 *
	 * @param targets
	 ...
	 * <p>
	 * According to RFC 3281 only one targets element must be produced. If multiple targets are
	 * given in the constructor they are merged into one targets element. If this was produced from
	 * a {@link org.bouncycastle.asn1.ASN1Sequence} the encoding is kept.
	 * 
