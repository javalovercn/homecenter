...
public class AuthorityKeyIdentifier extends ASN1Object {
	...
	/**
	 *
	 * Calulates the keyidentifier using a SHA1 hash over the BIT STRING from SubjectPublicKeyInfo
	...
	/**
	 * create an AuthorityKeyIdentifier with a precomputed key identifier and the GeneralNames tag
