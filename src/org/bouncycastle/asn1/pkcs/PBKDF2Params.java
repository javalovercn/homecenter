...
public class PBKDF2Params extends ASN1Object {
	private static final AlgorithmIdentifier algid_hmacWithSHA1 = new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA1,
			DERNull.INSTANCE);
	...
	/**
	 * Create a PBKDF2Params with the specified salt, iteration count, and algid-hmacWithSHA1 for
	 * the prf.
	 *
	 * @param salt
	 *            input salt.
