...
public class CertificationRequestInfo extends ASN1Object {
	 ...
	 * def shows the attributes field is not optional so should always at least contain an empty
	 * set. If a fully compliant request is required, pass in an empty set, the class will otherwise
