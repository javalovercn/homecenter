...
public class CertificateHolderAuthorization extends ASN1Object {
	...
	static {
		...
		/*
		 * for (int i : RightsDecodeMap.keySet()) ReverseMap.put(RightsDecodeMap.get(i), i);
		 * 
		 * for (int i : AuthorizationRole.keySet()) ReverseMap.put(AuthorizationRole.get(i), i);
		 */
	}
	 ...
	 *
	 * @param oid
	 *            Object Identifier : specifies the format and the rules for the evaluatioin of the
	 *            authorization level.
	 * @param rights
	...
	private void setAccessRights(byte rights) {
		...
		this.accessRights = new DERApplicationSpecific(EACTags.getTag(EACTags.DISCRETIONARY_DATA), accessRights);
	}
