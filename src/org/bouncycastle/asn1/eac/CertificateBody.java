...
public class CertificateBody extends ASN1Object {
		...
		while ((obj = aIS.readObject()) != null) {
			...
			if (obj instanceof DERApplicationSpecific) {
				...
				throw new IOException(
						"Not a valid iso7816 content : not a DERApplicationSpecific Object :" + EACTags.encodeTag(appSpe) + obj.getClass());
			}
	 ...
	 *
	 * @return return the ASN1Primitive representing the "request" or "profile" type certificate
	 *         body.
	 */
	 ...
	 *
	 * @param ced
	 *            DERApplicationSpecific containing the date of the certificate generation
	 * @throws IllegalArgumentException
	 ...
	 *
	 * @param ced
	 *            DERApplicationSpecific containing the date after wich the certificate expires
	 * @throws IllegalArgumentException
