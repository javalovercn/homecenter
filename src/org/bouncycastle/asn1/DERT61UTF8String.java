...
/**
 * DER T61String (also the teletex string) - a "modern" encapsulation that uses UTF-8. If at all
 * possible, avoid this one! It's only for emergencies. Use UTF8String instead.
 * 
