...
public abstract class DSTU4145PointEncoder {
	...
	public static byte[] encodePoint(ECPoint Q) {
		/*
		 * if (!Q.isCompressed()) Q=new ECPoint.F2m(Q.getCurve(),Q.getX(),Q.getY(),true);
		 * 
	...
	public static ECPoint decodePoint(ECCurve curve, byte[] bytes) {
		 ...
		 * bp_enc[0]=0x02; else bp_enc[0]=0x03; System.arraycopy(bytes, 0, bp_enc, 1, bytes.length);
		 * if (!trace(curve.fromBigInteger(new BigInteger(1,
