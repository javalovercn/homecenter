...
/**
 * <a href="http://tools.ietf.org/html/rfc5652#section-9.1">RFC 5652</a> section 9.1: The
 * AuthenticatedData carries AuthAttributes and other data which define what really is being signed.
 * 
 * <pre>
...
public class AuthenticatedData extends ASN1Object {
	...
	public AuthenticatedData(OriginatorInfo originatorInfo, ASN1Set recipientInfos, AlgorithmIdentifier macAlgorithm,
			AlgorithmIdentifier digestAlgorithm, ContentInfo encapsulatedContent, ASN1Set authAttrs, ASN1OctetString mac,
			ASN1Set unauthAttrs) {
