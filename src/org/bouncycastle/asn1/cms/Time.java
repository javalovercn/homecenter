...
/**
 * <a href="http://tools.ietf.org/html/rfc5652#section-11.3">RFC 5652</a>: Dual-mode timestamp
 * format producing either UTCTIme or GeneralizedTime.
 * <p>
 * 
 * <pre>
 * Time ::= CHOICE {
 ...
 * {@link org.bouncycastle.asn1.DERUTCTime DERUTCTime} object if the supplied datetime is in range
 * 1950-01-01-00:00:00 UTC until 2049-12-31-23:59:60 UTC. If the datetime value is outside that
 * range, the generated object will be {@link org.bouncycastle.asn1.DERGeneralizedTime
 * DERGeneralizedTime}.
 */
public class Time extends ASN1Object implements ASN1Choice {
	...
	/**
	 * Creates a time object from a given date - if the date is between 1950 and 2049 a UTCTime
	 * object is generated, otherwise a GeneralizedTime is used.
	 *
	 * @param time
	 ...
	 * constructor if the default locale doesn't use a Gregorian calender so that the
