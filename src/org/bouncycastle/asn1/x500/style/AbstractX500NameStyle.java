...
public abstract class AbstractX500NameStyle implements X500NameStyle {
	...
	/**
	 * For all string values starting with '#' is assumed, that these are already valid ASN.1
	 * objects encoded in hex.
	 * <p>
	 * All other string values are send to
	 * {@link AbstractX500NameStyle#encodeStringValue(ASN1ObjectIdentifier, String)}.
	 * </p>
	 * Subclasses should overwrite
	 * {@link AbstractX500NameStyle#encodeStringValue(ASN1ObjectIdentifier, String)} to change the
