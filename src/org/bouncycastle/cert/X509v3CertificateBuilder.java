...
public class X509v3CertificateBuilder {
	 ...
	 */
	public X509v3CertificateBuilder(X500Name issuer, BigInteger serial, Date notBefore, Date notAfter, X500Name subject,
	 ...
	 *            the info structure for the public key to be associated with this certificate.
	 */
	public X509v3CertificateBuilder(X500Name issuer, BigInteger serial, Date notBefore, Date notAfter, Locale dateLocale, X500Name subject,
			SubjectPublicKeyInfo publicKeyInfo) {
	 ...
	 *            the info structure for the public key to be associated with this certificate.
	 */
	public X509v3CertificateBuilder(X500Name issuer, BigInteger serial, Time notBefore, Time notAfter, X500Name subject,
			SubjectPublicKeyInfo publicKeyInfo) {
	 ...
	 *
	 * @param uniqueID
	 *            a boolean array representing the bits making up the subjectUniqueID.
	 ...
	 *
	 * @param uniqueID
	 *            a boolean array representing the bits making up the issuerUniqueID.
	 * @return this builder object.
	 */
	 ...
	 *            true if the extension is critical, false otherwise.
	 * @param encodedValue
	 *            a byte array representing the encoding of the extension value.
	 * @return this builder object.
	 */
	 ...
	 *            the OID defining the extension type.
	 * @param isCritical
	 *            true if the copied extension is to be marked as critical, false otherwise.
	 * @param certHolder
	 *            the holder for the certificate that the extension is to be copied from.
	 * @return this builder object.
	 */
