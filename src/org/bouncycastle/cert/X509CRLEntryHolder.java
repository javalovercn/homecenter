...
public class X509CRLEntryHolder {
	 ...
	 * CRL entry.
	 * <p>
	 * Note: this will be the issuer of the CRL unless it has been specified that the CRL is
	 * indirect in the IssuingDistributionPoint extension and either a previous entry, or the
	 * current one, has specified a different CA via the certificateIssuer extension.
	 * </p>
	 *
	...
	/**
	 * Returns a set of ASN1ObjectIdentifier objects representing the OIDs of the critical
