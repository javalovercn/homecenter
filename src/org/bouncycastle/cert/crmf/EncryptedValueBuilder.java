...
public class EncryptedValueBuilder {
	 ...
	 * @param encryptor
	 *            an output encryptor to encrypt the actual data contained in the EncryptedValue.
	 */
	...
	/**
	 * Create a builder that makes EncryptedValue structures with fixed length blocks padded using
	 * the passed in padder.
	 *
	 * @param wrapper
	 *            a wrapper for key used to encrypt the actual data contained in the EncryptedValue.
	 * @param encryptor
	 *            an output encryptor to encrypt the actual data contained in the EncryptedValue.
	 * @param padder
	 *            a padder to ensure that the EncryptedValue created will always be a constant
	 *            length.
	 */
