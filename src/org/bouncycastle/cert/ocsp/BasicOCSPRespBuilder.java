...
public class BasicOCSPRespBuilder {
	 ...
	 *
	 * @param key
	 *            the key info of the responder public key.
	 * @param digCalc
	 ...
	 *            optional extensions
	 */
	public BasicOCSPRespBuilder addResponse(CertificateID certID, CertificateStatus certStatus, Date nextUpdate,
	...
	public BasicOCSPResp build(ContentSigner signer, X509CertificateHolder[] chain, Date producedAt) throws OCSPException {
		...
		ResponseData tbsResp = new ResponseData(responderID.toASN1Primitive(), new ASN1GeneralizedTime(producedAt),
