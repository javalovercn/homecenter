...
public class X509ExtensionUtils {
	 ...
	 *
	 * @param certHolder
	 *            the issuer certificate that the AuthorityKeyIdentifier should refer to.
	 ...
	 *
	 * @param publicKeyInfo
	 *            the SubjectPublicKeyInfo to base the key identifier on.
	 * @return an AuthorityKeyIdentifier.
	 */
	 ...
	 *            the SubjectPublicKeyInfo to base the key identifier on.
	 * @param generalNames
	 *            the general names to associate with the issuer cert's issuer.
	 * @param serial
	 *            the serial number of the issuer cert.
	 * @return an AuthorityKeyIdentifier.
	 */
	public AuthorityKeyIdentifier createAuthorityKeyIdentifier(SubjectPublicKeyInfo publicKeyInfo, GeneralNames generalNames,
			BigInteger serial) {
