...
public class X509v2AttributeCertificateBuilder {
	 ...
	 * @param issuer
	 *            issuer of this attribute certificate.
	 * @param serialNumber
	 *            serial number of this attribute certificate.
	 * @param notBefore
	 *            the date before which the certificate is not valid.
	 * @param notAfter
	 *            the date after which the certificate is not valid.
	 */
	public X509v2AttributeCertificateBuilder(AttributeCertificateHolder holder, AttributeCertificateIssuer issuer, BigInteger serialNumber,
	 ...
	 */
	public X509v2AttributeCertificateBuilder(AttributeCertificateHolder holder, AttributeCertificateIssuer issuer, BigInteger serialNumber,
			Date notBefore, Date notAfter, Locale dateLocale) {
		acInfoGen = new V2AttributeCertificateInfoGenerator();
		extGenerator = new ExtensionsGenerator();
	 ...
	 * @return this builder object.
	 */
	public X509v2AttributeCertificateBuilder addExtension(ASN1ObjectIdentifier oid, boolean isCritical, byte[] encodedValue)
			throws CertIOException {
