...
public class ProtectedPKIMessageBuilder {
	 ...
	 *
	 * @param freeText
	 *            the contents of the human readable message,
	 * @return the current builder instance.
	 */
	 ...
	 *
	 * @param genInfo
	 *            the generalInfo data to be added.
	 * @return the current builder instance.
	 */
	 ...
	 *
	 * @param nonce
	 *            a NONCE, typically copied from the sender nonce of the previous message.
	 * @return the current builder instance.
	 */
	 ...
	 *
	 * @param nonce
	 *            a NONCE, typically 128 bits of random data.
	 * @return the current builder instance.
	 */
