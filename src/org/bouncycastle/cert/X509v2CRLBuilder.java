...
public class X509v2CRLBuilder {
	 ...
	 *
	 * @param issuer
	 *            the issuer this CRL is associated with.
	 * @param thisUpdate
	 ...
	 *
	 * @param userCertificateSerial
	 *            serial number of revoked certificate.
	 * @param revocationDate
	 *            date of certificate revocation.
	 * @param reason
	 *            the reason code, as indicated in CRLReason, i.e CRLReason.keyCompromise, or 0 if
	 *            not to be used.
	 * @return the current builder.
	 */
	 ...
	 *            the date on which the private key for the certificate became compromised or the
	 ...
	 * 
	 * @param other
	 *            the X509CRLHolder to source the other entries from.
	 * @return the current builder.
	 */
