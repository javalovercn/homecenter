 ...
 * </pre>
 * <p>
 * <b>Note:</b> If objectDigestInfo comparisons are to be carried out the static method
 * setDigestCalculatorProvider <b>must</b> be called once to configure the class to do the necessary
 * calculations.
 * </p>
 */
public class AttributeCertificateHolder implements Selector {
	 ...
	 *
	 * @param issuerName
	 *            name of associated certificate's issuer.
	 * @param serialNumber
	 ...
	 *
	 * @param cert
	 *            the certificate to be associated with this holder.
	 */
	 ...
	 *            The hash value.
	 */
	public AttributeCertificateHolder(int digestedObjectType, ASN1ObjectIdentifier digestAlgorithm, ASN1ObjectIdentifier otherObjectTypeID,
			byte[] objectDigest) {
		holder = new Holder(new ObjectDigestInfo(digestedObjectType, otherObjectTypeID, new AlgorithmIdentifier(digestAlgorithm),
	 ...
	 * 
	 * @return an array of Principal objects (usually X500Principal), null if no entity names field
	 *         is set.
	 */
