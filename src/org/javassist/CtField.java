...
import org.javassist.compiler.Javac;
import org.javassist.compiler.SymbolTable;
import org.javassist.compiler.ast.ASTree;
import org.javassist.compiler.ast.DoubleConst;
import org.javassist.compiler.ast.IntConst;
import org.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
	...
	/**
	 * Creates a <code>CtField</code> object. The created field must be added to a class with
	 * <code>CtClass.addField()</code>. An initial value of the field is specified by a
	 * <code>CtField.Initializer</code> object.
	 *
	 * <p>
	 * If getter and setter methods are needed, call <code>CtNewMethod.getter()</code> and
	...
	/**
	 * Creates a copy of the given field. The created field must be added to a class with
	 * <code>CtClass.addField()</code>. An initial value of the field is specified by a
	 * <code>CtField.Initializer</code> object.
	 *
	 * <p>
	...
	/**
	 * Returns the FieldInfo representing the field in the class file (read only). Normal
	 * applications do not need calling this method. Use <code>getFieldInfo()</code>.
	 *
	 * <p>
	 * The <code>FieldInfo</code> object obtained by this method is read only. Changes to this
	 ...
	 *
	 * <p>
	 * This method is available even if the <code>CtClass</code> containing this field is frozen.
	 * However, if the class is frozen, the <code>FieldInfo</code> might be also pruned.
	 *
	 * @see #getFieldInfo()
	...
	/**
	 * Returns the annotation if the class has the specified annotation class. For example, if an
	 * annotation <code>@Author</code> is associated with this field, an <code>Author</code> object
	...
	/**
	 * Returns the annotations associated with this field. If any annotations are not on the
	 * classpath, they are not included in the returned array.
	 *
	 * @return an array of annotation-type objects.
	 * @see #getAnnotations()
	 * @since 3.3
	...
	/**
	 * Returns the character string representing the type of the field. The field signature is
	 * represented by a character string called a field descriptor, which is defined in the JVM
	 * specification. If two fields have the same type, <code>getSignature()</code> returns the same
	 * string.
	 *
	 * <p>
	...
	/**
	 * Set the generic signature of the field. It represents a type including type variables. See
	 * {@link org.javassist.CtClass#setGenericSignature(String)} for a code sample.
	 *
	 * @param sig
	 *            a new generic signature.
	 * @see org.javassist.bytecode.SignatureAttribute.ObjectType#encode()
	 * @since 3.17
	 */
	 ...
	 *
	 * <p>
	 * This method does not automatically update method bodies that access this field. They have to
	 * be explicitly updated. For example, if some method contains an expression {@code t.value} and
	 * the type of the variable {@code t} is changed by {@link #setType(CtClass)} from {@code int}
	 * to {@code double}, then {@code t.value} has to be modified as well since the bytecode of
	 * {@code t.value} contains the type information.
	 * </p>
	 *
	 * @see CodeConverter
	...
	/**
	 * Returns the value of this field if it is a constant field. This method works only if the
	 * field type is a primitive type or <code>String</code> type. Otherwise, it returns
	 * <code>null</code>. A constant field is <code>static</code> and <code>final</code>.
	 *
	 * @return a <code>Integer</code>, <code>Long</code>, <code>Float</code>, <code>Double</code>,
	 *         <code>Boolean</code>, or <code>String</code> object representing the constant value.
	 *         <code>null</code> if it is not a constant field or if the field type is not a
	 *         primitive type or <code>String</code>.
	 */
	 ...
	 *
	 * <p>
	 * Note that an attribute is a data block specified by the class file format. See
	 * {@link org.javassist.bytecode.AttributeInfo}.
	 *
	 * @param name
	 *            attribute name
	 */
	...
	/**
	 * Instances of this class specify how to initialize a field. <code>Initializer</code> is passed
	 * to <code>CtClass.addField()</code> with a <code>CtField</code>.
	 *
	 * <p>
	 * This class cannot be instantiated with the <code>new</code> operator. Factory methods such as
	 * <code>byParameter()</code> and <code>byNew</code> must be used for the instantiation. They
	 * create a new instance with the given parameters and return it.
	 *
	 * @see CtClass#addField(CtField,CtField.Initializer)
	 */
	public static abstract class Initializer {
		/**
		 * Makes an initializer that assigns a constant integer value. The field must be integer,
		 * short, char, or byte type.
		 */
		...
		/**
		 * Makes an initializer that assigns a constant boolean value. The field must be boolean
		 * type.
		 */
		...
		/**
		 * Makes an initializer that assigns a constant string value. The field must be
		 ...
		 *
		 * <p>
		 * The initial value is the N-th parameter given to the constructor of the object including
		 * the field. If the constructor takes less than N parameters, the field is not initialized.
		 * If the field is static, it is never initialized.
		 *
		 * @param nth
		 *            the n-th (&gt;= 0) parameter is used as the initial value. If nth is 0, then
		 ...
		 *
		 * <p>
		 * This initializer creates a new object and uses it as the initial value of the field. The
		 * constructor of the created object receives the parameter:
		 *
		 * <p>
		 ...
		 * <p>
		 * This initializer creates a new object and uses it as the initial value of the field. The
		 * constructor of the created object receives the parameters:
		 *
		 * <p>
		 ...
		 * <p>
		 * <code>Object obj</code> - the object including the field.<br>
		 * <code>Object[] args</code> - the parameters passed to the constructor of the object
		 * including the filed.
		 *
		 * <p>
		 * If the initialized field is static, then the constructor does not receive any parameters.
		 ...
		 *            the class instantiated for the initial value.
		 *
		 * @see org.javassist.CtField.Initializer#byNewArray(CtClass,int)
		 * @see org.javassist.CtField.Initializer#byNewArray(CtClass,int[])
		 */
		 ...
		 *
		 * <p>
		 * This initializer calls a static method and uses the returned value as the initial value
		 * of the field. The called method receives the parameters:
		 *
		 * <p>
		 * <code>Object obj</code> - the object including the field.
		 *
		 ...
		 *            the type of the array.
		 * @param sizes
		 *            an <code>int</code> array of the size in every dimension. The first element is
		 *            the size in the first dimension. The second is in the second, etc.
		 */
	...
	/**
	 * A field initialized with a parameter passed to the constructor of the class containing that
	 * field.
	 */
	...
	static class NewInitializer extends Initializer {
		...
		/**
		 * Produces codes in which a new object is created and assigned to the field as the initial
		 * value.
		 */
		int compile(CtClass type, String name, Bytecode code, CtClass[] parameters, Javac drv) throws CannotCompileException {
			int stacksize;
