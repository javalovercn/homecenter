...
public class TransformCall extends Transformer {
	...
	/**
	 * Modify INVOKEINTERFACE, INVOKESPECIAL, INVOKESTATIC and INVOKEVIRTUAL so that a different
	 * method is invoked. The class name in the operand of these instructions might be a subclass of
	 * the target class specified by <code>classname</code>. This method transforms the instruction
