...
public class SignatureAttribute extends AttributeInfo {
	...
	/**
	 * Sets <code>signature_index</code> to the index of the given generic signature, which is added
	 * to a constant pool.
	 *
	 * @param sig
	 *            new signature.
	...
	public static class MethodSignature {
		...
		/**
		 * Constructs a method type signature. Any parameter can be null to represent
		 * <code>void</code> or nothing.
		 *
		 * @param tp
		 *            type parameters.
		 * @param params
		 ...
		 *
		 * @return a zero-length array if exceptions are never thrown or the exception types are not
	...
	public static class TypeParameter {
		...
		/**
		 * Constructs a <code>TypeParameter</code> representing a type parametre like
		 * <code>&lt;T extends ... &gt;</code>.
		 *
		 * @param name
		 *            parameter name.
		...
		/**
		 * Constructs a <code>TypeParameter</code> representing a type parameter like
		 * <code>&lt;T&gt;</code>.
		 *
		 * @param name
		 *            parameter name.
	...
	public static class TypeArgument {
		...
		/**
		 * Constructs a <code>TypeArgument</code>. A type argument is <code>&lt;String&gt;</code>,
		 * <code>&lt;int[]&gt;</code>, or a type variable <code>&lt;T&gt;</code>, etc.
		 *
		 * @param t
		...
		/**
		 * A factory method constructing a <code>TypeArgument</code> with an upper bound. It
		 * represents <code>&lt;? extends ... &gt;</code>
		 * 
		 * @param t
		 *            an upper bound type.
		 */
		...
		/**
		 * A factory method constructing a <code>TypeArgument</code> with an lower bound. It
		 * represents <code>&lt;? super ... &gt;</code>
		 * 
		 * @param t
		 ...
		 *
		 * @return <code>' '</code> (not-wildcard), <code>'*'</code> (wildcard), <code>'+'</code>
		 *         (wildcard with upper bound), or <code>'-'</code> (wildcard with lower bound).
		 */
		public char getKind() {
			return wildcard;
		}
		...
		/**
		 * Returns true if this type argument is a wildcard type such as <code>?</code>,
		 * <code>? extends String</code>, or <code>? super Integer</code>.
		 */
		 ...
		 * Otherwise, this method returns the upper bound (if the kind is '+'), the lower bound (if
		 * the kind is '-'), or null (if the upper or lower bound is not specified).
		 */
	...
	public static abstract class Type {
		...
		/**
		 * Returns the type name in the JVM internal style. For example, if the type is a nested
		 * class {@code foo.Bar.Baz}, then {@code foo.Bar$Baz} is returned.
		 */
	...
	/**
	 * Class types, array types, and type variables. This class is also used for representing a
	 * field type.
	 */
	...
	public static class ClassType extends ObjectType {
		...
		/**
		 * Constructs a <code>ClassType</code>. It represents the name of a non-nested class.
		 *
		 * @param className
		...
		/**
		 * If this class is a member of another class, returns the class in which this class is
		 * declared.
		 *
	...
	public static class NestedClassType extends ClassType {
		 ...
		 * @param className
		 *            a simple class name. It does not include a package name or a parent's class
		 *            name.
		 * @param args
		...
		/**
		 * Returns the class that declares this nested class. This nested class is a member of that
		 * declaring class.
		 */
		public ClassType getDeclaringClass() {
			return parent;
	 ...
	 *
	 * @param sig
	 *            the signature obtained from the <code>SignatureAttribute</code> of a
	 *            <code>ClassFile</code>.
	 * @return a tree-like data structure representing a class signature. It provides convenient
	 *         accessor methods.
	 * @throws BadBytecode
	 ...
	 *
	 * @param sig
	 *            the signature string obtained from the <code>SignatureAttribute</code> of a
	 *            <code>FieldInfo</code>.
	...
	/**
	 * Parses the given signature string as a type signature. The type signature is either the field
	 * type signature or a base type descriptor including <code>void</code> type.
	 *
	 * @throws BadBytecode
	 *             thrown when a syntactical error is found.
	 * @since 3.18
	...
	private static TypeParameter[] parseTypeParams(String sig, Cursor cur) throws BadBytecode {
		...
		if (sig.charAt(cur.position) == '<') {
			...
			while (sig.charAt(cur.position) != '>') {
				...
				TypeParameter p = new TypeParameter(sig, nameBegin, nameEnd, classBound,
						(ObjectType[]) ifBound.toArray(new ObjectType[ifBound.size()]));
				typeParam.add(p);
			}
