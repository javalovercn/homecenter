...
import org.javassist.bytecode.annotation.*;
 ...
 * <code>getAttribute(AnnotationsAttribute.visibleTag)</code> in <code>ClassFile</code>,
 * <code>MethodInfo</code>, or <code>FieldInfo</code>. The obtained attribute is a runtime visible
 * annotations attribute. If the parameter is <code>AnnotationAttribute.invisibleTag</code>, then
 * the obtained attribute is a runtime invisible one.
 *
 * <p>
 * For example,
 *
 * <pre>
 * import org.javassist.bytecode.annotation.Annotation;
 *    :
 * CtMethod m = ... ;
 ...
 *
 * <p>
 * This code snippet retrieves an annotation of the type <code>Author</code> from the
 * <code>MethodInfo</code> object specified by <code>minfo</code>. Then, it prints the value of
 * <code>name</code> in <code>Author</code>.
 *
 * <p>
 ...
 *
 * <p>
 * Then <code>Author</code> is visible at runtime. Therefore, the third statement of the code
 * snippet above must be changed into:
 *
 * <pre>
 ...
 *
 * <p>
 * If the member value of an annotation is not specified, the default value is used as that member
 * value. If so, <code>getMemberValue()</code> in <code>Annotation</code> returns <code>null</code>
 * since the default value is not included in the <code>AnnotationsAttribute</code>. It is included
 * in the <code>AnnotationDefaultAttribute</code> of the method declared in the annotation type.
 *
 * <p>
 ...
 *
 * <p>
 * The last statement is necessary if the class file was produced by <code>javac</code> of JDK 1.4
 * or earlier. Otherwise, it is not necessary.
 *
 * @see AnnotationDefaultAttribute
 * @see org.javassist.bytecode.annotation.Annotation
 */
public class AnnotationsAttribute extends AttributeInfo {
	 ...
	 *            <code>attribute_name_index</code> or <code>attribute_length</code>.
	 */
	...
	/**
	 * Constructs an empty <code>Runtime(In)VisibleAnnotations_attribute</code>. A new annotation
	 * can be later added to the created attribute by <code>setAnnotations()</code>.
	 *
	 * @param cp
	 *            constant pool
	 * @param attrname
	...
	/**
	 * Parses the annotations and returns a data structure representing the annotation with the
	 * specified type. See also <code>getAnnotations()</code> as to the returned data structure.
	 *
	 * @param type
	 *            the annotation type.
	...
	/**
	 * Adds an annotation. If there is an annotation with the same type, it is removed before the
	 * new annotation is added.
	 *
	 * @param annotation
	...
	/**
	 * Removes an annotation by type. After removing an annotation, if {@link #numAnnotations()}
	 * returns 0, this annotations attribute has to be removed.
	 *
	 * @param type
	 ...
	 * Note that changes of the node values of the returned tree are not reflected on the
	 * annotations represented by this object unless the tree is copied back to this object by
	...
	static class Renamer extends Walker {
		...
		/**
		 * Constructs a renamer. It renames some class names into the new names specified by
		 * <code>map</code>.
		 *
		 * @param info
	...
	static class Copier extends Walker {
		...
		/**
		 * Constructs a copier. This copier renames some class names into the new names specified by
		 * <code>map</code> when it copies an annotation attribute.
		 *
		 * @param info
		...
		/**
		 * Copies a constant pool entry into the destination constant pool and returns the index of
		 * the copied entry.
		 *
		 * @param srcIndex
		 *            the index of the copied entry into the source constant pool.
		...
		/**
		 * Copies a constant pool entry into the destination constant pool and returns the index of
		 * the copied entry. That entry must be a Utf8Info representing a class name in the L<class
		 * name>; form.
		 *
		 * @param srcIndex
		 *            the index of the copied entry into the source constant pool.
	...
	static class Parser extends Walker {
		...
		/**
		 * Constructs a parser. This parser constructs a parse tree of the annotations.
		 *
		 * @param info
		 *            the attribute.
		 * @param src
