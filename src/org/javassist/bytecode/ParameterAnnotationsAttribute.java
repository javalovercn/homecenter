...
import org.javassist.bytecode.AnnotationsAttribute.Copier;
import org.javassist.bytecode.AnnotationsAttribute.Parser;
import org.javassist.bytecode.AnnotationsAttribute.Renamer;
 ...
 * <code>getAttribute(ParameterAnnotationsAttribute.invisibleTag)</code> in <code>MethodInfo</code>.
 * The obtained attribute is a runtime invisible annotations attribute. If the parameter is
 * <code>ParameterAnnotationAttribute.visibleTag</code>, then the obtained attribute is a runtime
 * visible one.
 */
public class ParameterAnnotationsAttribute extends AttributeInfo {
	...
	/**
	 * Constructs a <code>Runtime(In)VisibleParameterAnnotations_attribute</code>.
	 *
	 * @param cp
	 *            constant pool
	 * @param attrname
	...
	/**
	 * Constructs an empty <code>Runtime(In)VisibleParameterAnnotations_attribute</code>. A new
	 * annotation can be later added to the created attribute by <code>setAnnotations()</code>.
	 *
	 * @param cp
	 *            constant pool
	 * @param attrname
	 ...
	 *
	 * @return Each element of the returned array represents an array of annotations that are
	 *         associated with each method parameter.
	 * 
	 * @see #setAnnotations(Annotation[][])
	 */
	 ...
	 *
	 * @param params
	 *            the data structure representing the new annotations. Every element of this array
