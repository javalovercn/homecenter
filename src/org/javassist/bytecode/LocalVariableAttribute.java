...
public class LocalVariableAttribute extends AttributeInfo {
	 ...
	 *
	 * @param name
	 *            the attribute name. <code>LocalVariableAttribute.tag</code> or
	...
	/**
	 * For each <code>local_variable_table[i].index</code>, this method increases <code>index</code>
	 * by <code>delta</code>.
	 *
	 * @param lessThan
	...
	/**
	 * Returns <code>local_variable_table_length</code>. This represents the number of entries in
	 * the table.
	 */
	...
	/**
	 * Returns <code>local_variable_table[i].start_pc</code>. This represents the index into the
	 * code array from which the local variable is effective.
	 *
	 * @param i
	 *            the i-th entry.
	 */
	...
	/**
	 * Returns <code>local_variable_table[i].length</code>. This represents the length of the code
	 * region in which the local variable is effective.
	 *
	 * @param i
	 *            the i-th entry.
	 */
	...
	/**
	 * Returns the value of <code>local_variable_table[i].name_index</code>. This represents the
	 ...
	 * <code>local_variable_table[i].name_index</code>.
	 *
	 * @param i
	 *            the i-th entry.
	 */
	...
	/**
	 * Returns the value of <code>local_variable_table[i].descriptor_index</code>. This represents
	 * the type descriptor of the local variable.
	 * <p>
	 * If this attribute represents a LocalVariableTypeTable attribute, this method returns the
	 * value of <code>local_variable_type_table[i].signature_index</code>. It represents the type of
	 * the local variable.
	 *
	 * @param i
	 *            the i-th entry.
	...
	/**
	 * This method is equivalent to <code>descriptorIndex()</code>. If this attribute represents a
	 * LocalVariableTypeTable attribute, this method should be used instead of
	 * <code>descriptorIndex()</code> since the method name is more appropriate.
	 * 
	 * @param i
	 *            the i-th entry.
	 ...
	 * <p>
	 * If this attribute represents a LocalVariableTypeTable attribute, this method returns the type
	 * signature of the local variable specified by
	...
	/**
	 * This method is equivalent to <code>descriptor()</code>. If this attribute represents a
	 * LocalVariableTypeTable attribute, this method should be used instead of
	 * <code>descriptor()</code> since the method name is more appropriate.
	 *
	 * <p>
	...
	/**
	 * Returns <code>local_variable_table[i].index</code>. This represents the index of the local
	 * variable.
	 *
	 * @param i
	 *            the i-th entry.
