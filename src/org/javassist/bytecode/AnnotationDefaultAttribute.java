...
import org.javassist.bytecode.annotation.AnnotationsWriter;
import org.javassist.bytecode.annotation.MemberValue;
 ...
 *
 * <p>
 * The defautl values of <code>name</code> and <code>age</code> are stored as annotation default
 * attributes in <code>Author.class</code>. The following code snippet obtains the default value of
 * <code>name</code>:
 * 
 * <pre>
 * ClassPool pool = ...
 ...
 *
 * <p>
 * If the following statement is executed after the code above, the default value of age is set to
 * 80:
 *
 * <pre>
 ...
 * @see org.javassist.bytecode.annotation.MemberValue
 */
...
public class AnnotationDefaultAttribute extends AttributeInfo {
	...
	/**
	 * Constructs an empty <code>AnnotationDefault_attribute</code>. The default value can be set by
	 * <code>setDefaultValue()</code>.
	 *
	 * @param cp
	 *            constant pool
	 * @see #setDefaultValue(org.javassist.bytecode.annotation.MemberValue)
	 */
	 ...
	 * @param value
	 *            the new value.
	 * @see org.javassist.bytecode.annotation.Annotation#createMemberValue(ConstPool, CtClass)
	 */
