 ...
 *
 * <p>
 * This is an entry in the attributes table of a Code attribute. It was introduced by J2SE 6 for the
 * verification by typechecking.
 *
 * @see StackMap
 * @since 3.4
 */
public class StackMapTable extends AttributeInfo {
	 ...
	 *                if a <code>BadBytecode</code> exception is thrown while copying, it is
	...
	public static class Walker {
		 ...
		 *
		 * @param data
		 *            the <code>info</code> field of the <code>attribute_info</code> structure. It
		 *            can be obtained by <code>get()</code> in the <code>AttributeInfo</code> class.
		 */
		 ...
		 *
		 * @param pos
		 *            the position of the frame in the <code>info</code> field of
		 ...
		 *
		 * @param pos
		 *            the position of this frame in the <code>info</code> field of
		 *            <code>attribute_info</code> structure.
		 * @param offsetDelta
		 */
		...
		/**
		 * Invoked if the visited frame is a <code>same_locals_1_stack_item_frame</code> or a
		 ...
		 * @param stackData
		 *            <code>stack[0].cpool_index</code> if the tag is <code>OBJECT</code>, or
		 *            <code>stack[0].offset</code> if the tag is <code>UNINIT</code>.
		 */
		...
		/**
		 * Invoked if <code>Object_variable_info</code> or <code>Uninitialized_variable_info</code>
		 * is visited.
		 *
		 * @param tag
	 ...
	 * @param classInfo
	 *            the index of the <code>CONSTANT_Class_info</code> structure in a constant pool
	 *            table. This should be zero unless the tag is <code>ITEM_Object</code>.
	 *
	 * @see org.javassist.CtBehavior#addParameter(org.javassist.CtClass)
	 * @see #typeTagOf(char)
	 * @see ConstPool
	 */
	...
	/**
	 * Returns the tag of the type specified by the descriptor. This method returns
	 * <code>INTEGER</code> unless the descriptor is either D (double), F (float), J (long), L
	 * (class type), or [ (array).
	 *
	 * @param descriptor
	 *            the type descriptor.
	...
	/*
	 * This implementation assumes that a local variable initially holding a parameter value is
	 * never changed to be a different type.
	 * 
	 */
	...
	public static class Writer {
		 ...
		 * @param data
		 *            <code>stack[0].cpool_index</code> if the tag is <code>OBJECT</code>, or
		 *            <code>stack[0].offset</code> if the tag is <code>UNINIT</code>. Otherwise,
		...
		/**
		 * Writes a <code>append_frame</code>. The number of the appended locals is specified by the
		 * length of <code>tags</code>.
		 *
		 * @param tags
		 *            <code>locals[].tag</code>. The length of this array must be either 1, 2, or 3.
		 * @param data
		 *            <code>locals[].cpool_index</code> if the tag is <code>OBJECT</code>, or
		 *            <code>locals[].offset</code> if the tag is <code>UNINIT</code>. Otherwise,
		 *            this parameter is not used.
		 */
		 ...
		 *            <code>stack[].tag</code>.
		 * @param stackData
		 *            <code>stack[].cpool_index</code> if the tag is <code>OBJECT</code>, or
		 *            <code>stack[].offset</code> if the tag is <code>UNINIT</code>. Otherwise, this
	 ...
	 *
	 * <p>
	 * This method is for org.javassist.convert.TransformNew. It is called to update the stack map
	 * table when the NEW opcode (and the following DUP) is removed.
	 *
	 * @param where
