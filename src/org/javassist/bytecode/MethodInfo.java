...
import org.javassist.bytecode.stackmap.MapMaker;
 ...
 *
 * <p>
 * The following code adds the default constructor to a class: of <code>int</code> type:
 * <blockquote>
 * 
 * <pre>
 * ClassFile cf = ...
 ...
 * @see CodeAttribute
 * @see Bytecode
 * @see org.javassist.CtMethod#getMethodInfo()
 * @see org.javassist.CtConstructor#getMethodInfo()
 */
public class MethodInfo {
	...
	/**
	 * If this value is true, Javassist maintains a <code>StackMap</code> attribute generated by the
	 * <code>preverify</code> tool of J2ME (CLDC). The initial value of this field is
	 * <code>false</code>.
	 */
	...
	/**
	 * Constructs a copy of <code>method_info</code> structure. Class names appearing in the source
	 * <code>method_info</code> are renamed according to <code>classnameMap</code>.
	 * 
	 * <p>
	 * Note: only <code>Code</code> and <code>Exceptions</code> attributes are copied from the
	 * source. The other attributes are ignored.
	 * 
	 * @param cp
	 *            a constant pool table
	 * @param methodname
	 ...
	 * If you add a new attribute to the list, the attribute is also added to the method represented
	 * by this object. If you remove an attribute from the list, it is also removed from the method.
	 * 
	 ...
	 * 
	 * <p>
	 * The added attribute must share the same constant pool table as this <code>method_info</code>
	 * structure.
	 */
	...
	/**
	 * Rebuilds a stack map table if the class file is for Java 6 or later. Java 5 or older Java VMs
	 * do not recognize a stack map table. If <code>doPreverify</code> is true, this method also
	 * rebuilds a stack map for J2ME (CLDC).
	 *
	 * @param pool
	...
	/**
	 * Returns the line number of the source line corresponding to the specified bytecode contained
	 * in this method.
	 * 
	 * @param pos
	 *            the position of the bytecode (&gt;= 0). an index into the code array.
	 ...
	 * 
	 * <p>
	 * This method modifies a call to <code>super()</code>, which should be at the head of a
	 * constructor body, so that a constructor in a different super class is called. This method
	 * does not change actual parameters. Hence the new super class must have a constructor with the
	 * same signature as the original one.
	 * 
	 * <p>
	 * This method should be called when the super class of the class declaring this method is
	 * changed.
	 * 
	 * <p>
	 * This method does not perform anything unless this <code>MethodInfo</code> represents a
	 * constructor.
	 * 
	 * @param superclass
	 *            the new super class
