...
public class Descriptor {
	...
	/**
	 * Converts a class name from the internal representation used in the JVM to the normal one used
	 * in Java. This method does not deal with an array type name such as "[Ljava/lang/Object;" and
	 * "[I;". For such names, use <code>toClassName()</code>.
	 *
	...
	/**
	 * Returns the descriptor representing a method that receives the given parameter types and
	...
	/**
	 * Returns the descriptor representing a list of parameter types. For example, if the given
	 * parameter types are two <code>int</code>, then this method returns <code>"(II)"</code>.
	 *
	 * @param paramTypes
	 *            parameter types
	 */
	...
	/**
	 * Inserts a parameter type at the beginning of the parameter list represented by the given
	 * descriptor.
	 *
	 * <p>
	 * <code>classname</code> must not be an array type.
	...
	/**
	 * Appends a parameter type to the parameter list represented by the given descriptor. The
	 * appended parameter becomes the last parameter.
	 *
	 * @param type
	...
	/**
	 * Returns the <code>CtClass</code> objects representing the parameter types specified by the
	 * given descriptor.
	 *
	 * @param desc
	 *            descriptor
	 * @param cp
	 *            the class pool used for obtaining a <code>CtClass</code> object.
	 */
	...
	/**
	 * Returns true if the list of the parameter types of desc1 is equal to that of desc2. For
	 * example, "(II)V" and "(II)I" are equal.
	 */
	...
	/**
	 * Returns the signature of the given descriptor. The signature does not include the return
	 * type. For example, the signature of "(I)V" is "(I)".
	 */
	...
	/**
	 * Returns the <code>CtClass</code> object representing the return type specified by the given
	 * descriptor.
	 *
	 * @param desc
	 *            descriptor
	...
	/**
	 * Returns a <code>CtClass</code> object representing the type specified by the given
	 * descriptor.
	 *
	 * <p>
	 * This method works even if the package-class separator is not <code>/</code> but
	 * <code>.</code> (period). For example, it accepts <code>Ljava.lang.Object;</code> as well as
	...
	/**
	 * Computes the dimension of the array represented by the given descriptor. For example, if the
	 * descriptor is <code>"[[I"</code>, then this method returns 2.
	 *
	 * @param desc
	 *            the descriptor.
	...
	/**
	 * Returns the descriptor of the type of the array component. For example, if the given
	 * descriptor is <code>"[[Ljava/lang/String;"</code> and the given dimension is 2, then this
	 * method returns <code>"Ljava/lang/String;"</code>.
	 *
	 * @param desc
	 *            the descriptor.
	 * @param dim
	...
	/**
	 * Computes the data size specified by the given descriptor. For example, if the descriptor is
	 * "D", this method returns 2.
	 *
	 * <p>
	 * If the descriptor represents a method type, this method returns (the size of the returned
	 * value) - (the sum of the data sizes of all the parameters). For example, if the descriptor is
	...
	/**
	 * Computes the data size of parameters. If one of the parameters is double type, the size of
	 * that parameter is 2 words. For example, if the given descriptor is <code>"(IJ)D"</code>, then
	 * this method returns 3. The size of the return type is not computed.
	 * 
	 * @param desc
	 *            a method descriptor.
	 */
	...
	/**
	 * Returns a human-readable representation of the given descriptor. For example,
	 * <code>Ljava/lang/Object;</code> is converted into <code>java.lang.Object</code>.
	 * <code>(I[I)V</code> is converted into <code>(int, int[])</code> (the return type is ignored).
	 */
	...
	public static class Iterator {
		...
		/**
		 * Returns the position of the next type character. That type character becomes a new
		 * current element.
		 */
		public int next() {
			int nextPos = index;
