...
public class ExceptionTable implements Cloneable {
	...
	/**
	 * Returns <code>exception_table_length</code>, which is the number of entries in the
	 ...
	 * @param nth
	 *            the <i>n</i>-th (&gt;= 0).
	 * @return an index into the <code>constant_pool</code> table, or zero if this exception handler
	 *         is for all exceptions.
	 */
	...
	/**
	 * Makes a copy of this <code>exception_table[]</code>. Class names are replaced according to
	 * the given <code>Map</code> object.
	 *
	 * @param newCp
