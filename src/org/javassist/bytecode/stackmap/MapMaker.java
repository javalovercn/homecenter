...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //org.javassist.CtClass cc = cp.get(className);
        org.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //org.javassist.CtClass cc = cp.get(args[1]);
        org.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
    ...
    */
     ...
     * See org.javassist.JvstTest4.testJIRA195().
     */
