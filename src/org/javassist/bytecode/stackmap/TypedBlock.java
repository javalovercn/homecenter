...
public class TypedBlock extends BasicBlock {
	...
	/**
	 * Divides the method body into basic blocks. The type information of the first block is
	 * initialized.
	 *
	 * @param optimize
	 *            if it is true and the method does not include branches, this method returns null.
	 */
	public static TypedBlock[] makeBlocks(MethodInfo minfo, CodeAttribute ca, boolean optimize) throws BadBytecode {
		...
		blocks[0].initFirstBlock(ca.getMaxStack(), ca.getMaxLocals(), pool.getClassName(), minfo.getDescriptor(), isStatic,
				minfo.isConstructor());
		return blocks;
	}
	 ...
	 * @param className
	 *            a dot-separated fully qualified class name. For example,
	 *            <code>org.javassist.bytecode.stackmap.BasicBlock</code>.
	 * @param methodDesc
	 *            method descriptor.
	 * @param isStatic
