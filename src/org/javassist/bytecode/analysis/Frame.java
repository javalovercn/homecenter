...
public class Frame {
	...
	/**
	 * Gets the index of the type sitting at the top of the stack. This is not to be confused with a
	 * length operation which would return the number of elements, not the position of the last
	 * element.
	 *
	...
	/**
	 * Makes a shallow copy of the stack portion of this frame. The local variable table size will
	 * be copied, but its contents will be empty.
	 *
	...
	/**
	 * Merges all types on the stack of this frame instance with that of the specified frame. The
	 * local variable table is left untouched.
	 *
	 * @param frame
	...
	/**
	 * Merges all types on the stack and local variable table of this frame with that of the
	 * specified type.
	 *
	 * @param frame
	...
	/**
	 * Whether or not state from the RET instruction, of the subroutine that was jumped to has been
	 * merged.
	 *
	...
	/**
	 * Sets whether or not state from the RET instruction, of the subroutine that was jumped to has
	 * been merged.
	 *
	 * @param retMerged
