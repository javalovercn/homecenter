...
public class Executor implements Opcode {
	...
	/**
	 * Execute the instruction, modeling the effects on the specified frame and subroutine. If a
	 * subroutine is passed, the access flags will be modified if this instruction accesses the
