...
public class InnerClassesAttribute extends AttributeInfo {
	...
	/**
	 * Returns the class name indicated by <code>classes[nth].inner_class_info_index</code>.
	 *
	...
	/**
	 * Returns the simple class name indicated by <code>classes[nth].inner_name_index</code>.
	 *
	 * @return null or the class name.
	 */
	...
	/**
	 * Removes the {@code nth} entry. It does not eliminate constant pool items that the removed
	 * entry refers to. {@link ClassFile#compact()} should be executed to remove these unnecessary
	 * items.
	 *
	 * @param nth
	 *            0, 1, 2, ...
