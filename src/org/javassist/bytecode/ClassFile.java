...
/**
 * <code>ClassFile</code> represents a Java <code>.class</code> file, which consists of a constant
 * pool, methods, fields, and attributes.
 *
 * <p>
 * For example,
 * </p>
 ...
 * @see MethodInfo
 * @see ClassFileWriter
 * @see org.javassist.CtClass#getClassFile()
 * @see org.javassist.ClassPool#makeClass(ClassFile)
 */
public final class ClassFile {
	...
	/**
	 * The major version number of class files created from scratch. The default value is 47 (JDK
	 * 1.3). It is 49 (JDK 1.5) if the JVM supports <code>java.lang.StringBuilder</code>. It is 50
	 * (JDK 1.6) if the JVM supports <code>java.util.zip.DeflaterInputStream</code>. It is 51 (JDK
	 * 1.7) if the JVM supports <code>java.lang.invoke.CallSite</code>. It is 52 (JDK 1.8) if the
	 * JVM supports <code>java.util.function.Function</code>. It is 53 (JDK 1.9) if the JVM supports
	...
	/**
	 * Eliminates dead constant pool items. If a method or a field is removed, the constant pool
	 * items used by that method/field become dead items. This method recreates a constant pool.
	 */
	public void compact() {
	...
	/**
	 * Discards all attributes, associated with both the class file and the members such as a code
	 * attribute and exceptions attribute. The unused constant pool entries are also discarded (a
	 ...
	 * 
	 * @see org.javassist.bytecode.AccessFlag
	 */
	...
	/**
	 * Returns access and property flags of this nested class. This method returns -1 if the class
	 * is not a nested class.
	 *
	 * <p>
	 * The returned value is obtained from <code>inner_class_access_flags</code> of the entry
	 * representing this nested class itself in <code>InnerClasses_attribute</code>.
	 */
	...
	/**
	 * Sets the class name. This method substitutes the new name for all occurrences of the old
	 * class name in the class file.
	 */
	 ...
	 * 
	 * <p>
	 * The new super class should inherit from the old super class. This method modifies
	 * constructors so that they call constructors declared in the new super class.
	 */
	 ...
	 * 
	 * <p>
	 * If class X is substituted for class Y in the class file, X and Y must have the same
	 * signature. If Y provides a method m(), X must provide it even if X inherits m() from the
	 * super class. If this fact is not guaranteed, the bytecode verifier may cause an error.
	 * 
	 * @param oldname
	 ...
	 * 
	 * @param classnames
	 *            specifies which class name is replaced with which new name. Class names must be
	 *            described with the JVM-internal representation like <code>java/lang/Object</code>.
	...
	/**
	 * Returns the names of the interfaces implemented by the class. The returned array is read
	 * only.
	 */
	...
	/**
	 * Just appends a field to the class. It does not check field duplication. Use this method only
	 * when minimizing performance overheads is seriously required.
	 *
	 * @since 3.13
	 */
	...
	/**
	 * Returns the method with the specified name. If there are multiple methods with that name,
	...
	/**
	 * Appends a method to the class. If there is a bridge method with the same name and signature,
	...
	/**
	 * Just appends a method to the class. It does not check method duplication or remove a bridge
	 * method. Use this method only when minimizing performance overheads is seriously required.
	 *
	 * @since 3.13
	 */
	...
	/**
	 * Returns all the attributes. The returned <code>List</code> object is shared with this object.
	 * If you add a new attribute to the list, the attribute is also added to the classs file
	 * represented by this object. If you remove an attribute from the list, it is also removed from
	 * the class file.
	 * 
	...
	/**
	 * Returns the attribute with the specified name. If there are multiple attributes with that
	 * name, this method returns either of them. It returns null if the specified attributed is not
	 * found.
	 *
	 * <p>
	 * An attribute name can be obtained by, for example, {@link AnnotationsAttribute#visibleTag} or
	 ...
	 *
	 * If the major version is older than 49, Java 5 extensions such as annotations are ignored by
	 * the JVM.
	 */
