...
import org.javassist.bytecode.StackMapTable.InsertLocal;
import org.javassist.bytecode.StackMapTable.NewRemover;
import org.javassist.bytecode.StackMapTable.Shifter;

/**
 * Another <code>stack_map</code> attribute defined in CLDC 1.1 for J2ME.
 *
 * <p>
 * This is an entry in the attributes table of a Code attribute. It was introduced by J2ME CLDC 1.1
 * (JSR 139) for pre-verification.
 *
 * <p>
 * According to the CLDC specification, the sizes of some fields are not 16bit but 32bit if the code
 * size is more than 64K or the number of the local variables is more than 64K. However, for the
 * J2ME CLDC technology, they are always 16bit. The implementation of the StackMap class assumes
 * they are 16bit.
 *
...
public class StackMap extends AttributeInfo {
	...
	public static class Walker {
		...
		/**
		 * Invoked when an array of <code>verification_type_info</code> is visited.
		 *
		 * @param num
		 *            the number of elements.
		 * @param isLocals
		 *            true if this array is for <code>locals</code>. false if it is for
		 *            <code>stack</code>.
		 */
		...
		/**
		 * Invoked when an element of <code>verification_type_info</code> (except
		 * <code>Object_variable_info</code> and <code>Uninitialized_variable_info</code>) is
		 * visited.
		 */
	 ...
	 * when the NEW opcode (and the following DUP) is removed.
	 *
	 * @param where
	...
	public static class Writer {
		// see org.javassist.bytecode.stackmap.MapMaker
