...
public class Bytecode extends ByteVector implements Cloneable, Opcode {
	/**
	 * Represents the <code>CtClass</code> file using the constant pool table given to this
	...
	/**
	 * Constructs a <code>Bytecode</code> object with an empty bytecode sequence.
	 *
	 * <p>
	 * The parameters <code>stacksize</code> and <code>localvars</code> specify initial values of
	 * <code>max_stack</code> and <code>max_locals</code>. They can be changed later.
	 *
	 * @param cp
	 *            constant pool table.
	 * @param stacksize
	...
	/**
	 * Constructs a <code>Bytecode</code> object with an empty bytecode sequence. The initial values
	 * of <code>max_stack</code> and <code>max_locals</code> are zero.
	 * 
	 * @param cp
	 *            constant pool table.
	...
	/**
	 * Creates and returns a copy of this object. The constant pool object is shared between this
	 * object and the cloned object.
	 */
	public Object clone() {
		try {
	 ...
	 * <code>Bytecode</code> object maintains the current stack depth whenever an instruction is
	 * added by <code>addOpcode()</code>. For example, if DUP is appended, the current stack depth
	 * is increased by one. If the new stack depth is more than <code>max_stack</code>, then it is
	 * assigned to <code>max_stack</code>. However, if branch instructions are appended, the current
	 * stack depth may not be correctly maintained.
	 *
	 * @see #addOpcode(int)
	 */
	 ...
	 * <code>max_locals</code> to that number plus <code>locals</code>.
	 *
	 * @param isStatic
	 *            true if <code>params</code> must be interpreted as parameters to a static method.
	 * @param params
	 *            parameter types.
	 * @param locals
	...
	/**
	 * Appends an 8bit opcode to the end of the bytecode sequence. The current stack depth is
	 * updated. <code>max_stack</code> is updated if the current stack depth is the deepest so far.
	 *
	 * <p>
	 * Note: some instructions such as INVOKEVIRTUAL does not update the current stack depth since
	 * the increment depends on the method signature. <code>growStack()</code> must be explicitly
	 * called.
	 */
	...
	/**
	 * Increases the current stack depth. It also updates <code>max_stack</code> if the current
	...
	/**
	 * Sets the current stack depth. It also updates <code>max_stack</code> if the current stack
	 * depth is the deepest so far.
	 *
	 * @param depth
	 *            new value.
	 */
	...
	/**
	 * Appends a 16bit value to the end of the bytecode sequence. It never changes the current stack
	 * depth.
	 */
	...
	/**
	 * Appends an instruction for pushing zero or null on the stack. If the type is void, this
	 * method does not append any instruction.
	 *
	 * @param type
	 ...
	 *
	 * @param offset
	 *            the index of the first parameter. It is 0 if the method is static. Otherwise, it
	 *            is 1.
	 */
	...
	/**
	 * Appends INVOKESPECIAL. The invoked method must not be a default method declared in an
	 * interface.
	 *
	 * @param clazz
	 *            the fully-qualified class name.
	 ...
	 *
	 * @param isInterface
	 *            true if the invoked method is a default method declared in an interface.
	 * @param clazz
	 *            the index of <code>CONSTANT_Class_info</code> structure.
	 * @param name
	 *            the method name
	 ...
	 *
	 * @param index
	 *            the index of <code>CONSTANT_Methodref_info</code> or
	 ...
	 *
	 * @param classname
	 *            the fully-qualified class name. It must not be an interface-type name.
	 * @param name
	 *            the method name
	 * @param desc
	 *            the descriptor of the method signature.
	 ...
	 *
	 * @param clazz
	 *            the index of <code>CONSTANT_Class_info</code> structure. It must not be an
	 *            interface type.
	 * @param name
	 *            the method name
	 * @param desc
	 ...
	 *
	 * <p>
	 * The specified method must not be an inherited method. It must be directly declared in the
	 * class specified in <code>clazz</code>.
	 *
	 * @param clazz
	 *            the target class.
	 * @param name
	 ...
	 * <p>
	 * The specified method must not be an inherited method. It must be directly declared in the
	 * class specified in <code>classname</code>.
	 *
	 * @param classname
	 *            the fully-qualified class name.
	 * @param name
	 ...
	 * <p>
	 * The specified method must not be an inherited method. It must be directly declared in the
	 * class specified by <code>clazz</code>.
	 *
	 * @param clazz
	 *            the index of <code>CONSTANT_Class_info</code> structure.
	 * @param name
	 ...
	 *
	 * @param bootstrap
	 *            an index into the <code>bootstrap_methods</code> array of the bootstrap method
	 *            table.
	 * @param name
	 *            the method name.
	 * @param desc
	...
	/**
	 * Appends MULTINEWARRAY. The size of every dimension must have been already pushed on the
	 * stack.
	 *
	 * @param clazz
	 *            the array type.
