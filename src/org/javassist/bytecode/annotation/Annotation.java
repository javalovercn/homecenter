...
package org.javassist.bytecode.annotation;
 ...
 * <code>AnnotationsAttribute</code> or in <code>ParameterAnnotationsAttribute</code>.
 *
 * @see org.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see org.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
	...
	/**
	 * Constructs an annotation including no members. A member can be later added to the created
	 * annotation by <code>addMemberValue()</code>.
	 *
	 * @param type
	 *            the index into the constant pool table. the entry at that index must be the
	 *            <code>CONSTANT_Utf8_Info</code> structure repreenting the name of the annotation
	 *            interface type.
	 * @param cp
	 ...
	 * <code>clazz</code>. The values of the members are not specified.
	 *
	 * @param cp
	 *            the constant pool table.
	 * @param clazz
	 ...
	 *
	 * @param nameIndex
	 *            the index into the constant pool table. The entry at that index must be a
	 *            <code>CONSTANT_Utf8_info</code> structure. structure representing the member name.
	 * @param value
	 *            the member value.
	 */
	 ...
	 * It does not return a <code>MemberValue</code> with the default value. The default value can
	 * be obtained from the annotation type.
	 *
	 * @param name
	 *            the member name
	 * @return null if the member cannot be found or if the value is the default value.
	 *
	 * @see org.javassist.bytecode.AnnotationDefaultAttribute
	 */
	...
	/**
	 * Constructs an annotation-type object representing this annotation. For example, if this
	 * annotation represents <code>@Author</code>, this method returns an <code>Author</code>
	 * object.
	 * 
	 * @param cl
	...
	public Object toAnnotationType(ClassLoader cl, ClassPool cp) throws ClassNotFoundException, NoSuchClassError {
		...
		try {
			...
			/*
			 * AnnotationImpl.make() may throw this exception when it fails to make a proxy object
			 * for some reason.
			 */
	...
	/**
	 * Returns true if the given object represents the same annotation as this object. The equality
	 * test checks the member values.
	 */
