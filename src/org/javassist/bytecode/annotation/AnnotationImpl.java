...
import org.javassist.bytecode.AnnotationDefaultAttribute;
...
public class AnnotationImpl implements InvocationHandler {
	 ...
	 * <code>toString()</code>, <code>equals()</code>, and <code>hashCode()</code> are directly
	 * supplied by the <code>AnnotationImpl</code>. The <code>annotationType()</code> method is also
	 * available on the proxy instance.
	 */
