...
public class EnumMemberValue extends MemberValue {
	...
	/**
	 * Constructs an enum constant value. The initial value is specified by the constant pool
	 * entries at the given indexes.
	 *
	 * @param type
	 *            the index of a CONSTANT_Utf8_info structure representing the enum type.
	 * @param value
