...
import org.javassist.bytecode.ByteArray;
import org.javassist.bytecode.ConstPool;

/**
 * A convenience class for constructing a <code>..Annotations_attribute</code>. See the source code
 * of the <code>AnnotationsAttribute.Copier</code> class.
 *
 * <p>
 ...
 * </pre>
 *
 * @see org.javassist.bytecode.AnnotationsAttribute
 * @see org.javassist.bytecode.ParameterAnnotationsAttribute
 */
public class AnnotationsWriter {
	 ...
	 * <code>Runtime(In)VisibleParameterAnnotations_attribute</code>. This method must be followed
	 * by <code>num</code> calls to <code>numAnnotations()</code>.
	 */
	 ...
	 * This method must be followed by a call to <code>constValueIndex()</code>,
	...
	/**
	 * Writes <code>tag</code> and <code>annotation_value</code> in <code>element_value</code>. This
	 * method must be followed by a call to <code>annotation()</code>.
	 */
	...
	/**
	 * Writes <code>tag</code> and <code>array_value</code> in <code>element_value</code>. This
	 * method must be followed by <code>numValues</code> calls to <code>constValueIndex()</code>,
	 * <code>enumConstValue()</code>, etc.
	 *
	 * @param numValues
