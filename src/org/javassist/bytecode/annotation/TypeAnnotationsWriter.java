...
/**
 * A convenience class for constructing a {@code ..TypeAnnotations_attribute}. See the source code
 * of the {@link org.javassist.bytecode.TypeAnnotationsAttribute} class.
 *
 * @since 3.19
 */
public class TypeAnnotationsWriter extends AnnotationsWriter {
	...
	/**
	 * Writes {@code num_annotations} in {@code Runtime(In)VisibleTypeAnnotations_attribute}. It
	 * must be followed by {@code num} instances of {@code type_annotation}.
	 */
	...
	/**
	 * Writes {@code target_type} and {@code type_parameter_bound_target} of {@code target_info}
	 * union.
	 */
	...
	/**
	 * Writes {@code target_type} and {@code localvar_target} of {@code target_info} union. It must
