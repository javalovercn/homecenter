...
public class EnclosingMethodAttribute extends AttributeInfo {
	...
	/**
	 * Constructs an EnclosingMethod attribute. The value of <code>method_index</code> is set to 0.
	 *
	 * @param cp
	 *            a constant pool table.
	 * @param className
	...
	/**
	 * Returns the method name specified by <code>method_index</code>. If the method is a class
	 * initializer (static constructor), {@link MethodInfo#nameClinit} is returned.
	 */
