 ...
 *
 * <p>
 * The following code adds a public field <code>width</code> of <code>int</code> type: <blockquote>
 * 
 * <pre>
 * ClassFile cf = ...
 ...
 * </blockquote>
 *
 * @see org.javassist.CtField#getFieldInfo()
 */
public final class FieldInfo {
	 ...
	 * with the new ones. This is used for garbage collecting the items of removed fields and
	 * methods.
	 *
	 * @param cp
	 *            the destination
	...
	/**
	 * Finds a ConstantValue attribute and returns the index into the <code>constant_pool</code>
	 * table.
	 *
	 ...
	 * If you add a new attribute to the list, the attribute is also added to the field represented
	 * by this object. If you remove an attribute from the list, it is also removed from the field.
	 *
