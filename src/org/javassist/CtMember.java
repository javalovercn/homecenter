...
/**
 * An instance of <code>CtMember</code> represents a field, a constructor, or a method.
 */
public abstract class CtMember {
	...
	/*
	 * Make a circular link of CtMembers declared in the same class so that they are
	 * garbage-collected together at the same time.
	 */
	...
	/**
	 * Invoked by {@link #toString()} to add to the buffer and provide the complete value.
	 * Subclasses should invoke this method, adding a space before each token. The modifiers for the
	 * member are provided first; subclasses should provide additional data such as return type,
	 * field or method name, etc.
	 */
	 ...
	 *
	 * @return modifiers encoded with <code>org.javassist.Modifier</code>.
	 * @see Modifier
	 */
	 ...
	 * annotation <code>@Author</code> is associated with this member, an <code>Author</code> object
	...
	/**
	 * Returns the annotations associated with this member. For example, if an annotation
	 * <code>@Author</code> is associated with this member, the returned array contains an
	...
	/**
	 * Returns the annotations associated with this member. This method is equivalent to
	...
	/**
	 * Returns the character string representing the signature of the member. If two members have
	 * the same signature (parameter types etc.), <code>getSignature()</code> returns the same
	 * string.
	 */
	 ...
	 *
	 * @see org.javassist.bytecode.SignatureAttribute#toFieldSignature(String)
	 * @see org.javassist.bytecode.SignatureAttribute#toMethodSignature(String)
	...
	/**
	 * Obtains a user-defined attribute with the given name. If that attribute is not found in the
	 * class file, this method returns null.
	 *
	 * <p>
