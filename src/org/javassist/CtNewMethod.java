...
import org.javassist.CtMethod.ConstParameter;
import org.javassist.bytecode.*;
import org.javassist.compiler.CompileError;
import org.javassist.compiler.Javac;

/**
 * A collection of static methods for creating a <code>CtMethod</code>. An instance of this class
...
public class CtNewMethod {
	...
	/**
	 * Compiles the given source code and creates a method. The source code must include not only
	 * the method body but the whole declaration, for example,
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * If the source code includes <code>$proceed()</code>, then it is compiled into a method call
	 ...
	 *            the class to which the created method is added.
	 * @param delegateObj
	 *            the source text specifying the object that is called on by
	 *            <code>$proceed()</code>.
	 * @param delegateMethod
	 *            the name of the method that is called by <code>$proceed()</code>.
	 */
	...
	/**
	 * Creates a public (non-static) method. The created method cannot be changed to a static method
	 * later.
	 *
	 * @param returnType
	 ...
	 *            <code>{}</code>. If it is <code>null</code>, the created method does nothing
	 *            except returning zero or null.
	 * @param declaring
	 *            the class to which the created method is added.
	 * @see #make(int, CtClass, String, CtClass[], CtClass[], String, CtClass)
	 */
	public static CtMethod make(CtClass returnType, String mname, CtClass[] parameters, CtClass[] exceptions, String body,
	 ...
	 * @see Modifier
	 */
	public static CtMethod make(int modifiers, CtClass returnType, String mname, CtClass[] parameters, CtClass[] exceptions, String body,
			CtClass declaring) throws CannotCompileException {
		try {
	...
	/**
	 * Creates a copy of a method. This method is provided for creating a new method based on an
	 * existing method. This is a convenience method for calling
	 * {@link CtMethod#CtMethod(CtMethod, CtClass, ClassMap) this constructor}. See the description
	 * of the constructor for particular behavior of the copying.
	 *
	 * @param src
	 *            the source method.
	 * @param declaring
	 *            the class to which the created method is added.
	 * @param map
	 *            the hash table associating original class names with substituted names. It can be
	 *            <code>null</code>.
	 *
	 ...
	 * based on an existing method. This is a convenience method for calling
	 * {@link CtMethod#CtMethod(CtMethod, CtClass, ClassMap) this constructor}. See the description
	 * of the constructor for particular behavior of the copying.
	 *
	 * @param src
	...
	/**
	 * Creates a public getter method. The getter method returns the value of the specified field in
	 * the class to which this method is added. The created method is initially not static even if
	 * the field is static. Change the modifiers if the method should be static.
	 *
	 * @param methodName
	 ...
	 * static even if the field is static. You may not change it to be static by
	 * <code>setModifiers()</code> in <code>CtBehavior</code>.
	 *
	 * @param methodName
	...
	/**
	 * Creates a method forwarding to a delegate in a super class. The created method calls a method
	 * specified by <code>delegate</code> with all the parameters passed to the created method. If
	 * the delegate method returns a value, the created method returns that value to the caller. The
	 * delegate method must be declared in a super class.
	 *
	 * <p>
	 ...
	 * <code>body</code>. However, it is wrapped in parameter-conversion code.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * The type of the <code>cvalue</code> depends on <code>constParam</code>. If
	 * <code>constParam</code> is <code>null</code>, the signature must be:
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * The method body copied from <code>body</code> is wrapped in parameter-conversion code, which
	 * converts parameters specified by <code>parameterTypes</code> into an array of
	 * <code>Object</code>. The returned value is also converted from the <code>Object</code> type
	 * to the type specified by <code>returnType</code>. Thus, the resulting method body is as
	 * follows:
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * The variables <code>p0</code>, <code>p2</code>, ... represent formal parameters of the
	 * created method. The value of <code>cvalue</code> is specified by <code>constParam</code>.
	 *
	 * <p>
	 * If the type of a parameter or a returned value is a primitive type, then the value is
	 ...
	 *
	 * <p>
	 * Note that the type of the parameter to <code>add()</code> depends only on the value of
	 * <code>argTypes</code> passed to <code>CtNewMethod.wrapped()</code>. Thus, it is easy to
	 * modify this program to produce a <code>StringVector</code> class, which is a vector
	 * containing only <code>String</code> objects, and other vector classes.
	 *
	 * @param returnType
	 *            the type of the returned value.
	 * @param mname
	 ...
	 *            a list of the exception types.
	 * @param body
	 *            the method body (must not be a static method).
	 * @param constParam
	 *            the constant parameter (maybe <code>null</code>).
	 * @param declaring
	 *            the class to which the created method is added.
	 */
	public static CtMethod wrapped(CtClass returnType, String mname, CtClass[] parameterTypes, CtClass[] exceptionTypes, CtMethod body,
			ConstParameter constParam, CtClass declaring) throws CannotCompileException {
