...
public class TypeChecker extends Visitor implements Opcode, TokenId {
	...
	/*
	 * The following fields are used by atXXX() methods for returning the type of the compiled
	 * expression.
	 */
	...
	/*
	 * Converts an array of tuples of exprType, arrayDim, and className into a String object.
	 */
	...
	/*
	 * Converts a tuple of exprType, arrayDim, and className into a String object.
	 */
	 ...
	 *
	 * It may also expand a simple class name to java.lang.*. For example, this converts Object into
	 * java/lang/Object.
	 */
	...
	/*
	 * Expands a simple class name to java.lang.*. For example, this converts Object into
	 * java/lang/Object.
	 */
	...
	/*
	 * If atBinExpr() substitutes a new expression for the original binary-operator expression, it
	 * changes the operator name to '+' (if the original is not '+') and sets the new expression to
	 * the left-hand-side expression and null to the right-hand-side expression.
	 */
	public void atBinExpr(BinExpr expr) throws CompileError {
		...
		if (k >= 0) {
			...
			if (token == '+') {
				...
				if (e != null) {
					/*
					 * String concatenation has been translated into an expression using
					 * StringBuffer.
					 */
	...
	/*
	 * EXPR must be a + expression. atPlusExpr() returns non-null if the given expression is string
	...
	/**
	 * If MEM is a static final field, this method returns a constant expression representing the
	 * value of that field.
	 */
	...
	/**
	 * Returns non-null if target is something like Foo.super for accessing the default method in an
	...
	/**
	 * @return a pair of the class declaring the invoked method and the MethodInfo of that method.
	 *         Never null.
	 */
	...
	/*
	 * if EXPR is to access a static field, fieldAccess() translates EXPR into an expression using
	 * '#' (MEMBER). For example, it translates java.lang.Integer.TYPE into java.lang.Integer#TYPE.
	 * This translation speeds up type resolution by MemberCodeGen.
	 */
		...
		if (expr instanceof Member) {
			...
			if (op == MEMBER) {
				...
				try {
					...
					/*
					 * EXPR should be a static field. If EXPR might be part of a qualified class
					 * name, lookupFieldByJvmName2() throws NoFieldException.
					 */
				...
				/*
				 * If a filed name is the same name as a package's, a static member of a class in
				 * that package is not visible. For example,
				 *
				 * class Foo { int org.javassist; }
				 *
				 * It is impossible to add the following method:
				 *
				 * String m() { return org.javassist.CtClass.intType.toString(); }
				 *
				 * because org.javassist is a field name. However, this is often inconvenient, this
