...
/**
 * AccessorMaker maintains accessors to private members of an enclosing class. It is necessary for
 * compiling a method in an inner class.
 */
public class AccessorMaker {
	...
	static final String lastParamType = "org.javassist.runtime.Inner";
	 ...
	 * @param accDesc
	 *            the descriptor of the accessor method. The first parameter type is
	 *            <code>clazz</code>. If the private method is static, <code>accDesc</code> must be
	 *            identical to <code>desc</code>.
	 * 
	 * @param orig
