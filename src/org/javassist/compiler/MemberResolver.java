...
public class MemberResolver implements TokenId {
	...
	public Method lookupMethod(CtClass clazz, CtClass currentClass, MethodInfo current, String methodName, int[] argTypes, int[] argDims,
	 ...
	 *
	 * This method does not correctly implement the Java method dispatch algorithm.
	 *
	 * If some of the parameter types exactly match but others are subtypes of the corresponding
	 * type in the signature, this method returns the number of parameter types that do not exactly
	 * match.
	 */
