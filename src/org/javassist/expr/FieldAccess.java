...
public class FieldAccess extends Expr {
	...
	/**
	 * Returns the method or constructor containing the field-access expression represented by this
	 * object.
	 */
	...
	/**
	 * Returns the signature of the field type. The signature is represented by a character string
	 ...
	 *
	 * <p>
	 * $0 is available even if the called method is static. If the field access is writing, $_ is
	 * available but the value of $_ is ignored.
	 *
	 * @param statement
	...
	/*
	 * void $proceed(<field type>) the return type is not the field type but void.
	 */
