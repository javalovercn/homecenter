...
public class NewArray extends Expr {
	...
	/**
	 * Returns the type of array components. If the created array is a two-dimensional array of
	 * <tt>int</tt>, the type returned by this method is not <tt>int[]</tt> but <tt>int</tt>.
	 */
	...
	/**
	 * Returns the number of dimensions of arrays to be created. If the opcode is multianewarray,
	 * this method returns the second operand. Otherwise, it returns 1.
	 */
