...
public class Handler extends Expr {
	...
	/**
	 * Returns the type handled by the catch clause. If this is a <code>finally</code> block,
	...
	/**
	 * Inserts bytecode at the beginning of the catch clause. The caught exception is stored in
	 * <code>$1</code>.
	 *
	 * @param src
