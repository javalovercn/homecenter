...
import org.javassist.compiler.*;
import org.javassist.compiler.ast.ASTList;
...
public class NewExpr extends Expr {
	 ...
	 * 
	 * if (c == INVOKEINTERFACE) return cp.getInterfaceMethodrefNameAndType(index); else return
	 * cp.getMethodrefNameAndType(index); }
	 */

	/**
	 * Returns the method or constructor containing the <tt>new</tt> expression represented by this
	 * object.
	 */
	 ...
	 *
	 * The signature is represented by a character string called method descriptor, which is defined
	 * in the JVM specification.
	 *
	 * @see org.javassist.CtBehavior#getSignature()
	 ...
	 * 
	 * public CtClass[] getParameterTypes() throws NotFoundException { ConstPool cp =
	 * getConstPool(); int index = iterator.u16bitAt(currentPos + 1); String desc =
	 * cp.getMethodrefType(index); return Descriptor.getParameterTypes(desc,
	...
	/**
	 * Replaces the <tt>new</tt> expression with the bytecode derived from the given source text.
	 *
	 * <p>
