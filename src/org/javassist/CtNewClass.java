...
class CtNewClass extends CtClassType {
	 ...
	 *
	 * <p>
	 * After this method is called, the class inherits all the constructors from the super class.
	 * The added constructor calls the super's constructor with the same signature.
	 */
