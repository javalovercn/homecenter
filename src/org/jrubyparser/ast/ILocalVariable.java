...
public interface ILocalVariable extends INameNode {
	/**
	 * Which Variable Scope does this variable belong to? Note that RootNode is a special
	 * ILocalScope for the implicit scope created at top-level.
	 *
	...
	/**
	 * Retrieve the node which is responsible for declaring this one. This can be a variable or a
	 * parameter.
	 * 
