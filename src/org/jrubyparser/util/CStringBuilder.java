...
/**
 * The sole purpose of this builder is to allow append(int) do a forced cast to a char. Our lexer
 * returns int's for each character and builder till convert ints to base-10 decimal strings. This
 * just makes things less error-prone
 */
