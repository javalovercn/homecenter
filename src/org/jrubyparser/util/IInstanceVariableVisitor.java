...
/**
 * To use this visitor pass in the root of the scope you want to search for instance variables. This
 * will not enter into contained classes/modules/singleton-classes so it should not see same-named
 * ivars in a nested class. If you want those as well it is up to you to realize the ivars in those
 * nested objects refer to the same instance variables and you need to visit them separately.
 */
