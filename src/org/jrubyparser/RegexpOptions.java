...
public class RegexpOptions implements Cloneable {
	...
	/**
	 * Whether the kcode associated with this regexp is implicit (aka default) or is specified
	 * explicitly (via 'nesu' syntax postscript or flags to Regexp.new.
	 * 
	...
	public boolean equals(Object other) {
		...
		return o.encodingNone == encodingNone && o.extended == extended && o.fixed == fixed && o.ignorecase == ignorecase && o.java == java
				&& o.kcodeDefault == kcodeDefault && o.multiline == multiline;
	}

	@Override
	public String toString() {
		return "RegexpOptions(" + (encodingNone == true ? ", encodingNone" : "") + (extended == true ? ", extended" : "")
				+ (fixed == true ? ", fixed" : "") + (ignorecase == true ? ", ignorecase" : "") + (java == true ? ", java" : "")
				+ (kcodeDefault == true ? ", kcodeDefault" : "") + (multiline == true ? ", multiline" : "") + (once == true ? ", once" : "")
				+ ")";
	}
