...
public abstract class J2SEExceptionJSONBuilder extends ExceptionJSONBuilder {
	...
	@Override
	public final ExceptionJSON buildJSON(final HarHelper helper, final ExceptionChecker checker, final Throwable throwable,
			final String reportURL, final String script, final String scriptErrMsg) {
		String projectID = "";
		...
		data.initData(threadName, exceptionClassName, exceptionMessage, stackTrace, sysPropertiesSnap, projectID, projectVersion,
				jreVersion, hcVersion, jrubyVersion, script, blockMessage);//scriptErrMsg
	...
	public static final StringBuilder printStackTraceToStringBuilder(final String harID, final ExceptionChecker checker,
			final Throwable throwable, StringBuilder sb, final String tab, final String errMsg) {
