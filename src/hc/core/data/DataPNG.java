...
//	private final int png_block_id_index= refresh_id_index + 2;
	...
	//尾部结构如下
	//PNG_DATA[********************************[one byte to store screenID.len][??????(ScreenID bytes)]]
	
//	private final byte DATA_IS_REFRESH_TRUE = 't';
//	private final byte DATA_IS_REFRESH_FALSE = 'f';
	
	public static final int HEAD_LENGTH = png_index - MsgBuilder.INDEX_MSG_DATA;//(6 + 4 + 3);//1 + 2 + 2 + 
...
//	}
	...
	public void setTargetID(final int dataPngLen, final byte[] id, final int offset, final int len){
...
//		bs[isrefresh_index] = (refresh?DATA_IS_REFRESH_TRUE:DATA_IS_REFRESH_FALSE);
//	}
...
//	}
	...
	public void setPNGDataLen(int len, final int x, final int y, final int width, final int height) {
	...
	public int getLength() {
		...
		return HEAD_LENGTH + pngDataLen + 
				bs[png_index + pngDataLen]//getTargetIDLen(pngDataLen)
				+ 1;
	}
