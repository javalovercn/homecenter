...
public class GZipInputStream extends InputStream {
	...
	throws IOException 
	{
		...
		//#debugSystem.out.println("creating outbuff, size=" + size + ", actual lenth=" + this.outBuff.length) ;
    ...
    private void copyFromWindow(int start, int len, byte[] dest, int destoff){
    	//#debugSystem.out.println( "copyFromWindow(start=" + start + ", len=" + len + ", dest.length=" + dest.length + ", destoff="  + destoff + ") - window.length=" + this.window.length );
    ...
    private void inflate() throws IOException{
    	//#debugSystem.out.println("inflate - outbuff.length=" + this.outBuff.length);
    	int val=0;
    ...
    public int available() throws IOException {
    	...
    	if ((this.outEnd-this.outStart)<this.outBuff.length-300){
    		inflate();
    		//#debugSystem.out.println("inflated to " + (this.outEnd-this.outStart));
    	}
