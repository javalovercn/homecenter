 ...
 * <br>
 * Powerful and efficient encryption system is built in HomeCenter system. <br>
 * <br>
 * How to develop a encryptor, please see <a target="_blank" href=
 * "http://homecenter.mobi/en/pc/faq.htm#item7">http://homecenter.mobi/en/pc/faq.htm#item7</a>
 */
public interface IEncrypter {
	/**
	 * 
	 * @param uuid
	 *            UTF-8 of uuid String
	 */
	 ...
	 * 
	 * @param password
	 *            UTF-8 of password String
	 */
	public void setPassword(byte[] password);

	/**
	 * system will call initEncrypter method before encrypt or decrypt; System
	 * will call setUUID and setPassword before initEncrypter method.
	 */
