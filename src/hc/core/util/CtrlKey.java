...
public abstract class CtrlKey {

	public static final int MAX_CTRL_ITEM_NUM = 256;
	public final int USED_KEY = 1;
	public final int[] used_keys = new int[CtrlKey.MAX_CTRL_ITEM_NUM];
	public final String[] pngs = new String[CtrlKey.MAX_CTRL_ITEM_NUM];
	public final String[] desc = new String[CtrlKey.MAX_CTRL_ITEM_NUM];
	private int keySize;
