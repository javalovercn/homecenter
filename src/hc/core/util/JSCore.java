...
public class JSCore {
	...
	public static final byte[] notifyTextFieldValue = NOTIFY_TEXT_FIELD_VALUE
			.getBytes();
	public static final byte[] notifyTextAreaValue = NOTIFY_TEXT_AREA_VALUE
			.getBytes();
	...
	public static final byte[] splitBS = StringUtil.SPLIT_LEVEL_2_JING
			.getBytes();
