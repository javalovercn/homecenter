...
public class CNCtrlKey extends CtrlKeySet {
	...
	void buildMapInfo(){
		...
		buildOneMap(CtrlKey.KEY_DIGIT_INPUT_TIME_SHIFT, "b_digit_input", "Digit Input/Time shift");
		...
		buildOneMap(CtrlKey.KEY_FAST_BACKWARD, "b_fast_backward", "Fast Backward");
		buildOneMap(CtrlKey.KEY_FAST_FORWARD, "b_fast_forward", "Fast Forward");
		buildOneMap(CtrlKey.KEY_FAVORITE_OR_CHARACTOR_STAR, "b_favorite", "Favorite/Charactor *");
		buildOneMap(CtrlKey.KEY_NUMBER_5_JKL, "b_five", "5/JKL");
		buildOneMap(CtrlKey.KEY_NUMBER_4_GHI, "b_four", "4/GHI");
		buildOneMap(CtrlKey.KEY_INFORMATION_OR_CHARACTOR_POUND, "b_information", "Information/Charactor #");
		...
		buildOneMap(CtrlKey.KEY_PROGRAM_DOWN_PAGE_DOWN, "b_program_down", "Program -/Page Down");
		buildOneMap(CtrlKey.KEY_PROGRAM_UP_PAGE_UP, "b_program_up", "Program +/Page Up");
		buildOneMap(CtrlKey.KEY_RECALL_REVIEW, "b_recall_review", "Recall/Review");
		...
		buildOneMap(CtrlKey.KEY_SKIP_DOWN_TUNE_DOWN, "b_skipdown_tunedown", "Skip-/Tune Down");
		buildOneMap(CtrlKey.KEY_SKIP_UP_TUNE_UP, "b_skipup_tuneup", "Skip+/Tune Up");
