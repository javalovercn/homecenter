...
public class HCURL {
	...
	public static final String[] FAST_RESP_PROTOCAL = { CMD_PROTOCAL,
			FORM_PROTOCAL, CONTROLLER_PROTOCAL, SCREEN_PROTOCAL };
	...
	// 注意：以_开始为特权cmd
	public static final String CMD_FOR_SUPER_PRE = buildStandardURL(
			CMD_PROTOCAL, "_");
	...
	public static final String DATA_PARA_VOICE_COMMANDS = CCoreUtil.SYS_PREFIX
			+ "voiceCommand";
	public static final String DATA_PARA_MGR_PROJS_COMMANDS = CCoreUtil.SYS_PREFIX
			+ "MgrProjs";
	...
	public static final String DATA_PARA_NOTIFY_RECEIVE_ROOT_MENU_DATA = "notifyReceiveRootMenuData";
	...
	public static final String URL_CMD_EXIT = buildStandardURL(
			HCURL.CMD_PROTOCAL, HCURL.DATA_CMD_EXIT);
	public static final String URL_CMD_CONFIG = buildStandardURL(
			HCURL.CMD_PROTOCAL, HCURL.DATA_CMD_CONFIG);
	// 注意：如果增加新项，请同步增加到ServerUIAPIAgent.FAST_NOT_RESP_URL

	public static final String URL_HOME_SCREEN = buildStandardURL(
			HCURL.SCREEN_PROTOCAL, HCURL.REMOTE_HOME_SCREEN);
	public static final String URL_CFG_ADD_DEVICE_BY_QR = buildStandardURL(
			HCURL.CFG_PROTOCAL, ADD_HAR_QR);
	public static final String URL_CFG_ADD_DEVICE_BY_WIFI = buildStandardURL(
			HCURL.CFG_PROTOCAL, ADD_HAR_WIFI);
	public static final String URL_CMD_VOICE_COMMAND = buildStandardURL(
			HCURL.CMD_PROTOCAL, VOICE_COMMAND);
	public static final String URL_CMD_MGR_PROJS_COMMAND = buildStandardURL(
			HCURL.CMD_PROTOCAL, MGR_PROJS_COMMAND);

	public static final String URL_DEFAULT_MLET_ALIAS = "";

	public static final String DIALOG_PRE = CCoreUtil.SYS_PREFIX + "DIALOG_";
	public static final String URL_DIALOG_PRE = buildStandardURL(
			HCURL.FORM_PROTOCAL, DIALOG_PRE);

	public static final String HTML_LOAD_DONE = "window.hcloader.stop();";

	public static final boolean isUsingWiFiWPS = false;

	public static final String[] URL_PROTOCAL = { CMD_PROTOCAL, SCREEN_PROTOCAL,
			CONTROLLER_PROTOCAL, FORM_PROTOCAL, CFG_PROTOCAL, MENU_PROTOCAL };

	public static String buildStandardURL(final String protocal,
			final String target) {
		return protocal + HTTP_SPLITTER + target;
	}

	public final static String FORM_MLET_PREFIX = buildStandardURL(
			FORM_PROTOCAL, "");
	...
	public static void checkSuperCmd(final String url) {
		if (url.startsWith(CMD_FOR_SUPER_PRE)) {
			throw new IllegalArgumentException(
					"cmd can NOT start with '" + CMD_FOR_SUPER_PRE + "'");
		}
	}

	public static void setToContext(final CoreSession coreSS,
			final HCURL hcurl) {
	...
	public static String getNextParaValue(final CoreSession coreSS) {
		final String key = coreSS.contextHCURL
				.getParaAtIdx(coreSS.urlParaIdx++);
		if (key == null) {
			return null;
		} else {
