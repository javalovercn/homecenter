...
public abstract class IConstant {
	...
	public static final int GG_SPEECH_PORT = 62222;
	public static final int GG_SPEECH_HEADER_LEN_BYTE_LEN = 2;
	public static final int GG_SPEECH_FILE_LEN_BYTE_LEN = 8;
	...
	// public static final byte[] DATA_PROTOCAL_HEAD = {DATA_PROTOCAL_HEAD_H,
	// DATA_PROTOCAL_HEAD_C};
	...
	public static void setPassword(final String pwd) {
		...
		// LogManager.log("PWD byte len:" + passwordBS.length + ", " +
		// password);
		CUtil.setCertKey(
