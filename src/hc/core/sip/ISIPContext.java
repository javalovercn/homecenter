...
public abstract class ISIPContext {
	...
	// public abstract StunDesc stun(Object iaddress, String stunServer, int
	// stunServerPort, int udpPort);

	public abstract Object buildSocket(int localPort, String targetServer,
			int targetPort);
	...
	public abstract DataInputStream getInputStream(Object socket)
			throws IOException;

	public abstract DataOutputStream getOutputStream(Object socket)
			throws IOException;

	public abstract void setInputOutputStream(final DataInputStream dis,
	 ...
	 * @param socket
	 */
	public void deploySocket(final HCConnection hcConnection,
			final Object socket) throws Exception {
		enterDeployStatus();

		final Object inputStream = (socket == null) ? null
				: getInputStream(socket);
		hcConnection.setReceiveServerInputStream(inputStream, false, false);

		final Object outputStream = (socket == null) ? null
