...
public class MSBException extends Error {
	...
	protected static final String UN_RE_DISPATCH = Message.class.getSimpleName()
			+ " can't be in used more than two tasks";
	protected static final String UN_MODIFIED = Message.class.getSimpleName()
			+ " can't be modified after dispatch or in process";
	protected static final String TOO_MUCH_FORWARD_STR = "too much times (" + TOO_MUCH_FORWARD
			+ ") forwarding, may be in surround";
	protected static final String EMPTY_DEV_ID = Message.class.getSimpleName()
			+ " can't be empty device ID";
	// protected static final String EMPTY_BIND_ID =
	// Message.class.getSimpleName() + " error in isInitiative value of dispatch
	// method.";
	protected static final String SAME_KEY_PROC = Message.class.getSimpleName()
			+ " can't be added in same key processor";
	...
	public MSBException(final String message, final Throwable cause, final Message msg,
