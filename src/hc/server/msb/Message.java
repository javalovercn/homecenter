...
public final class Message {
	...
	/**
	 * In <code>Robot</code>, it means <i>Reference Device ID</i>; <BR>
	...
	final void tryRecycle(final Workbench workbench, final boolean isShutdown) {
		// Workbench.V = Workbench.O ? false : Workbench.log("try recycle
		...
		if (ctrl_sync_id != 0) {
			...
			if (wm != null) {
				if (wm.dispatch_thread_id != ctrl_dispatch_thread_id) {// 由于可能存在异常，增加header_dispatch_thread_id比对
					...
					// workbench.log("WaitingForMessage result
	...
	final void cloneHeaderTo(final Message target) {
		...
		// target.header_dispatch_thread_id =
		// header_dispatch_thread_id;//本项不能被复制
	 ...
	 * {@link #setByteArrayHeader(String, byte[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * to copy to new byte array , please invoke
	 * {@link #setByteArrayBody(String, byte[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setShortArrayBody(String, short[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setFloatArrayBody(String, float[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setCharArrayBody(String, char[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setLongArrayBody(String, long[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setDoubleArrayBody(String, double[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setBooleanArrayBody(String, boolean[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	 ...
	 * {@link #setStringArrayBody(String, String[], int, int)}.
	 * 
	 * @param name
	 * @param value
	 *            is NOT copied.
	...
	public final String toString() {
		...
		return "\n\t{" + super.toString() + ", dev_id=" + ctrl_dev_id + sb.toString() + "}";
	}
}
