...
public abstract class Processor {
	...
	final void __response(final Message msg, final boolean isDownward) {
		...
		// workbench.log(this.getClass().getSimpleName() + " todo new Message "
	...
	final void pushInFromWorkbench(final Message msg) {
		// workbench.V = workbench.O ? false : workbench.log("push message " +
	...
	// return " [" + name + "] in project [" + __context.getProjectID() + "]";//
	// + super.toString();
	// }
