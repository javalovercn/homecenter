...
public class CallContext {
	...
	private final String removeWarning(final String msg) {
		// <script>:20 warning: singleton on non-persistent Java type
		// #<Class:0x7f178b3c> (http://wiki.jruby.org/Persistence)
	...
	private final void buildInvocationErrMsg(final Throwable t, final StringBuilder sb) {
		...
		// at
		// hc.server.ui.design.engine.HCJRubyEngine.runScriptlet(HCJRubyEngine.java:123)
		// at
		// hc.server.ui.design.engine.RubyExector.runAndWaitOnEngine(RubyExector.java:133)
		...
		// Caused by: org.jruby.embed.EvalFailedException:
		// java.lang.NullPointerException
		// at
		// org.jruby.embed.internal.EmbedEvalUnitImpl.run(EmbedEvalUnitImpl.java:137)
		// ... 11 more
		...
		// at
		// org.jruby.runtime.invokedynamic.InvocationLinker.invocationFallback(InvocationLinker.java:132)
		// at $_lt_script_gt_.method__5$RUBY$initialize(<script>:47)
		// at
		// $_lt_script_gt_$method__5$RUBY$initialize.call($_lt_script_gt_$method__5$RUBY$initialize)
		// at
		...
		// at
		// org.jruby.java.proxies.ConcreteJavaProxy$3.call(ConcreteJavaProxy.java:141)
		// at
		// java.lang.invoke.MethodHandle.invokeWithArguments(MethodHandle.java:599)
		// at
		// org.jruby.runtime.invokedynamic.InvocationLinker.invocationFallback(InvocationLinker.java:132)
