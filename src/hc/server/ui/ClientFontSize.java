...
public class ClientFontSize {
	...
	public final boolean updateFontSize(final int maxWH, final int fontSizeForLarge, final int fontSizeForNormal, final int fontSizeForSmall, 
			final int fontSizeForButton){
