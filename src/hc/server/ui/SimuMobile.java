...
public class SimuMobile {
	...
	public static Robot buildSimuRobot() {
		...
		// script.");//会导致block access Homecenter Non-public api
	...
	public static synchronized HCJRubyEngine rebuildJRubyEngine() {
		...
		runTestEngine = new HCJRubyEngine(getConsoleWriter(), StoreDirManager.RUN_TEST_ABS_PATH,
				ServerUtil.buildProjClassLoader(StoreDirManager.RUN_TEST_DIR, "hc.testDir"), true,
				HCJRubyEngine.IDE_LEVEL_ENGINE + "TestEngine");
		return runTestEngine;
	}
