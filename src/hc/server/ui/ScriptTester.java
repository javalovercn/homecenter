...
public class ScriptTester {
	...
	// (BindRobotSource)ContextManager.getThreadPool().runAndWait(new
	// ReturnableRunnable() {
	// @Override
	...
	// final BindHTMLMlet mlet = new BindHTMLMlet(source, threadToken,
	// okImage[0], cancelImage[0], "OK", "Cancel", false,
