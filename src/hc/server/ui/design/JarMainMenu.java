...
public class JarMainMenu extends MCanvasMenu implements ICanvas {
		...
		if (menuItemObj != null) {
			...
			for (int itemIdx = 0; itemIdx < itemCount; itemIdx++) {
				...
				final I18NStoreableHashMapWithModifyFlag i18nName = HCjar
						.buildI18nMapFromSerial((String) map.get(header + HCjar.ITEM_I18N_NAME));
	...
	public final void appendProjToMenuItemArray(final Map<String, Object>[] maps, final int mapSize,
