...
public class SystemHTMLMlet extends HTMLMlet {
	...
	public static void setAreaCSS(final HTMLMlet mlet, final JTextArea area) {
		...
		mlet.setCSS(area, null, "width:100%;height:100%;" + "overflow:scroll;" + // font-size:"
																					// +
																					// normalFontSize
																					// +
																					// "px;
				"background-color:#" + HTMLMlet.toHexColor(AREA_BACK_COLOR, false) + ";color:#"
	...
	public static void setAreaCSS(final Dialog dialog, final JTextArea area) {
		...
		dialog.setCSS(area, null, "width:100%;height:100%;" + "overflow:scroll;" + // font-size:"
																					// +
																					// normalFontSize
																					// +
																					// "px;
