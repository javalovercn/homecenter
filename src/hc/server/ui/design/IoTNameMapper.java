...
public class IoTNameMapper extends NameMapper {
	...
	// final HashMap<String, DeviceList> workingDeviceList = new HashMap<String,
	// DeviceList>(4);
	...
	// public String searchBindIDFromDevice(final String proj_id, final String
	// devName, final String devID){
