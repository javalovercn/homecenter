...
public class LinkProjectStore extends StoreableHashMap{
	...
	private final String NULL_REFERENCE = "null";
	 ...
	 */
	private final String FIELD_BIND_DEV_MAP = "bindDevMap";
	private final String FIELD_BIND_CONV_MAP = "bindConvMap";
	/**
	 * 用于升级时，复制bind
	 * @param fromLps
	 * @param toLps
	...
	private final String FIELD_IS_CHANGED_BEFORE_UPGRADE = "chgBfrUpgrade";
