...
public class J2SEEClassHelper {
	protected static void dispatch(final J2SESession coreSS, final String className,
		...
		// System.out.println("testClass ====>" + ByteUtil.buildString(bs,
		// offset, len, IConstant.UTF_8));
		// }
	}
}
