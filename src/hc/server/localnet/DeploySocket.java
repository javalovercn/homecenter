...
public class DeploySocket {
	...
	static final byte[] ERR_IS_BUSY = ByteUtil.getBytes("server is busy or can't deploy now, please try late or close locking window!", IConstant.UTF_8);
	 ...
	 * 
	 * @param len
	 * @param passwords null means NOT encrypt
	 * @return
	 * @throws IOException
	 */
