...
/**
 * <p>
 * This implementation of the JobCalendar excludes a set of days of the month. You
 ...
 */
public class MonthlyJobCalendar extends BaseJobCalendar implements JobCalendar,
        Serializable {
    ...
    public MonthlyJobCalendar() {
        this(null, null);
    }

    public MonthlyJobCalendar(final JobCalendar baseCalendar) {
        this(baseCalendar, null);
    }

    public MonthlyJobCalendar(final TimeZone timeZone) {
        this(null, timeZone);
    }

    public MonthlyJobCalendar(final JobCalendar baseCalendar, final TimeZone timeZone) {
    ...
    @Override
    public Object clone() {
        final MonthlyJobCalendar clone = (MonthlyJobCalendar) super.clone();
