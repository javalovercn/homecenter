package hc.server.util.scheduler;
 ...
 * exclude business hours (8AM - 5PM) every day. Each <CODE>DailyJobCalendar</CODE>
 ...
 * are excluded.
 * <P>
 * Note when using <CODE>DailyJobCalendar</CODE>, it behaves on the same principals
 * as, for example, {@link hc.server.util.scheduler.WeeklyJobCalendar 
 * WeeklyJobCalendar}. <CODE>WeeklyJobCalendar</CODE> defines a set of days that are
 * excluded <I>every week</I>. Likewise, <CODE>DailyJobCalendar</CODE> defines a 
 * set of times that are excluded <I>every day</I>.
 * 
 * @author Mike Funk, Aaron Craven
 */
public class DailyJobCalendar extends BaseJobCalendar {
     ...
     *                          the time range
     */
    public DailyJobCalendar(final String rangeStartingTime,
     ...
     *                          time range
     */
    public DailyJobCalendar(final hc.server.util.scheduler.JobCalendar baseCalendar,
     ...
     *                               range
     */
    public DailyJobCalendar(final int rangeStartingHourOfDay,
     ...
     * <b>Note:</b> This <CODE>DailyJobCalendar</CODE> will use the 
     * <code>{@link TimeZone#getDefault()}</code> time zone.
     * You should use <code>{@link #DailyJobCalendar(hc.server.util.scheduler.JobCalendar, java.util.TimeZone, long, long)}</code>
     ...
     *                                  <code>DailyJobCalendar</code> which will 
     ...
     *                                  the time range
     */
    public DailyJobCalendar(final TimeZone timeZone,
                         final long rangeStartingTimeInMillis,
                         final long rangeEndingTimeInMillis) {
        super(timeZone);
        setTimeRange(rangeStartingTimeInMillis, 
    ...
    @Override
    public Object clone() {
        final DailyJobCalendar clone = (DailyJobCalendar) super.clone();
        return clone;
    }
    ...
    public boolean isTimeIncluded(final long timeInMillis) {        
        ...
        final long timeRangeStartingTimeInMillis = 
            getTimeRangeStartingTimeInMillis(timeInMillis);
        final long timeRangeEndingTimeInMillis = 
     ...
     * 
     * @param rangeStartingCalendar a JobCalendar containing the start time for
     *                              the <CODE>DailyJobCalendar</CODE>
     * @param rangeEndingCalendar   a JobCalendar containing the end time for
     *                              the <CODE>DailyJobCalendar</CODE>
     */
     ...
     *                          range
     */
    public void setTimeRange(final long rangeStartingTime, 
                              final long rangeEndingTime) {
        setTimeRange(
