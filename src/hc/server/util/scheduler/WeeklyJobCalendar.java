...
/**
 * <p>
 * This implementation of the JobCalendar excludes a set of days of the week. You
 ...
 */
public class WeeklyJobCalendar extends BaseJobCalendar implements JobCalendar,
        Serializable {
    ...
    public WeeklyJobCalendar() {
        this(null, null);
    }

    public WeeklyJobCalendar(final JobCalendar baseCalendar) {
        this(baseCalendar, null);
    }

    public WeeklyJobCalendar(final TimeZone timeZone) {
        super(null, timeZone);
    }

    public WeeklyJobCalendar(final JobCalendar baseCalendar, final TimeZone timeZone) {
    ...
    @Override
    public Object clone() {
        final WeeklyJobCalendar clone = (WeeklyJobCalendar) super.clone();
    ...
    /**
     * <p>
     * Return true, if wday (see JobCalendar.get()) is defined to be exluded. E. g.
     * saturday and sunday.
     * </p>
     */
     ...
     * (false). Use {@link java.util.Calendar#SUNDAY} - {@link java.util.Calendar#SATURDAY} to determine the
     * wday.
     * </p>
     */
