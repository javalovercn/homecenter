...
/**
 * <p>
 * This implementation of the JobCalendar excludes a set of days of the year. You
 ...
 */
public class AnnualJobCalendar extends BaseJobCalendar implements JobCalendar,
        Serializable {
    ...
    public AnnualJobCalendar() {
    }

    public AnnualJobCalendar(final JobCalendar baseCalendar) {
        super(baseCalendar);
    }

    public AnnualJobCalendar(final TimeZone timeZone) {
        super(timeZone);
    }

    public AnnualJobCalendar(final JobCalendar baseCalendar, final TimeZone timeZone) {
        super(baseCalendar, timeZone);
    }

    @Override
    public Object clone() {
        final AnnualJobCalendar clone = (AnnualJobCalendar) super.clone();
    ...
    /**
     * <p>
     * Return true, if day (java.util.Calendar) is defined to be exluded.
     * </p>
     */
    ...
    /**
     * Remove the given day (java.util.Calendar) from the list of excluded days
     *  
