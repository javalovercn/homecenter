 ...
 * example to exclude weekends you may use WeeklyJobCalendar. In order to exclude
 * holidays as well you may define a WeeklyJobCalendar instance to be the base
 * calendar for HolidayJobCalendar instance.
 * </p>
 *
...
public class BaseJobCalendar implements JobCalendar, Serializable, Cloneable {
    ...
    /**
     * @param timeZone The time zone to use for this JobCalendar, <code>null</code>
     ...
     * resolved.
     *
     * @return This JobCalendar's timezone, <code>null</code> if JobCalendar should
     ...
     * </p>
     *
     * @see hc.server.util.scheduler.JobCalendar#isTimeIncluded(long)
     */
    @Override
     ...
     * JobCalendar after the given time. Return the original value if timeStamp is
     * included. Return 0 if all days are excluded.
     * </p>
     *
     * @see hc.server.util.scheduler.JobCalendar#getNextIncludedTime(long)
     */
    @Override
     ...
     * The new JobCalendar will use the <code>BaseJobCalendar</code> time zone if it
     ...
     * The new JobCalendar will use the <code>BaseJobCalendar</code> time zone if
     ...
     * This calculation will take the <code>BaseJobCalendar</code>
