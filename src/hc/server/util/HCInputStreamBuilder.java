...
public class HCInputStreamBuilder {
	...
	public static HCImageInputStream buildImageStream(final InputStream is, 
			final float azimuth, final float pitch, final float roll, final String format, final double latitude, final double longitude,
			final double altitude){
		L.V = L.WShop ? false : LogManager.log("build stream (image), " +
				"format : " + format + ", azimuth : " + azimuth + ", pitch : " + pitch + ", roll : " + roll + ", latitude : " + latitude + 
	...
	public static HCAudioInputStream buildAudioStream(final InputStream is, final String format,
		...
		L.V = L.WShop ? false : LogManager.log("build stream (audio), format : " + format + ", latitude : " + latitude + 
				", longitude : " + longitude + ", altitude : " + altitude);
