...
/**
 * This implementation of the JobCalendar excludes the set of times expressed by a given cron
 * expression. For example, you could use this calendar to exclude all but business hours (8AM -
 * 5PM) every day using the expression &quot;* * 0-7,18-23 ? * *&quot;.
 * <P>
 * It is important to remember that the cron expression here describes a set of times to be
 * <I>excluded</I> from firing. Whereas the cron expression in cron trigger describes a set of times
 * that can be <I>included</I> for firing. Thus, if a cron trigger has a given cron expression and
 * is associated with a <CODE>CronExcludeJobCalendar</CODE> with the <I>same</I> expression, the
 * calendar will exclude all the times the trigger includes, and they will cancel each other out.
 * 
 * @author Aaron Craven
 */
public class CronExcludeJobCalendar extends BaseJobCalendar {
	 ...
	 *            for more about Cron Expression, please click <a href=
	 ...
	 */
	public CronExcludeJobCalendar(final String cronExpression) throws ParseException {
	 ...
	 *            "http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html">http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html</a>
	 */
	public CronExcludeJobCalendar(final JobCalendar baseCalendar, final String cronExpression) throws ParseException {
	 ...
	 *            "http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html">http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html</a>
	 * @param timeZone
	 *            Specifies for which time zone the <code>expression</code> should be interpreted,
	 *            i.e. the expression 0 0 10 * * ?, is resolved to 10:00 am in this time zone. If
	 *            <code>timeZone</code> is <code>null</code> then <code>TimeZone.getDefault()</code>
	 *            will be used.
	 */
	public CronExcludeJobCalendar(final JobCalendar baseCalendar, final String cronExpression, final TimeZone timeZone)
	 ...
	 * <code>CronExcludeJobCalendar</code> will be resolved.
	 * <p>
	 */
	@Override
	 ...
	 * <code>CronExcludeJobCalendar</code> will be resolved. If <code>timeZone</code> is
	...
	/**
	 * Determines the next time included by the <CODE>CronExcludeJobCalendar</CODE> after the
	 * specified time.
	 * 
	 * @param timeInMillis
	...
	/**
	 * Returns a string representing the properties of the <CODE>CronExcludeJobCalendar</CODE>
	 * 
	...
	/**
	 * Returns the object representation of the cron expression that defines the dates and times
	 * this calendar excludes.
	 * 
