...
/**
 * This implementation of the JobCalendar excludes the set of times expressed by
 * a given cron expression. For example, you could use this calendar to exclude
 * all but business hours (8AM - 5PM) every day using the expression &quot;* *
 * 0-7,18-23 ? * *&quot;.
 * <P>
 * It is important to remember that the cron expression here describes a set of
 * times to be <I>excluded</I> from firing. Whereas the cron expression in cron
 * trigger describes a set of times that can be <I>included</I> for firing.
 * Thus, if a cron trigger has a given cron expression and is associated with a
 * <CODE>CronExcludeJobCalendar</CODE> with the <I>same</I> expression, the
 * calendar will exclude all the times the trigger includes, and they will
...
public class CronExcludeJobCalendar extends BaseJobCalendar {
	...
	/**
	 * Create a <CODE>CronExcludeJobCalendar</CODE> with the given cron
	 * expression and no <CODE>baseCalendar</CODE>.
	 * 
	...
	/**
	 * Create a <CODE>CronExcludeJobCalendar</CODE> with the given cron
	 * expression and <CODE>baseCalendar</CODE>.
	 * 
	 * @param baseCalendar
	 ...
	 *            "http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html">http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html</a>
	 */
	public CronExcludeJobCalendar(final JobCalendar baseCalendar, final String cronExpression)
	...
	/**
	 * Create a <CODE>CronExcludeJobCalendar</CODE> with the given cron
	 * exprssion, <CODE>baseCalendar</CODE>, and <code>TimeZone</code>.
	 * 
	 * @param baseCalendar
	 *            the base calendar for this calendar instance
	 * @param cronExpression
	 ...
	 * <code>CronExcludeJobCalendar</code> will be resolved. If
	 * <code>timeZone</code> is <code>null</code> then
	 * <code>TimeZone.getDefault()</code> will be used.
	 * <p>
	 */
	 ...
	 * <CODE>CronExcludeJobCalendar</CODE> after the specified time.
	 * 
	 * @param timeInMillis
	...
	public long getNextIncludedTime(final long timeInMillis) {
		...
		while (!isTimeIncluded(nextIncludedTime)) {
			...
			if (cronExpression.isSatisfiedBy(new Date(nextIncludedTime))) {
				nextIncludedTime = cronExpression
						.getNextInvalidTimeAfter(new Date(nextIncludedTime)).getTime();
