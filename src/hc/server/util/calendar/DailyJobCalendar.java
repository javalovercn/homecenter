 ...
 * as, for example, {@link hc.server.util.calendar.WeeklyJobCalendar 
...
public class DailyJobCalendar extends BaseJobCalendar {
     ...
     *                          time range
     */
    public DailyJobCalendar(final JobCalendar baseCalendar,
     ...
     * <b>Note:</b> This <CODE>DailyJobCalendar</CODE> will use the 
     * <code>{@link TimeZone#getDefault()}</code> time zone.
     * You should use <code>{@link #DailyJobCalendar(JobCalendar, java.util.TimeZone, long, long)}</code>
