...
/**
 * in JRuby, all Java String instance are traded as JRuby String, NOT Java
 * String, so this class is helpful to provide Java String functions/methods in
 * JRuby.
 * 
 * @author Lee Boynton
...
public final class JavaString {
	...
	/**
	 * Initializes a newly created {@code JavaString} object so that it
	 ...
	 * an explicit copy of {@code original} is needed, use of this constructor
	 * is unnecessary since Strings are immutable.
	 *
	 * @param original
	 *            A {@code String}
	...
	/**
	 * Allocates a new {@code JavaString} so that it represents the sequence of
	...
	/**
	 * Allocates a new {@code JavaString} that contains characters from a
	 * subarray of the character array argument. The {@code offset} argument is
	 * the index of the first character of the subarray and the {@code count}
	...
	/**
	 * Allocates a new {@code JavaString} that contains characters from a
	 * subarray of the <a href="Character.html#unicode">Unicode code point</a>
	 * array argument. The {@code offset} argument is the index of the first
	 * code point of the subarray and the {@code count} argument specifies the
	...
	/**
	 * Allocates a new {@code JavaString} constructed from a subarray of an
	...
	/**
	 * Allocates a new {@code JavaString} containing characters constructed from
	 * an array of 8-bit integer values. Each character <i>c</i>in the resulting
	...
	/**
	 * Constructs a new {@code JavaString} by decoding the specified subarray of
	 * bytes using the specified charset. The length of the new
	 * {@code JavaString} is a function of the charset, and hence may not be
	 ...
	 * The length of the new {@code JavaString} is a function of the charset,
	...
	/**
	 * Constructs a new {@code JavaString} by decoding the specified array of
	 * bytes using the specified {@linkplain java.nio.charset.Charset charset}.
	 * The length of the new {@code JavaString} is a function of the charset,
	 ...
	 * @since JDK1.1
	 */
	public JavaString(final byte bytes[], final String charsetName)
			throws UnsupportedEncodingException {
	...
	/**
	 * Constructs a new {@code JavaString} by decoding the specified array of
	 * bytes using the platform's default charset. The length of the new {@code
	 ...
	 * <i>repl</i><tt>)</tt> yields exactly the same result as the expression
	 *
	 * <blockquote><tt>
	 ...
	 * <table border="1" summary="Lowercase mapping examples showing language
	 * code of locale, upper case, lower case, and description">
	 * <tr>
	 ...
	 * "doc-files/upsilon.gif" alt="upsilon">
