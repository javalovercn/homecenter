...
/**
 * in JRuby, all Java String instance are traded as JRuby String, NOT Java String, so this class is
 * helpful to provide Java String functions/methods in JRuby.
 * 
 * @author Lee Boynton
...
public final class JavaString {
	...
	/**
	 * Initializes a newly created {@code JavaString} object so that it represents an empty
	 * character sequence. Note that use of this constructor is unnecessary since Strings are
	 * immutable.
	 */
	public JavaString() {
		this.str = new String();
	...
	/**
	 * Initializes a newly created {@code JavaString} object so that it represents the same sequence
	 * of characters as the argument; in other words, the newly created string is a copy of the
	 ...
	 *            A {@code String}
	 */
	public JavaString(final String original) {
		this.str = new String(original);
	}

	/**
	 * Allocates a new {@code JavaString} so that it represents the sequence of characters currently
	 ...
	 */
	public JavaString(final char value[]) {
		this.str = new String(value);
	}

	/**
	 * Allocates a new {@code JavaString} that contains characters from a subarray of the character
	 ...
	 *             If the {@code offset} and {@code count} arguments index characters outside the
	 *             bounds of the {@code value} array
	 */
	public JavaString(final char value[], final int offset, final int count) {
		this.str = new String(value, offset, count);
	}

	/**
	 * Allocates a new {@code JavaString} that contains characters from a subarray of the
	 ...
	 * {@code char}s; subsequent modification of the {@code int} array does not affect the newly
	 * created string.
	 *
	 * @param codePoints
	 ...
	 * @since 1.5
	 */
	public JavaString(final int[] codePoints, final int offset, final int count) {
		this.str = new String(codePoints, offset, count);
	}

	/**
	 * Allocates a new {@code JavaString} constructed from a subarray of an array of 8-bit integer
	 * values.
	 *
	 * <p>
	 * The {@code offset} argument is the index of the first byte of the subarray, and the
	 * {@code count} argument specifies the length of the subarray.
	 *
	 * <p>
	 ...
	 *             the preferred way to do this is via the {@code String} constructors that take a
	 *             {@link java.nio.charset.Charset}, charset name, or that use the platform's
	 *             default charset.
	 *
	 * @param ascii
	 ...
	 *
	 * @see #JavaString(byte[], int)
	 * @see #JavaString(byte[], int, int, java.lang.String)
	 * @see #JavaString(byte[], int, int, java.nio.charset.Charset)
	 * @see #JavaString(byte[], int, int)
	 * @see #JavaString(byte[], java.lang.String)
	 * @see #JavaString(byte[], java.nio.charset.Charset)
	 * @see #JavaString(byte[])
	 */
	@Deprecated
	public JavaString(final byte ascii[], final int hibyte, final int offset, final int count) {
		this.str = new String(ascii, hibyte, offset, count);
	}

	/**
	 * Allocates a new {@code JavaString} containing characters constructed from an array of 8-bit
	 * integer values. Each character <i>c</i>in the resulting string is constructed from the
	 ...
	 */
	@Deprecated
	public JavaString(final byte ascii[], final int hibyte) {
		this(ascii, hibyte, 0, ascii.length);
	}

	/**
	 * Constructs a new {@code JavaString} by decoding the specified subarray of bytes using the
	 * specified charset. The length of the new {@code JavaString} is a function of the charset, and
	 ...
	 *
	 * @throws IndexOutOfBoundsException
	 *             If the {@code offset} and {@code length} arguments index characters outside the
	 *             bounds of the {@code bytes} array
	 *
	 * @since JDK1.1
	 */
	public JavaString(final byte bytes[], final int offset, final int length, final String charsetName)
			throws UnsupportedEncodingException {
	...
	/**
	 * Constructs a new {@code JavaString} by decoding the specified subarray of bytes using the
	 * specified {@linkplain java.nio.charset.Charset charset}. The length of the new
	 * {@code JavaString} is a function of the charset, and hence may not be equal to the length of
	 * the subarray.
	 *
	 * <p>
	 ...
	 *
	 * @param charset
	 *            The {@linkplain java.nio.charset.Charset charset} to be used to decode the
	 *            {@code bytes}
	 *
	 * @throws IndexOutOfBoundsException
	 *             If the {@code offset} and {@code length} arguments index characters outside the
	 ...
	 * @since 1.6
	 */
	public JavaString(final byte bytes[], final int offset, final int length, final Charset charset) {
		this.str = new String(bytes, offset, length, charset);
	}

	/**
	 * Constructs a new {@code JavaString} by decoding the specified array of bytes using the
	 * specified {@linkplain java.nio.charset.Charset charset}. The length of the new
	 * {@code JavaString} is a function of the charset, and hence may not be equal to the length of
	 * the byte array.
	 *
	 ...
	 * @since JDK1.1
	 */
	public JavaString(final byte bytes[], final String charsetName) throws UnsupportedEncodingException {
	 ...
	 * @since 1.6
	 */
	public JavaString(final byte bytes[], final Charset charset) {
		this(bytes, 0, bytes.length, charset);
	}

	/**
	 * Constructs a new {@code JavaString} by decoding the specified subarray of bytes using the
	 * platform's default charset. The length of the new {@code JavaString} is a function of the
	 ...
	 *
	 * @throws IndexOutOfBoundsException
	 *             If the {@code offset} and the {@code length} arguments index characters outside
	 *             the bounds of the {@code bytes} array
	 *
	 * @since JDK1.1
	 */
	public JavaString(final byte bytes[], final int offset, final int length) {
		this.str = new String(bytes, offset, length);
	}

	/**
	 * Constructs a new {@code JavaString} by decoding the specified array of bytes using the
	 * platform's default charset. The length of the new {@code
	 * String} is a function of the charset, and hence may not be equal to the length of the byte
	 * array.
	 *
	 * <p>
	 * The behavior of this constructor when the given bytes are not valid in the default charset is
	 ...
	 * @since JDK1.1
	 */
	public JavaString(final byte bytes[]) {
		this(bytes, 0, bytes.length);
	}

	/**
	 * Allocates a new string that contains the sequence of characters currently contained in the
	 * string buffer argument. The contents of the string buffer are copied; subsequent modification
	 * of the string buffer does not affect the newly created string.
	 *
	 * @param buffer
	 *            A {@code StringBuffer}
	 */
	public JavaString(final StringBuffer buffer) {
		this.str = new String(buffer);
	}

	/**
	 * Allocates a new string that contains the sequence of characters currently contained in the
	 * string builder argument. The contents of the string builder are copied; subsequent
	 * modification of the string builder does not affect the newly created string.
	 *
	 * <p>
	 ...
	 * @since 1.5
	 */
	public JavaString(final StringBuilder builder) {
		this.str = new String(builder);
	}

	/*
	 * Package private constructor which shares value array for speed. this constructor is always
	 * expected to be called with share==true. a separate constructor is needed because we already
	 * have a public String(char[]) constructor that makes a copy of the given char[].
	 */
	JavaString(final char[] value, final boolean share) {
		this.str = new String(value);
	}
	 ...
	 *
	 * @deprecated Use {@link #JavaString(char[],int,int)} instead.
	 */
	@Deprecated
	JavaString(final int offset, final int count, final char[] value) {
	 ...
	 *                if the <code>index</code> argument is negative or not less than the length of
	 *                this string.
	 */
	 ...
	 * @exception IndexOutOfBoundsException
	 *                if the <code>index</code> argument is less than 1 or greater than the length
	 *                of this string.
	 * @since 1.5
	 */
	 ...
	 * <code>String</code>. The text range begins at the specified <code>beginIndex</code> and
	 * extends to the <code>char</code> at index <code>endIndex - 1</code>. Thus the length (in
	 * <code>char</code>s) of the text range is <code>endIndex-beginIndex</code>. Unpaired
	 ...
	 * @exception IndexOutOfBoundsException
	 *                if the <code>beginIndex</code> is negative, or <code>endIndex</code> is larger
	 *                than the length of this <code>String</code>, or <code>beginIndex</code> is
	...
	/**
	 * Returns the index within this <code>String</code> that is offset from the given
	 * <code>index</code> by <code>codePointOffset</code> code points. Unpaired surrogates within
	 * the text range given by <code>index</code> and <code>codePointOffset</code> count as one code
	 * point each.
	 *
	 * @param index
	 ...
	 * @exception IndexOutOfBoundsException
	 *                if <code>index</code> is negative or larger then the length of this
	 *                <code>String</code>, or if <code>codePointOffset</code> is positive and the
	 *                substring starting with <code>index</code> has fewer than
	 *                <code>codePointOffset</code> code points, or if <code>codePointOffset</code>
	 *                is negative and the substring before <code>index</code> has fewer than the
	 *                absolute value of <code>codePointOffset</code> code points.
	 * @since 1.5
	 */
	 ...
	 * <code>srcEnd-srcBegin</code>). The characters are copied into the subarray of
	 ...
	 * low-order bits of the corresponding character. The eight high-order bits of each character
	 ...
	 *             the preferred way to do this is via the {@link #getBytes()} method, which uses
	 ...
	 *
	 * @return {@code true} if this {@code String} represents the same sequence of char values as
	 *         the specified sequence, {@code
	 *          false} otherwise
	 *
	 * @since 1.5
	 */
	 ...
	 * character in the strings. The character sequence represented by this <code>String</code>
	 * object is compared lexicographically to the character sequence represented by the argument
	 * string. The result is a negative integer if this <code>String</code> object lexicographically
	 * precedes the argument string. The result is a positive integer if this <code>String</code>
	 * object lexicographically follows the argument string. The result is zero if the strings are
	 * equal; <code>compareTo</code> returns <code>0</code> exactly when the {@link #equals(Object)}
	 ...
	 * positions, let <i>k</i> be the smallest such index; then the string whose character at
	 * position <i>k</i> has the smaller value, as determined by using the &lt; operator,
	 * lexicographically precedes the other string. In this case, <code>compareTo</code> returns the
	 * difference of the two character values at position <code>k</code> in the two string -- that
	 ...
	 * lexicographically precedes the longer string. In this case, <code>compareTo</code> returns
	 * the difference of the lengths of the strings -- that is, the value: <blockquote>
	 * 
	 * <pre>
	 ...
	 *         than <code>0</code> if this string is lexicographically less than the string
	 *         argument; and a value greater than <code>0</code> if this string is lexicographically
	...
	/**
	 * Returns a hash code for this string. The hash code for a <code>String</code> object is
	 ...
	 * character of the string, <code>n</code> is the length of the string, and <code>^</code>
	 ...
	 *
	 * @throws IndexOutOfBoundsException
	 *             if <tt>beginIndex</tt> or <tt>endIndex</tt> are negative, if <tt>endIndex</tt> is
	 *             greater than <tt>length()</tt>, or if <tt>beginIndex</tt> is greater than
	 *             <tt>startIndex</tt>
	 *
	 * @since 1.4
	 */
	 ...
	 * <p>
	 * An invocation of this method of the form
	 * <i>str</i><tt>.replaceFirst(</tt><i>regex</i><tt>,</tt> <i>repl</i><tt>)</tt> yields exactly
	 ...
	 * <p>
	 * An invocation of this method of the form
	 * <i>str</i><tt>.replaceAll(</tt><i>regex</i><tt>,</tt> <i>repl</i><tt>)</tt> yields exactly
	 * the same result as the expression
	 *
	 * <blockquote><tt>
	 * {@link java.util.regex.Pattern}.{@link java.util.regex.Pattern#compile
	 ...
	 * <p>
	 * An invocation of this method of the form
	 * <i>str.</i><tt>split(</tt><i>regex</i><tt>,</tt>&nbsp;<i>n</i><tt>)</tt> yields the same
	 * result as the expression
	 *
	 * <blockquote> {@link java.util.regex.Pattern}.{@link java.util.regex.Pattern#compile
	 ...
	 * the given <code>Locale</code>. Case mapping is based on the Unicode Standard version
	 * specified by the {@link java.lang.Character Character} class. Since case mappings are not
	 * always 1:1 char mappings, the resulting <code>String</code> may be a different length than
	 ...
	 * <code>"TITLE".toLowerCase()</code> in a Turkish locale returns
	 * <code>"t\u005Cu0131tle"</code>, where '\u005Cu0131' is the LATIN SMALL LETTER DOTLESS I
	 ...
	 * strings that are intended to be interpreted locale independently. Examples are programming
	 * language identifiers, protocol keys, and HTML tags. For instance,
	 * <code>"title".toUpperCase()</code> in a Turkish locale returns
	 * <code>"T\u005Cu0130TLE"</code>, where '\u005Cu0130' is the LATIN CAPITAL LETTER I WITH DOT
	 * ABOVE character. To obtain correct results for locale insensitive strings, use
	 ...
	 *             string, or other illegal conditions. For specification of all possible formatting
	 *             errors, see the <a href="../util/Formatter.html#detail">Details</a> section of
	 ...
	 *
	 * @param l
	 *            The {@linkplain java.util.Locale locale} to apply during formatting. If <tt>l</tt>
	 *            is <tt>null</tt> then no localization is applied.
	 *
	 * @param format
	 *            A <a href="../util/Formatter.html#syntax">format string</a>
	 *
	...
	/**
	 * Returns the string representation of a specific subarray of the <code>char</code> array
	 * argument.
	 * <p>
	 * The <code>offset</code> argument is the index of the first character of the subarray. The
	 * <code>count</code> argument specifies the length of the subarray. The contents of the
	 * subarray are copied; subsequent modification of the character array does not affect the newly
	 * created string.
	 *
	 * @param data
	 *            the character array.
