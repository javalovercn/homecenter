...
public class ScreenCapturer extends PNGCapturer {
	...
	public ScreenCapturer(final J2SESession coreSS, final int clientWidth, final int clientHeight,
		...
		final Thread t = new Thread() {
			...
			public void run() {
				...
				// final byte[] thumbnail_bs =
				// StringUtil.getBytes(HCURL.THUMBNAIL_SCREEN);
	...
	// MAX_RIGHT_X = rx;
	// }
	// LogManager.log("BOTTOM_Y : " + BOTTOM_Y + ", MAX_RIGHT_X : " +
	// MAX_RIGHT_X);
	// }
			...
			try {
				...
				if (inputKeyStr(s) == false) {
					...
					synchronized (clipboard) {
						...
						try {
							Thread.sleep(ThreadPriorityManager.UI_WAIT_FOR_EVENTQUEUE);// Android
																						// maybe
																						// need
																						// sleep
						} catch (final Exception e) {
	...
	public static void type(final Robot r, final char character) {
		switch (character) {
		case '\b':
			doType(r, KeyEvent.VK_BACK_SPACE);
			break;
		case 'a':
			doType(r, KeyEvent.VK_A);
			break;
		case 'b':
			doType(r, KeyEvent.VK_B);
			break;
		case 'c':
			doType(r, KeyEvent.VK_C);
			break;
		case 'd':
			doType(r, KeyEvent.VK_D);
			break;
		case 'e':
			doType(r, KeyEvent.VK_E);
			break;
		case 'f':
			doType(r, KeyEvent.VK_F);
			break;
		case 'g':
			doType(r, KeyEvent.VK_G);
			break;
		case 'h':
			doType(r, KeyEvent.VK_H);
			break;
		case 'i':
			doType(r, KeyEvent.VK_I);
			break;
		case 'j':
			doType(r, KeyEvent.VK_J);
			break;
		case 'k':
			doType(r, KeyEvent.VK_K);
			break;
		case 'l':
			doType(r, KeyEvent.VK_L);
			break;
		case 'm':
			doType(r, KeyEvent.VK_M);
			break;
		case 'n':
			doType(r, KeyEvent.VK_N);
			break;
		case 'o':
			doType(r, KeyEvent.VK_O);
			break;
		case 'p':
			doType(r, KeyEvent.VK_P);
			break;
		case 'q':
			doType(r, KeyEvent.VK_Q);
			break;
		case 'r':
			doType(r, KeyEvent.VK_R);
			break;
		case 's':
			doType(r, KeyEvent.VK_S);
			break;
		case 't':
			doType(r, KeyEvent.VK_T);
			break;
		case 'u':
			doType(r, KeyEvent.VK_U);
			break;
		case 'v':
			doType(r, KeyEvent.VK_V);
			break;
		case 'w':
			doType(r, KeyEvent.VK_W);
			break;
		case 'x':
			doType(r, KeyEvent.VK_X);
			break;
		case 'y':
			doType(r, KeyEvent.VK_Y);
			break;
		case 'z':
			doType(r, KeyEvent.VK_Z);
			break;
		case 'A':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_A);
			break;
		case 'B':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_B);
			break;
		case 'C':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_C);
			break;
		case 'D':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_D);
			break;
		case 'E':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_E);
			break;
		case 'F':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_F);
			break;
		case 'G':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_G);
			break;
		case 'H':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_H);
			break;
		case 'I':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_I);
			break;
		case 'J':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_J);
			break;
		case 'K':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_K);
			break;
		case 'L':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_L);
			break;
		case 'M':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_M);
			break;
		case 'N':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_N);
			break;
		case 'O':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_O);
			break;
		case 'P':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_P);
			break;
		case 'Q':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_Q);
			break;
		case 'R':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_R);
			break;
		case 'S':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_S);
			break;
		case 'T':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_T);
			break;
		case 'U':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_U);
			break;
		case 'V':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_V);
			break;
		case 'W':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_W);
			break;
		case 'X':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_X);
			break;
		case 'Y':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_Y);
			break;
		case 'Z':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_Z);
			break;
		case '`':
			doType(r, KeyEvent.VK_BACK_QUOTE);
			break;
		case '0':
			doType(r, KeyEvent.VK_0);
			break;
		case '1':
			doType(r, KeyEvent.VK_1);
			break;
		case '2':
			doType(r, KeyEvent.VK_2);
			break;
		case '3':
			doType(r, KeyEvent.VK_3);
			break;
		case '4':
			doType(r, KeyEvent.VK_4);
			break;
		case '5':
			doType(r, KeyEvent.VK_5);
			break;
		case '6':
			doType(r, KeyEvent.VK_6);
			break;
		case '7':
			doType(r, KeyEvent.VK_7);
			break;
		case '8':
			doType(r, KeyEvent.VK_8);
			break;
		case '9':
			doType(r, KeyEvent.VK_9);
			break;
		case '-':
			doType(r, KeyEvent.VK_MINUS);
			break;
		case '=':
			doType(r, KeyEvent.VK_EQUALS);
			break;
		case '~':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_BACK_QUOTE);
			break;
		case '!':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_1);
			break;
		case '@':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_2);
			break;
		case '#':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_3);
			break;
		case '$':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_4);
			break;
		case '%':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_5);
			break;
		case '^':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_6);
			break;
		case '&':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_7);
			break;
		case '*':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_8);
			break;
		case '(':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_9);
			break;
		case ')':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_0);
			break;
		case '_':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_MINUS);
			break;
		case '+':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_EQUALS);
			break;
		case '\t':
			doType(r, KeyEvent.VK_TAB);
			break;
		case '\n':
			doType(r, KeyEvent.VK_ENTER);
			break;
		case '[':
			doType(r, KeyEvent.VK_OPEN_BRACKET);
			break;
		case ']':
			doType(r, KeyEvent.VK_CLOSE_BRACKET);
			break;
		case '\\':
			doType(r, KeyEvent.VK_BACK_SLASH);
			break;
		case '{':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_OPEN_BRACKET);
			break;
		case '}':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_CLOSE_BRACKET);
			break;
		case '|':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_BACK_SLASH);
			break;
		case ';':
			doType(r, KeyEvent.VK_SEMICOLON);
			break;
		case ':':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_SEMICOLON);
			break;
		case '\'':
			doType(r, KeyEvent.VK_QUOTE);
			break;
		case '"':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_QUOTE);
			break;
		case ',':
			doType(r, KeyEvent.VK_COMMA);
			break;
		case '<':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_COMMA);
			break;
		case '.':
			doType(r, KeyEvent.VK_PERIOD);
			break;
		case '>':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_PERIOD);
			break;
		case '/':
			doType(r, KeyEvent.VK_SLASH);
			break;
		case '?':
			doType(r, KeyEvent.VK_SHIFT, KeyEvent.VK_SLASH);
			break;
		case ' ':
			doType(r, KeyEvent.VK_SPACE);
			break;
		default:
	...
	public void copytxtToMobi() {
		...
		if (txt.length() > 0) {
			try {
				...
				coreSS.context.send(MsgBuilder.E_INPUT_EVENT, txtToMobiBS, e.getLength());
	...
	public void zoom(final int zoomMultiPara) {
		synchronized (LOCK) {
			// LogManager.log("receive zoom cmd : " + zoomMultiPara + ",
			// oldZoomMulti : " + zoomOldMultiples);
			int[] outInts = null;
			;
			...
			// LogManager.log("oldLocX : " + oldLocX + ", oldLocY : " + oldLocY
			// + ", locX : " + locX + ", locY : " + locY);
			...
			ContextManager.getThreadPool().run(new Runnable() {
				...
				public void run() {
					...
					synchronized (LOCK) {
						...
						// System.out.println("new capRect w : " + capRect.width
						// + ", h : " + capRect.height);
					}
				}
	...
	private void doBizAfterIsLockScreen() {
		...
		// LogManager.errToLog(" screen is locked after pressed Win + L or
		// screen save is triggered,");
