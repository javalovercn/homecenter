...
import third.quartz.impl.triggers.DailyTimeIntervalTriggerImpl;
...
public class DailyTimeIntervalScheduleBuilder extends ScheduleBuilder<DailyTimeIntervalTrigger> {
    ...
    static {
        ...
        for(int i=java.util.Calendar.MONDAY; i <= java.util.Calendar.FRIDAY; i++)
            t.add(i);
        MONDAY_THROUGH_FRIDAY = Collections.unmodifiableSet(t);
        
        t = new HashSet<Integer>(2);
        t.add(java.util.Calendar.SUNDAY);
        t.add(java.util.Calendar.SATURDAY);
