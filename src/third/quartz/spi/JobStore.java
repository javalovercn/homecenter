...
/**
 * <p>
 * The interface to be implemented by classes that want to provide a <code>{@link third.quartz.Job}</code>
 * and <code>{@link third.quartz.Trigger}</code> storage mechanism for the
 * <code>{@link third.quartz.core.QuartzScheduler}</code>'s use.
 * </p>
 *
 * <p>
...
public interface JobStore {
     ...
     * key, and any <code>{@link third.quartz.Trigger}</code> s that reference
     * it.
     *
     * <p>
     ...
     *           exists, and replaceExisting is set to false.
     */
    void storeCalendar(String name, JobCalendar calendar, boolean replaceExisting, boolean updateTriggers)
        throws ObjectAlreadyExistsException, JobPersistenceException;
     ...
     *         match.
     */
    JobCalendar retrieveCalendar(String calName)
        throws JobPersistenceException;
    ...
    /**
     * Get the keys of all of the <code>{@link third.quartz.Job}</code> s that
    ...
    /**
     * Pause the <code>{@link third.quartz.Trigger}</code> with the given key.
     *
    ...
    /**
     * Pause all of the <code>{@link third.quartz.Job}s</code> in the given
     ...
     * and that the <code>{@link third.quartz.JobDataMap}</code>
