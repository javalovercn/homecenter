...
public interface MutableTrigger extends Trigger {
    ...
    /**
     * <p>
     * Associate the <code>{@link JobCalendar}</code> with the given name with
     * this Trigger.
     * </p>
     * 
     * @param calendarName
     ...
     * </p>
     * 
     * @see TriggerUtils#computeEndTimeToAllowParticularNumberOfFirings(Trigger, JobCalendar, int)
     */
     ...
     * @see #updateAfterMisfire(JobCalendar)
     * @see SimpleTrigger
     * @see CronTrigger
     */
