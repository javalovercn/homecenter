...
public class DateBuilder {
    ...
    public Date build() {
        ...
        if(tz != null && lc != null)
            cal = java.util.Calendar.getInstance(tz, lc);
        else if(tz != null)
            cal = java.util.Calendar.getInstance(tz);
        else if(lc != null)
            cal = java.util.Calendar.getInstance(lc);
        else 
    ...
    private static int translate(IntervalUnit unit) {
        switch(unit) {
            case DAY : return java.util.Calendar.DAY_OF_YEAR;
            case HOUR : return java.util.Calendar.HOUR_OF_DAY;
            case MINUTE : return java.util.Calendar.MINUTE;
            case MONTH : return java.util.Calendar.MONTH;
            case SECOND : return java.util.Calendar.SECOND;
            case MILLISECOND : return java.util.Calendar.MILLISECOND;
            case WEEK : return java.util.Calendar.WEEK_OF_YEAR;
            case YEAR : return java.util.Calendar.YEAR;
    ...
    public static Date evenHourDate(Date date) {
        ...
        c.set(java.util.Calendar.HOUR_OF_DAY, c.get(java.util.Calendar.HOUR_OF_DAY) + 1);
    ...
    public static Date evenMinuteDate(Date date) {
        ...
        c.set(java.util.Calendar.MINUTE, c.get(java.util.Calendar.MINUTE) + 1);
        c.set(java.util.Calendar.SECOND, 0);
        c.set(java.util.Calendar.MILLISECOND, 0);
    ...
    public static Date nextGivenMinuteDate(Date date, int minuteBase) {
        ...
        if (nextMinuteOccurance < 60) {
            c.set(java.util.Calendar.MINUTE, nextMinuteOccurance);
            c.set(java.util.Calendar.SECOND, 0);
            c.set(java.util.Calendar.MILLISECOND, 0);
    ...
    public static Date nextGivenSecondDate(Date date, int secondBase) {
        ...
        if (nextSecondOccurance < 60) {
            c.set(java.util.Calendar.SECOND, nextSecondOccurance);
            c.set(java.util.Calendar.MILLISECOND, 0);
    ...
    private static final int MAX_YEAR = java.util.Calendar.getInstance().get(java.util.Calendar.YEAR) + 100;
