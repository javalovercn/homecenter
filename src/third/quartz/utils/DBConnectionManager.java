 ...
 * @see third.quartz.utils.weblogic.WeblogicConnectionProvider
 * 
 * @author James House
...
public class DBConnectionManager {
    ...
    public static final String DB_PROPS_PREFIX = "third.quartz.db.";
    ...
    public void shutdown(String dsName) throws SQLException {
        ...
        ConnectionProvider provider = providers
        .get(dsName);
        if (provider == null) {
            throw new SQLException("There is no DataSource named '"
                    + dsName + "'");
