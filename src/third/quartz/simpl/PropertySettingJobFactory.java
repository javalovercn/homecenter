 ...
 * @see third.quartz.JobExecutionContext#getMergedJobDataMap()
...
//        setBeanProps(job, jobDataMap);//yyh 关闭java.beans为android
        
        return job;
    }
    
//    yyh 关闭java.beans为android
...
//    }
    ...
    private void handleError(String message, Exception e) throws SchedulerException {
        ...
        if (isWarnIfPropertyNotFound()) {
            if (e == null) {
                ThirdLogManager.warn(message);
            } else {
                ThirdLogManager.warn(message, e);
            }
        }
    }
