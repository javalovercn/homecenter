...
import third.quartz.spi.InstanceIdGenerator;
 ...
 * 
 * If no value set for the property, a {@link third.quartz.SchedulerException} is thrown
 *
 * @author Alex Snaps
 */
public class SystemPropertyInstanceIdGenerator implements InstanceIdGenerator {
   ...
   */
  public static final String SYSTEM_PROPERTY = "third.quartz.scheduler.instanceId";
