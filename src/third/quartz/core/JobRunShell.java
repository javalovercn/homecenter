...
import third.quartz.impl.JobExecutionContextImpl;
    ...
    public void run() {
        ...
        try {
            ...
            do {
                ...
                // execute the job
                try {
                    L.V = L.WShop ? false : ThirdLogManager.debug("Calling execute on job " + jobDetail.getKey());
                    job.execute(jec);
                    endTime = System.currentTimeMillis();
                } catch (JobExecutionException jee) {
                    endTime = System.currentTimeMillis();
                    jobExEx = jee;
                    L.V = L.WShop ? false : ThirdLogManager.info("Job " + jobDetail.getKey() +
                            " threw a JobExecutionException: ", jobExEx);
                } catch (Throwable e) {
                    endTime = System.currentTimeMillis();
                    ThirdLogManager.error("Job " + jobDetail.getKey() +
