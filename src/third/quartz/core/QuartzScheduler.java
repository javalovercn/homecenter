...
import static third.quartz.TriggerBuilder.*;
import third.quartz.InterruptableJob;
...
import third.quartz.spi.SchedulerPlugin;
...
/**
 * <p>
 * This is the heart of Quartz, an indirect implementation of the <code>{@link third.quartz.Scheduler}</code>
 * interface, containing methods to schedule <code>{@link third.quartz.Job}</code>s,
 * register <code>{@link third.quartz.JobListener}</code> instances, etc.
 * </p>
 * 
 * @see third.quartz.Scheduler
 * @see third.quartz.core.QuartzSchedulerThread
 * @see third.quartz.spi.JobStore
 * @see third.quartz.spi.ThreadPool
 * 
 * @author James House
 */
...
//    private ArrayList<Object> holdToPreventGC = new ArrayList<Object>(5);//yyh
    ...
    public QuartzScheduler(QuartzSchedulerResources resources, long idleWaitTime, @Deprecated long dbRetryInterval)
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("Quartz Scheduler v." + getVersion() + " created.");
    }
...
//        }
        ...
        // Class.forName("third.quartz.management.ManagementServerImpl");
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("Scheduler meta-data: " +
    ...
    private void unregisterJMX() throws Exception {
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("Scheduler unregistered from name '" + jmxObjectName + "' in the local MBeanServer.");
    }
...
//        boundRemotely = true;
//
//        L.V = L.WShop ? false : ThirdLogManager.info("Scheduler bound to RMI registry under name '" + bindName + "'");
//    }
...
//        }
//
//        L.V = L.WShop ? false : ThirdLogManager.info("Scheduler un-bound from name '" + bindName + "' in RMI registry");
//    }
...
//    }
    ...
    /**
     * <p>
     * Starts the <code>QuartzScheduler</code>'s threads that fire <code>{@link third.quartz.Trigger}s</code>.
     * </p>
     * 
     * <p>
     * All <code>{@link third.quartz.Trigger}s</code> that have misfired will
        ...
        Thread t = new Thread(new Runnable() {
            public void run() {
                ...
                try { start(); }
                    ...
                    ThirdLogManager.error("Unable to start scheduler after startup delay.", se);
                }
            }
        });
        t.start();
    ...
    /**
     * <p>
     * Temporarily halts the <code>QuartzScheduler</code>'s firing of <code>{@link third.quartz.Trigger}s</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Halts the <code>QuartzScheduler</code>'s firing of <code>{@link third.quartz.Trigger}s</code>,
    ...
    public void shutdown(boolean waitForJobsToComplete) {
        ...
        // }
        // } catch (Exception e) {
        // ThirdLogManager.warn("Failed to shutdown the ManagementRESTService", e);
        // } finally {
        // if (removeMgmtSvr) {
            ...
            for(JobExecutionContext job: jobs) {
                if(job.getJobInstance() instanceof InterruptableJob)
                    try {
                        ...
                        ThirdLogManager.warn("Encountered error when interrupting job {} during shutdown: {}" + job.getJobDetail().getKey(), e);
                    }
            }
        }
...
//        holdToPreventGC.clear();
    ...
    /**
     * <p>
     * Add the <code>{@link third.quartz.Job}</code> identified by the given
     * <code>{@link third.quartz.JobDetail}</code> to the Scheduler, and
     * associate the given <code>{@link third.quartz.Trigger}</code> with it.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Schedule the given <code>{@link third.quartz.Trigger}</code> with the
    ...
    /**
     * <p>
     * Remove the indicated <code>{@link third.quartz.Trigger}</code> from the
     * scheduler.
     * </p>
     */
    ...
    /**
     * <p>
     * Trigger the identified <code>{@link third.quartz.Job}</code> (execute it
    ...
    /**
     * <p>
     * Store and schedule the identified <code>{@link third.quartz.spi.OperableTrigger}</code>
     * </p>
     */
    ...
    /**
     * <p>
     * Pause the <code>{@link third.quartz.JobDetail}</code> with the given
    ...
    /**
     * <p>
     * Pause all of the <code>{@link third.quartz.JobDetail}s</code> in the
    ...
    /**
     * <p>
     * Resume (un-pause) the <code>{@link third.quartz.JobDetail}</code> with
     * the given name.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Resume (un-pause) all of the <code>{@link third.quartz.JobDetail}s</code>
    ...
    /**
     * <p>
     * Get the names of all known <code>{@link third.quartz.Job}</code> groups.
     * </p>
     */
    ...
    /**
     * <p>
     * Get the names of all the <code>{@link third.quartz.Job}s</code> in the
     * matching groups.
     * </p>
     */
     ...
     * identified <code>{@link third.quartz.JobDetail}</code>.
     * </p>
     */
    ...
    /**
     * <p>
     * Get the names of all known <code>{@link third.quartz.Trigger}</code>
     * groups.
     * </p>
     */
    ...
    /**
     * <p>
     * Get the names of all the <code>{@link third.quartz.Trigger}s</code> in
     * the matching groups.
     * </p>
     */
...
J     *
     ...
     *           <code>false</code>.
     */
    public void addCalendar(String calName, JobCalendar calendar, boolean replace, boolean updateTriggers) throws SchedulerException {
        validateState();
     ...
     * </p>
     */
    public JobCalendar getCalendar(String calName)
        throws SchedulerException {
        validateState();
    ...
    /**
     * <p>
     * Add the given <code>{@link third.quartz.JobListener}</code> to the
    ...
    /**
     * <p>
     * Get a List containing all of the <code>{@link third.quartz.JobListener}</code>s
    ...
    /**
     * <p>
     * Get the <i>internal</i> <code>{@link third.quartz.JobListener}</code>
    ...
    /**
     * <p>
     * Add the given <code>{@link third.quartz.TriggerListener}</code> to the
     * <code>Scheduler</code>'s <i>internal</i> list.
     * </p>
     */
    ...
    /**
     * <p>
     * Get a list containing all of the <code>{@link third.quartz.TriggerListener}</code>s
     * in the <code>Scheduler</code>'s <i>internal</i> list.
     * </p>
     */
    ...
    public void setJobFactory(JobFactory factory) throws SchedulerException {
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("JobFactory set to: " + factory);
     ...
     * </p>
     * 
     * @see third.quartz.core.RemotableQuartzScheduler#interrupt(JobKey)
     */
...
class ErrorLogger extends SchedulerListenerSupport {
    ...
    public void schedulerError(String msg, SchedulerException cause) {
        ThirdLogManager.error(msg, cause);
    }
