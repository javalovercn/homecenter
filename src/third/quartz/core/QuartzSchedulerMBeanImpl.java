...
import third.quartz.core.jmx.JobDetailSupport;
import third.quartz.core.jmx.JobExecutionContextSupport;
import third.quartz.core.jmx.QuartzSchedulerMBean;
import third.quartz.core.jmx.TriggerSupport;
import third.quartz.impl.matchers.GroupMatcher;
import third.quartz.impl.triggers.AbstractTrigger;
...
public class QuartzSchedulerMBeanImpl extends StandardMBean implements
    ...
    private static Method findMethod(Class<?> targetType, String methodName,
            Class<?>[] argTypes) throws Exception {//yyh 关闭java.beans为android
