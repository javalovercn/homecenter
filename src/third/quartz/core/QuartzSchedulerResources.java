...
import third.quartz.management.ManagementRESTServiceConfiguration;
...
public class QuartzSchedulerResources {
    ...
    /**
     * <p>
     * Add the given <code>{@link third.quartz.spi.SchedulerPlugin}</code> for the 
     ...
     * <code>{@link third.quartz.spi.SchedulerPlugin}</code>s for the 
