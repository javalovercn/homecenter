...
public class TimeOfDay implements Serializable {
    ...
    public static TimeOfDay hourAndMinuteAndSecondFromDate(Date dateTime, TimeZone tz) {
        ...
        return new TimeOfDay(cal.get(java.util.Calendar.HOUR_OF_DAY), cal.get(java.util.Calendar.MINUTE), cal.get(java.util.Calendar.SECOND));
    }
    ...
    public static TimeOfDay hourAndMinuteFromDate(Date dateTime, TimeZone tz) {
        ...
        return new TimeOfDay(cal.get(java.util.Calendar.HOUR_OF_DAY), cal.get(java.util.Calendar.MINUTE));
    }
