 ...
 * 
 * <p>
 * If you need a <code>{@link third.quartz.spi.JobStore}</code> class to use
 * within an application-server environment, use <code>{@link
 * third.quartz.impl.jdbcjobstore.JobStoreCMT}</code>
 * instead.
 * </p>
 * 
...
public class JobStoreTX extends JobStoreSupport {
    ...
    public void initialize(ClassLoadHelper classLoadHelper,
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("JobStoreTX initialized.");
    }
