 ...
 * </p>
 * 
 * @see third.quartz.impl.jdbcjobstore.JobStoreSupport#getConnection()
 * @see third.quartz.impl.jdbcjobstore.JobStoreCMT#getNonManagedTXConnection()
 */
public class AttributeRestoringConnectionInvocationHandler implements InvocationHandler {
    ...
    public void restoreOriginalAtributes() {
        try {
            ...
            ThirdLogManager.warn("Failed restore connection's original auto commit setting.", t);
        }
        ...
        try {    
            ...
            ThirdLogManager.warn("Failed restore connection's original transaction isolation setting.", t);
        }
    }
