 ...
 * third.quartz.impl.jdbcjobstore.JobStoreTX}</code>
 * instead.
 * </p>
 * 
    ...
    public void initialize(ClassLoadHelper loadHelper,
        ...
        if (nonManagedTxDsName == null) {
            throw new SchedulerConfigException(
                ...
                "If your 'third.quartz.jobStore.dataSource' is XA, then set " + 
                "'third.quartz.jobStore.nonManagedTXDataSource' to a non-XA "+ 
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("JobStoreCMT initialized.");
    }
...
//        conn = getAttributeRestoringConnection(conn);//rem by yyh
