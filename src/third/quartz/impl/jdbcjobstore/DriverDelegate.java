 ...
 * third.quartz.spi.JobStore}</code>
 ...
 * <code>{@link third.quartz.impl.jdbcjobstore.StdJDBCDelegate}</code> class.
 * </p>
 * 
...
public interface DriverDelegate {
     ...
     */
    JobCalendar selectCalendar(Connection conn, String calendarName)
        throws ClassNotFoundException, IOException, SQLException;
