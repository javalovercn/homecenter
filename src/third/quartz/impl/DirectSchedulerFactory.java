...
import third.quartz.SchedulerFactory;
import third.quartz.core.JobRunShellFactory;
import third.quartz.core.QuartzScheduler;
import third.quartz.core.QuartzSchedulerResources;
import third.quartz.simpl.CascadingClassLoadHelper;
import third.quartz.simpl.RAMJobStore;
import third.quartz.simpl.SimpleThreadPool;
...
/**
 * <p>
 * A singleton implementation of <code>{@link third.quartz.SchedulerFactory}</code>.
 * </p>
 *
 * <p>
...
public class DirectSchedulerFactory implements SchedulerFactory {
     ...
     *          <code>{@link third.quartz.spi.SchedulerPlugin}</code>s.  Can use
    ...
    public void createScheduler(String schedulerName,
        ...
        L.V = L.WShop ? false : ThirdLogManager.info("Quartz scheduler '" + scheduler.getSchedulerName());
