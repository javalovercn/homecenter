...
/**
 * <p>
 * A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link third.quartz.JobDetail}</code>
...
public class CronTriggerImpl extends AbstractTrigger<CronTrigger> implements CronTrigger, CoreTrigger {
     ...
     * associated with the identified <code>{@link third.quartz.JobDetail}</code>.
     * </p>
     * 
     * <p>
     * The start-time will also be set to the current time, and the time zone
     ...
     *          of the <code>Trigger</code>
     * @param jobName
     *          name of the <code>{@link third.quartz.JobDetail}</code>
     *          executed on firetime
     * @param jobGroup
     *          group of the <code>{@link third.quartz.JobDetail}</code>
     *          executed on firetime
     * @param startTime
    ...
    /* (non-Javadoc)
     * @see third.quartz.CronTriggerI#getCronExpression()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.CronTriggerI#getTimeZone()
     */
     ...
     * not validated against third.quartz.calendar
     * </p>
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see third.quartz.CronTriggerI#getExpressionSummary()
     */
