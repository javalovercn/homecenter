...
import third.quartz.SimpleScheduleBuilder;
...
public class SimpleTriggerImpl extends AbstractTrigger<SimpleTrigger> implements SimpleTrigger, CoreTrigger {
    ...
    /* (non-Javadoc)
     * @see third.quartz.SimpleTriggerI#getRepeatCount()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.SimpleTriggerI#getRepeatInterval()
     */
     ...
     */
    @Override
    public void updateAfterMisfire(JobCalendar cal) {
     ...
     */
    @Override
    public void triggered(JobCalendar calendar) {
        timesTriggered++;
     ...
     */
    @Override
    public Date computeFirstFireTime(JobCalendar calendar) {
