...
public abstract class AbstractTrigger<T extends Trigger> implements OperableTrigger {
    ...
    */
    ...
    /**
     * <p>
     * Create a <code>Trigger</code> with no specified name, group, or <code>{@link third.quartz.JobDetail}</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Get the name of the associated <code>{@link third.quartz.JobDetail}</code>.
     * </p>
     */
    ...
    /**
     * <p>
     * Set the name of the associated <code>{@link third.quartz.JobDetail}</code>.
     * </p>
     * 
     * @exception IllegalArgumentException
    ...
    /**
     * <p>
     * Get the name of the associated <code>{@link third.quartz.JobDetail}</code>'s
     * group.
     * </p>
     */
    ...
    /**
     * <p>
     * Set the name of the associated <code>{@link third.quartz.JobDetail}</code>'s
     * group.
     * </p>
     * 
     ...
     */
    public abstract void triggered(JobCalendar calendar);
     ...
     *         </p>
     */
    public abstract Date computeFirstFireTime(JobCalendar calendar);
     ...
     * <code>{@link third.quartz.JobDetail}</code> associated with the <code>Trigger</code>
     ...
     * 
     * @see third.quartz.Trigger.CompletedExecutionInstruction
     ...
     * may remove the <code>Trigger</code> from the <code>{@link third.quartz.spi.JobStore}</code>.
     * </p>
     */
     ...
     * </p>
     */
    public abstract void updateAfterMisfire(JobCalendar cal);
     ...
     */
    public abstract void updateWithNewCalendar(JobCalendar cal, long misfireThreshold);
     ...
     * 
     * <p>
     * Usable by <code>{@link third.quartz.spi.JobStore}</code>
