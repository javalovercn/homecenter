...
import third.quartz.DisallowConcurrentExecution;
...
import third.quartz.PersistJobDataAfterExecution;
import third.quartz.Scheduler;
import third.quartz.StatefulJob;
import third.quartz.Trigger;
import third.quartz.utils.ClassUtils;
...
public class JobDetailImpl implements Cloneable, java.io.Serializable, JobDetail {
    ...
    */
    ...
    /* (non-Javadoc)
     * @see third.quartz.JobDetailI#getKey()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.JobDetailI#getDescription()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.JobDetailI#getJobClass()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.JobDetailI#getJobDataMap()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.JobDetailI#isDurable()
     */
    ...
    /* (non-Javadoc)
     * @see third.quartz.JobDetailI#requestsRecovery()
     */
