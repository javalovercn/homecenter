...
import third.quartz.utils.Key;

/**
 * This is the main interface of a Quartz Scheduler.
 * 
 * <p>
 * A <code>Scheduler</code> maintains a registry of <code>{@link third.quartz.JobDetail}</code>s
 ...
 * a class that implements the <code>{@link third.quartz.Job}</code>
...
public interface Scheduler {
     ...
     *
     * @see third.quartz.JobDetail#requestsRecovery()
     */
     ...
     * </p>
     * 
     * @see third.quartz.spi.JobFactory
     */
    ...
    /**
     * Add the given <code>{@link third.quartz.JobDetail}</code> to the
    ...
    /**
     * Trigger the identified <code>{@link third.quartz.JobDetail}</code>
     * (execute it now).
     */
    ...
    /**
     * Get the names of all known <code>{@link third.quartz.JobDetail}</code>
     * groups.
     */
    List<String> getJobGroupNames() throws SchedulerException;

    /**
     * Get the keys of all the <code>{@link third.quartz.JobDetail}s</code>
     ...
     *           <code>false</code>.
     */
    void addCalendar(String calName, JobCalendar calendar, boolean replace, boolean updateTriggers)
        throws SchedulerException;
     ...
     */
    JobCalendar getCalendar(String calName) throws SchedulerException;
