...
public interface Trigger extends Serializable, Cloneable, Comparable<Trigger> {
     ...
     * <code>{@link Trigger}</code> wants the <code>{@link third.quartz.JobDetail}</code> to 
     ...
     * that all <code>Trigger</code>s referencing the same <code>{@link third.quartz.JobDetail}</code> 
     ...
     * <code>Trigger</code>s referencing the same <code>{@link third.quartz.JobDetail}</code> as
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(third.quartz.spi.OperableTrigger, JobCalendar, java.util.Date, java.util.Date)
     */
