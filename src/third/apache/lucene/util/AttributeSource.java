...
public class AttributeSource {
  ...
  private Map<Class<? extends Attribute>, AttributeImpl> attributes;
  private Map<Class<? extends AttributeImpl>, AttributeImpl> attributeImpls;
  ...
  public final <T extends Attribute> T addAttribute(Class<T> attClass) {
    return (T)AttMapper.getAttribute(attClass);
  }
