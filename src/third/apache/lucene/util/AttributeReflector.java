...
public interface AttributeReflector {
   ...
   * E.g., an invocation of {@link third.apache.lucene.analysis.tokenattributes.CharTermAttributeImpl#reflectWith}
   * would call this method once using {@code third.apache.lucene.analysis.tokenattributes.CharTermAttribute.class}
