 ...
 */
package third.apache.lucene.analysis.snowball;
...
import third.apache.lucene.analysis.tr.TurkishLowerCaseFilter;
import third.tartarus.snowball.SnowballProgram;

/**
 * A filter that stems words using a Snowball-generated stemmer.
 *
 * Available stemmers are listed in {@link third.tartarus.snowball.ext}.
 ...
 * {@link third.apache.lucene.analysis.miscellaneous.KeywordRepeatFilterFactory}
 * </p>
 *
 *
 */
public final class SnowballFilter extends TokenFilter {
   ...
   * e.g., the stemmer in {@link third.tartarus.snowball.ext.EnglishStemmer} is named "English".
   *
  ...
  public SnowballFilter(TokenStream in, String name) {
    ...
    try {
      Class<? extends SnowballProgram> stemClass =
        Class.forName("third.tartarus.snowball.ext." + name + "Stemmer").asSubclass(SnowballProgram.class);
